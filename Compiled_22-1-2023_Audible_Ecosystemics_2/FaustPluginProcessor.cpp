...
class mydsp : public base_dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst2 = std::exp(0.0 - 10.000000000040254 / fConst0);
		fConst3 = 1.0 / fConst0;
		...
		fConst11 = std::exp(0.0 - 100.00000000040254 / fConst0);
		double fConst12 = std::tan(157.07963267948966 / fConst0);
		fConst13 = fConst12 / (fConst12 + 1.0);
		fConst14 = 2.0 * fConst13;
		double fConst15 = std::tan(18849.55592153876 / fConst0);
		...
		fConst23 = 0.5 * fConst0;
		fConst24 = 3.141592653589793 / fConst0;
		double fConst25 = std::tan(fConst24);
		fConst26 = fConst25 / (fConst25 + 1.0);
		fConst27 = 2.0 * fConst26;
		fConst28 = std::exp(0.0 - 20.000000000080508 / fConst0);
		fConst29 = 1.0 - fConst28;
		sig0->instanceInitmydspSIG0(sample_rate);
		sig0->fillmydspSIG0(882000, ftbl1);
		fConst30 = 0.3333333333333333 * fConst0;
		fConst31 = 0.5 / fConst0;
		fConst32 = 2.0 * fConst0;
		fConst33 = 0.4 * fConst0;
		iConst34 = int(std::max<double>(0.0, 0.036 * fConst0 + -1.0));
		iConst35 = int(std::max<double>(0.0, 0.04 * fConst0 + -1.0));
		fConst36 = 0.6666666666666666 * fConst0;
		fConst37 = std::max<double>(0.0, 0.05 * fConst0);
		fConst38 = 5e-05 * fConst0;
		fConst39 = 0.0014534883720930232 * fConst0;
		fConst40 = 0.0029069767441860465 * fConst0;
		deletemydspSIG0(sig0);
	}
	
	virtual void instanceResetUserInterface() {
		fEntry0 = FAUSTFLOAT(2e+01);
		fVslider0 = FAUSTFLOAT(0.0);
		fCheckbox0 = FAUSTFLOAT(0.0);
		fVslider1 = FAUSTFLOAT(0.0);
		fVslider2 = FAUSTFLOAT(0.0);
		fEntry1 = FAUSTFLOAT(1e+02);
		fEntry2 = FAUSTFLOAT(0.5);
		fVslider3 = FAUSTFLOAT(0.0);
		fEntry3 = FAUSTFLOAT(2e+01);
	}
	...
	virtual void instanceClear() {
		...
		for (int l224 = 0; l224 < 8388608; l224 = l224 + 1) {
			fVec30[l224] = 0.0;
		}
		for (int l225 = 0; l225 < 2; l225 = l225 + 1) {
			fRec268[l225] = 0.0;
		}
		for (int l226 = 0; l226 < 16384; l226 = l226 + 1) {
			fVec31[l226] = 0.0;
		}
		...
		for (int l231 = 0; l231 < 2097152; l231 = l231 + 1) {
			fRec284[l231] = 0.0;
		}
		for (int l232 = 0; l232 < 2; l232 = l232 + 1) {
			fRec282[l232] = 0.0;
		}
		for (int l233 = 0; l233 < 8192; l233 = l233 + 1) {
			fVec32[l233] = 0.0;
		}
		...
		for (int l239 = 0; l239 < 2097152; l239 = l239 + 1) {
			fRec293[l239] = 0.0;
		}
		for (int l240 = 0; l240 < 2; l240 = l240 + 1) {
			fRec291[l240] = 0.0;
		}
		for (int l241 = 0; l241 < 8192; l241 = l241 + 1) {
			fVec33[l241] = 0.0;
		}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalBargraph("sig_ 5", &fVbargraph18, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		...
		ui_interface->addVerticalBargraph("sig_ 7", &fVbargraph20, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("Signal Flow 1b");
		...
		ui_interface->addVerticalBargraph("sig_ 2", &fVbargraph22, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		...
		ui_interface->addVerticalBargraph("sig_ 4", &fVbargraph19, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		...
		ui_interface->addVerticalBargraph("sig_ 6", &fVbargraph21, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph27, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 7", &fVbargraph27, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("Signal Flow 2a");
		...
		ui_interface->addVerticalBargraph("sig_ 1", &fVbargraph24, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph31, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 2", &fVbargraph31, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph30, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 3", &fVbargraph30, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		...
		ui_interface->addVerticalBargraph("sig_ 7", &fVbargraph29, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("Signal Flow 3");
		ui_interface->declare(&fVbargraph28, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 0", &fVbargraph28, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph32, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 1", &fVbargraph32, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		...
		ui_interface->addVerticalBargraph("sig_ 3", &fVbargraph34, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph35, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 4", &fVbargraph35, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph36, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 5", &fVbargraph36, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("System Variables");
		ui_interface->addNumEntry("Var 1", &fEntry0, FAUSTFLOAT(2e+01), FAUSTFLOAT(1.0), FAUSTFLOAT(2e+01), FAUSTFLOAT(1.0));
		ui_interface->addNumEntry("Var 2", &fEntry1, FAUSTFLOAT(1e+02), FAUSTFLOAT(1.0), FAUSTFLOAT(1e+04), FAUSTFLOAT(1.0));
		ui_interface->addNumEntry("Var 3", &fEntry2, FAUSTFLOAT(0.5), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->addNumEntry("Var 4", &fEntry3, FAUSTFLOAT(2e+01), FAUSTFLOAT(1.0), FAUSTFLOAT(2e+01), FAUSTFLOAT(1.0));
		ui_interface->closeBox();
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		double fSlow2 = fConst4 * std::pow(1e+01, 0.05 * double(fVslider0));
		double fSlow3 = double(fCheckbox0);
		double fSlow4 = fConst4 * std::pow(1e+01, 0.05 * double(fVslider1));
		double fSlow5 = fConst4 * std::pow(1e+01, 0.05 * double(fVslider2));
		double fSlow6 = 0.001 * fSlow3;
		int iSlow7 = int(std::max<double>(0.0, fConst23 * fSlow0 + -1.0));
		double fSlow8 = double(fEntry1);
		double fSlow9 = std::tan(fConst24 * std::max<double>(2.220446049250313e-16, std::min<double>(2e+04, fSlow8)));
		double fSlow10 = fSlow9 / (fSlow9 + 1.0);
		double fSlow11 = 2.0 * fSlow10;
		double fSlow12 = 4.41e+04 * fSlow0;
		int iSlow13 = int(fSlow12);
		double fSlow14 = 2.0 * fSlow8;
		int iSlow15 = int(std::max<double>(0.0, fConst30 * fSlow0 + -1.0));
		double fSlow16 = 0.0005 * fSlow8;
		int iSlow17 = int(std::max<double>(0.0, fConst0 * fSlow0 + -1.0));
		double fSlow18 = fConst31 / fSlow0;
		double fSlow19 = fConst3 * fSlow0;
		double fSlow20 = 0.5 * (1.0 - double(fEntry2));
		int iSlow21 = int(std::max<double>(0.0, fConst32 * fSlow0 + -1.0));
		int iSlow22 = int(std::max<double>(0.0, fConst33 * fSlow0 + -1.0));
		double fSlow23 = fConst3 / fSlow0;
		double fSlow24 = fConst4 * std::pow(1e+01, 0.05 * double(fVslider3));
		int iSlow25 = int(std::max<double>(0.0, fConst36 * fSlow0 + -1.0));
		double fSlow26 = double(fEntry3);
		int iSlow27 = int(std::max<double>(0.0, fConst39 * fSlow26 + -1.0));
		int iSlow28 = int(std::max<double>(0.0, fConst40 * fSlow26 + -1.0));
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec27[0] = fSlow2 + fConst5 * fRec27[1];
			double fTemp2 = fRec27[0] * (fTemp1 + fTemp0);
			double fTemp3 = fSlow3 * fTemp2;
			fRec26[0] = std::max<double>(fRec26[1] - fConst3, std::fabs(fTemp3));
			fVbargraph0 = FAUSTFLOAT(2e+01 * std::log10(std::max<double>(2.2250738585072014e-308, std::max<double>(6.309573444801929e-05, fRec26[0]))));
			fRec25[0] = fConst6 * std::fabs(fTemp3) + fConst2 * fRec25[1];
			fVec1[IOTA0 & 2047] = fRec25[0] + 0.9 * fRec24[1];
			fRec24[0] = fVec1[(IOTA0 - iConst7) & 2047];
			double fTemp4 = fRec24[1] - fRec22[1];
			fRec22[0] = fRec22[1] + fConst10 * fTemp4;
			double fTemp5 = fRec22[1] + fConst9 * fTemp4;
			double fRec23 = fTemp5;
			double fTemp6 = fRec23 - fRec20[1];
			fRec20[0] = fRec20[1] + fConst10 * fTemp6;
			double fTemp7 = fRec20[1] + fConst9 * fTemp6;
			double fRec21 = fTemp7;
			double fTemp8 = fRec21 - fRec18[1];
			fRec18[0] = fRec18[1] + fConst10 * fTemp8;
			double fTemp9 = fRec18[1] + fConst9 * fTemp8;
			double fRec19 = fTemp9;
			double fTemp10 = fRec19 - fRec16[1];
			fRec16[0] = fRec16[1] + fConst10 * fTemp10;
			double fTemp11 = fRec16[1] + fConst9 * fTemp10;
			double fRec17 = fTemp11;
			double fTemp12 = fRec17 - fRec14[1];
			fRec14[0] = fRec14[1] + fConst10 * fTemp12;
			double fTemp13 = fRec14[1] + fConst9 * fTemp12;
			double fRec15 = fTemp13;
			double fTemp14 = std::max<double>(0.0, std::min<double>(1.0, 1.0 - mydsp_faustpower2_f(fRec15)));
			fVec2[IOTA0 & 2097151] = fTemp14;
			double fTemp15 = 1e+03 * fTemp14;
			fVbargraph1 = FAUSTFLOAT(fTemp15);
			double fTemp16 = fTemp15;
			double fTemp17 = fTemp16 * std::fabs(2.0 * (fRec13[0] + (-0.5 - std::floor(fRec13[0] + -0.5))) + -1.0);
			fVbargraph2 = FAUSTFLOAT(fTemp17);
			double fTemp18 = fTemp17;
			fRec45[0] = fSlow4 + fConst5 * fRec45[1];
			double fTemp19 = double(input0[i0]) + double(input4[i0]);
			double fTemp20 = fSlow3 * fTemp19 * fRec45[0];
			fRec44[0] = std::max<double>(fRec44[1] - fConst3, std::fabs(fTemp20));
			fVbargraph3 = FAUSTFLOAT(2e+01 * std::log10(std::max<double>(2.2250738585072014e-308, std::max<double>(6.309573444801929e-05, fRec44[0]))));
			double fTemp21 = fTemp20;
			double fTemp22 = fTemp21 - fRec42[1];
			fRec42[0] = fRec42[1] + fConst14 * fTemp22;
			double fTemp23 = fRec42[1] + fConst13 * fTemp22;
			double fRec43 = fTemp21 - fTemp23;
			double fTemp24 = fRec43 - fRec40[1];
			fRec40[0] = fRec40[1] + fConst17 * fTemp24;
			double fTemp25 = fRec40[1] + fConst16 * fTemp24;
			double fRec41 = fTemp25;
			fRec39[0] = fConst18 * std::fabs(fRec41) + fConst11 * fRec39[1];
			fVec3[IOTA0 & 2047] = fRec39[0] + 0.995 * fRec38[1];
			fRec38[0] = fVec3[(IOTA0 - iConst7) & 2047];
			double fTemp26 = fRec38[1] - fRec36[1];
			fRec36[0] = fRec36[1] + fConst21 * fTemp26;
			double fTemp27 = fRec36[1] + fConst20 * fTemp26;
			double fRec37 = fTemp27;
			double fTemp28 = fRec37 - fRec34[1];
			fRec34[0] = fRec34[1] + fConst21 * fTemp28;
			double fTemp29 = fRec34[1] + fConst20 * fTemp28;
			double fRec35 = fTemp29;
			double fTemp30 = fRec35 - fRec32[1];
			fRec32[0] = fRec32[1] + fConst21 * fTemp30;
			double fTemp31 = fRec32[1] + fConst20 * fTemp30;
			double fRec33 = fTemp31;
			double fTemp32 = fRec33 - fRec30[1];
			fRec30[0] = fRec30[1] + fConst21 * fTemp32;
			double fTemp33 = fRec30[1] + fConst20 * fTemp32;
			double fRec31 = fTemp33;
			double fTemp34 = fRec31 - fRec28[1];
			fRec28[0] = fRec28[1] + fConst21 * fTemp34;
			double fTemp35 = fRec28[1] + fConst20 * fTemp34;
			double fRec29 = fTemp35;
			double fTemp36 = 1e+03 * std::max<double>(0.0, std::min<double>(1.0, fRec29));
			fVbargraph4 = FAUSTFLOAT(fTemp36);
			double fTemp37 = 0.001 * fTemp36;
			fRec51[0] = fSlow5 + fConst5 * fRec51[1];
			double fTemp38 = fSlow3 * fTemp19 * fRec51[0];
			fRec50[0] = std::max<double>(fRec50[1] - fConst3, std::fabs(fTemp38));
			fVbargraph5 = FAUSTFLOAT(2e+01 * std::log10(std::max<double>(2.2250738585072014e-308, std::max<double>(6.309573444801929e-05, fRec50[0]))));
			double fTemp39 = fTemp38;
			double fTemp40 = fTemp39 - fRec48[1];
			fRec48[0] = fRec48[1] + fConst14 * fTemp40;
			double fTemp41 = fRec48[1] + fConst13 * fTemp40;
			double fRec49 = fTemp39 - fTemp41;
			double fTemp42 = fRec49 - fRec46[1];
			fRec46[0] = fRec46[1] + fConst17 * fTemp42;
			double fTemp43 = fRec46[1] + fConst16 * fTemp42;
			double fRec47 = fTemp43;
			double fTemp44 = fRec47 * (1.0 - fTemp37);
			int iTemp45 = double(iRec68[1]) >= (fRec70[1] + -1.0);
			int iTemp46 = double(iRec72[1]) >= (fRec74[1] + -1.0);
			double fTemp47 = std::fabs(fSlow3 * fTemp0 * fRec27[0]);
			double fTemp48 = std::max<double>(fTemp47, fRec73[1] * (1.0 - double(iTemp46)));
			fVec4[0] = fTemp48;
			fRec71[0] = ((iTemp46) ? fVec4[1] : fRec71[1]);
			iRec72[0] = ((iTemp46) ? 1 : iRec72[1] + 1);
			fRec73[0] = fTemp48;
			int iTemp49 = 1 - iVec0[1];
			fRec76[0] = fConst18 * fTemp47 + fConst11 * fRec76[1];
			fVec5[IOTA0 & 2047] = fRec76[0] + 0.95 * fRec75[1];
			fRec75[0] = fVec5[(IOTA0 - iConst7) & 2047];
			double fTemp50 = std::fabs(fSlow3 * fTemp1 * fRec27[0]);
			fRec78[0] = fConst18 * fTemp50 + fConst11 * fRec78[1];
			fVec6[IOTA0 & 2047] = fRec78[0] + 0.95 * fRec77[1];
			fRec77[0] = fVec6[(IOTA0 - iConst7) & 2047];
			double fTemp51 = fConst0 * std::max<double>(0.0, std::min<double>(1e+03, 6.0 * (fRec77[1] + fRec75[1] + 1.0)));
			fRec74[0] = ((iTemp46 + iTemp49) ? fTemp51 : fRec74[1]);
			int iTemp52 = double(iRec80[1]) >= (fRec82[1] + -1.0);
			double fTemp53 = std::max<double>(fTemp50, fRec81[1] * (1.0 - double(iTemp52)));
			fVec7[0] = fTemp53;
			fRec79[0] = ((iTemp52) ? fVec7[1] : fRec79[1]);
			iRec80[0] = ((iTemp52) ? 1 : iRec80[1] + 1);
			fRec81[0] = fTemp53;
			fRec82[0] = ((iTemp52 + iTemp49) ? fTemp51 : fRec82[1]);
			double fTemp54 = std::max<double>(std::fabs(fRec79[0] - fRec71[0]), fRec69[1] * (1.0 - double(iTemp45)));
			fVec8[0] = fTemp54;
			fRec67[IOTA0 & 4194303] = ((iTemp45) ? fVec8[1] : fRec67[(IOTA0 - 1) & 4194303]);
			iRec68[0] = ((iTemp45) ? 1 : iRec68[1] + 1);
			fRec69[0] = fTemp54;
			fRec70[0] = ((iTemp45 + iTemp49) ? fTemp51 : fRec70[1]);
			fRec66[0] = fRec67[(IOTA0 - iConst22) & 4194303];
			double fTemp55 = 0.5 * (fRec67[IOTA0 & 4194303] + fRec66[1]);
			double fTemp56 = fTemp55 - fRec64[1];
			fRec64[0] = fRec64[1] + fConst21 * fTemp56;
			double fTemp57 = fRec64[1] + fConst20 * fTemp56;
			double fRec65 = fTemp57;
			double fTemp58 = 1e+03 * fRec65;
			fVbargraph6 = FAUSTFLOAT(fTemp58);
			double fTemp59 = fTemp58;
			fRec63[0] = fConst18 * std::fabs(fSlow6 * fTemp2 * fTemp59) + fConst11 * fRec63[1];
			fVec9[IOTA0 & 2047] = fRec63[0] + 0.995 * fRec62[1];
			fRec62[0] = fVec9[(IOTA0 - iConst7) & 2047];
			double fTemp60 = fRec62[1] - fRec60[1];
			fRec60[0] = fRec60[1] + fConst10 * fTemp60;
			double fTemp61 = fRec60[1] + fConst9 * fTemp60;
			double fRec61 = fTemp61;
			double fTemp62 = fRec61 - fRec58[1];
			fRec58[0] = fRec58[1] + fConst10 * fTemp62;
			double fTemp63 = fRec58[1] + fConst9 * fTemp62;
			double fRec59 = fTemp63;
			double fTemp64 = fRec59 - fRec56[1];
			fRec56[0] = fRec56[1] + fConst10 * fTemp64;
			double fTemp65 = fRec56[1] + fConst9 * fTemp64;
			double fRec57 = fTemp65;
			double fTemp66 = fRec57 - fRec54[1];
			fRec54[0] = fRec54[1] + fConst10 * fTemp66;
			double fTemp67 = fRec54[1] + fConst9 * fTemp66;
			double fRec55 = fTemp67;
			double fTemp68 = fRec55 - fRec52[1];
			fRec52[0] = fRec52[1] + fConst10 * fTemp68;
			double fTemp69 = fRec52[1] + fConst9 * fTemp68;
			double fRec53 = fTemp69;
			double fTemp70 = std::max<double>(0.0, std::min<double>(1.0, fRec53));
			fVec10[IOTA0 & 2097151] = fTemp70;
			double fTemp71 = 1e+03 * std::max<double>(0.0, std::min<double>(1.0, ((fTemp70 <= 0.5) ? 1.0 : 2.0 * (1.0 - fTemp70))));
			fVbargraph7 = FAUSTFLOAT(fTemp71);
			double fTemp72 = fTemp71;
			fRec88[0] = fVec2[(IOTA0 - iSlow7) & 2097151];
			double fTemp73 = 1e+03 * std::max<double>(0.0, std::min<double>(1.0, fRec88[1]));
			fVbargraph8 = FAUSTFLOAT(fTemp73);
			double fTemp74 = fTemp73;
			double fTemp75 = 0.001 * fTemp74;
			double fTemp76 = 1.0 - fTemp75;
			double fTemp77 = fSlow8 * fTemp76;
			double fTemp78 = fTemp77 - fRec86[1];
			fRec86[0] = fRec86[1] + fConst27 * fTemp78;
			double fTemp79 = fRec86[1] + fConst26 * fTemp78;
			double fRec87 = fTemp79;
			double fTemp80 = std::max<double>(2e+01, std::min<double>(2.048e+04, fRec87));
			double fTemp81 = std::tan(fConst24 * fTemp80);
			double fTemp82 = fTemp3 - fRec107[1];
			fRec107[0] = fRec107[1] + fSlow11 * fTemp82;
			double fTemp83 = fRec107[1] + fSlow10 * fTemp82;
			double fRec108 = fTemp83;
			double fRec109 = fTemp3 - fTemp83;
			double fTemp84 = fRec108 - fRec105[1];
			fRec105[0] = fRec105[1] + fSlow11 * fTemp84;
			double fTemp85 = fRec105[1] + fSlow10 * fTemp84;
			double fRec106 = fTemp85;
			double fTemp86 = fRec106 - fRec103[1];
			fRec103[0] = fRec103[1] + fSlow11 * fTemp86;
			double fTemp87 = fRec103[1] + fSlow10 * fTemp86;
			double fRec104 = fTemp87;
			fRec102[0] = fConst6 * std::fabs(fRec104) + fConst2 * fRec102[1];
			double fTemp88 = fRec109 - fRec113[1];
			fRec113[0] = fRec113[1] + fSlow11 * fTemp88;
			double fTemp89 = fRec113[1] + fSlow10 * fTemp88;
			double fRec114 = fRec109 - fTemp89;
			double fTemp90 = fRec114 - fRec111[1];
			fRec111[0] = fRec111[1] + fSlow11 * fTemp90;
			double fTemp91 = fRec111[1] + fSlow10 * fTemp90;
			double fRec112 = fRec114 - fTemp91;
			fRec110[0] = fConst29 * std::fabs(fRec112) + fConst28 * fRec110[1];
			double fTemp92 = 1e+03 * (fRec110[0] - fRec102[0]);
			fVbargraph9 = FAUSTFLOAT(fTemp92);
			fVec11[IOTA0 & 2047] = 0.995 * fRec101[1] + 0.001 * fTemp92 * (1.0 - 0.001 * fTemp59);
			fRec101[0] = fVec11[(IOTA0 - iConst7) & 2047];
			double fTemp93 = fRec101[1] - fRec99[1];
			fRec99[0] = fRec99[1] + fConst10 * fTemp93;
			double fTemp94 = fRec99[1] + fConst9 * fTemp93;
			double fRec100 = fTemp94;
			double fTemp95 = fRec100 - fRec97[1];
			fRec97[0] = fRec97[1] + fConst10 * fTemp95;
			double fTemp96 = fRec97[1] + fConst9 * fTemp95;
			double fRec98 = fTemp96;
			double fTemp97 = fRec98 - fRec95[1];
			fRec95[0] = fRec95[1] + fConst10 * fTemp97;
			double fTemp98 = fRec95[1] + fConst9 * fTemp97;
			double fRec96 = fTemp98;
			double fTemp99 = fRec96 - fRec93[1];
			fRec93[0] = fRec93[1] + fConst10 * fTemp99;
			double fTemp100 = fRec93[1] + fConst9 * fTemp99;
			double fRec94 = fTemp100;
			double fTemp101 = fRec94 - fRec91[1];
			fRec91[0] = fRec91[1] + fConst10 * fTemp101;
			double fTemp102 = fRec91[1] + fConst9 * fTemp101;
			double fRec92 = fTemp102;
			double fTemp103 = 1e+03 * std::max<double>(0.0, std::min<double>(1.0, 0.5 * (fRec92 + 1.0)));
			fVbargraph10 = FAUSTFLOAT(fTemp103);
			double fTemp104 = fTemp103;
			double fTemp105 = 0.001 * fTemp104;
			double fTemp106 = 8e+02 * (1.0 - fTemp105);
			double fTemp107 = fTemp106 - fRec89[1];
			fRec89[0] = fRec89[1] + fConst27 * fTemp107;
			double fTemp108 = fRec89[1] + fConst26 * fTemp107;
			double fRec90 = fTemp108;
			double fTemp109 = std::max<double>(0.01, std::min<double>(1e+02, std::max<double>(1.0, std::min<double>(2.048e+04, fRec90)) / fTemp80));
			double fTemp110 = 1.0 / fTemp109 + fTemp81;
			double fTemp111 = fTemp81 * fTemp110 + 1.0;
			double fTemp112 = fSlow12 * std::max<double>(0.01, std::min<double>(1.0, fTemp76));
			iRec123[0] = (iVec0[1] + iRec123[1]) % iSlow13;
			double fTemp113 = double(iRec123[0]);
			double fTemp114 = std::max<double>(1.0, ((fTemp113 > fTemp112) ? fTemp112 : 1.0));
			double fTemp115 = 0.5 * fTemp114;
			fRec124[0] = std::fmod(0.0038314176245210726 * (fSlow14 - fTemp104) + fRec124[1], fTemp114);
			int iTemp116 = std::max<int>(0, std::min<int>(iRec123[0], 881999));
			ftbl1[iTemp116] = fRec8[1];
			int iTemp117 = int(fRec124[0]);
			double fTemp118 = std::floor(fRec124[0]);
			double fTemp119 = fRec124[0] + (-1.0 - fTemp118);
			double fTemp120 = fRec124[0] - fTemp118;
			double fTemp121 = fRec124[0] + (-2.0 - fTemp118);
			double fTemp122 = ((0.0 - fTemp120) * (0.0 - 0.5 * fTemp119) * (0.0 - 0.3333333333333333 * fTemp121) * ftbl1[((iTemp117 + -1) % 882000 + 882000) % 882000] + (fRec124[0] + (1.0 - fTemp118)) * ((0.0 - fTemp119) * (0.0 - 0.5 * fTemp121) * ftbl1[(iTemp117 % 882000 + 882000) % 882000] + 0.5 * fTemp120 * (0.0 - fTemp121) * ftbl1[((iTemp117 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp120 * fTemp119 * ftbl1[((iTemp117 + 2) % 882000 + 882000) % 882000])) * std::min<double>(1.0, 0.005 * std::fabs(std::fmod(fRec124[0] + fTemp115, fTemp114) - fTemp115));
			double fTemp123 = fTemp122 - fRec121[1];
			fRec121[0] = fRec121[1] + fConst14 * fTemp123;
			double fTemp124 = fRec121[1] + fConst13 * fTemp123;
			double fRec122 = fTemp122 - fTemp124;
			double fTemp125 = fRec122 - fRec119[1];
			fRec119[0] = fRec119[1] + fConst14 * fTemp125;
			double fTemp126 = fRec119[1] + fConst13 * fTemp125;
			double fRec120 = fRec122 - fTemp126;
			double fTemp127 = fRec120 - fRec117[1];
			fRec117[0] = fRec117[1] + fConst14 * fTemp127;
			double fTemp128 = fRec117[1] + fConst13 * fTemp127;
			double fRec118 = fRec120 - fTemp128;
			double fTemp129 = fRec118 - fRec115[1];
			fRec115[0] = fRec115[1] + fConst14 * fTemp129;
			double fTemp130 = fRec115[1] + fConst13 * fTemp129;
			double fRec116 = fRec118 - fTemp130;
			double fTemp131 = fRec116 - (fRec83[1] * fTemp110 + fRec84[1]);
			double fTemp132 = fTemp81 * fTemp131 / fTemp111;
			fRec83[0] = fRec83[1] + 2.0 * fTemp132;
			double fTemp133 = fRec83[1] + fTemp132;
			double fTemp134 = fTemp81 * fTemp133;
			fRec84[0] = fRec84[1] + 2.0 * fTemp134;
			double fTemp135 = fTemp133 / fTemp109;
			double fRec85 = fTemp135;
			fRec130[0] = fVec2[(IOTA0 - iSlow15) & 2097151];
			double fTemp136 = 1e+03 * std::max<double>(0.0, std::min<double>(1.0, fRec130[1]));
			fVbargraph11 = FAUSTFLOAT(fTemp136);
			double fTemp137 = fTemp136;
			double fTemp138 = fSlow16 * fTemp137;
			double fTemp139 = fTemp138 - fRec128[1];
			fRec128[0] = fRec128[1] + fConst27 * fTemp139;
			double fTemp140 = fRec128[1] + fConst26 * fTemp139;
			double fRec129 = fTemp140;
			double fTemp141 = std::max<double>(2e+01, std::min<double>(2.048e+04, fRec129));
			double fTemp142 = std::tan(fConst24 * fTemp141);
			double fTemp143 = 0.4 * fTemp104;
			double fTemp144 = fTemp143 - fRec131[1];
			fRec131[0] = fRec131[1] + fConst27 * fTemp144;
			double fTemp145 = fRec131[1] + fConst26 * fTemp144;
			double fRec132 = fTemp145;
			double fTemp146 = std::max<double>(0.01, std::min<double>(1e+02, std::max<double>(1.0, std::min<double>(2.048e+04, fRec132)) / fTemp141));
			double fTemp147 = 1.0 / fTemp146 + fTemp142;
			double fTemp148 = fTemp142 * fTemp147 + 1.0;
			double fTemp149 = fRec116 - (fRec125[1] * fTemp147 + fRec126[1]);
			double fTemp150 = fTemp142 * fTemp149 / fTemp148;
			fRec125[0] = fRec125[1] + 2.0 * fTemp150;
			double fTemp151 = fRec125[1] + fTemp150;
			double fTemp152 = fTemp142 * fTemp151;
			fRec126[0] = fRec126[1] + 2.0 * fTemp152;
			double fTemp153 = fTemp151 / fTemp146;
			double fRec127 = fTemp153;
			double fTemp154 = 0.001 * fTemp137;
			double fTemp155 = 1.0 - fTemp154;
			double fTemp156 = fSlow12 * std::max<double>(0.01, std::min<double>(1.0, fTemp155));
			double fTemp157 = std::max<double>(1.0, ((fTemp113 > fTemp156) ? fTemp156 : 1.0));
			double fTemp158 = 0.5 * fTemp157;
			fRec142[0] = std::fmod(0.0038314176245210726 * (fSlow8 + fTemp104) + fRec142[1], fTemp157);
			int iTemp159 = int(fRec142[0]);
			double fTemp160 = std::floor(fRec142[0]);
			double fTemp161 = fRec142[0] + (-1.0 - fTemp160);
			double fTemp162 = fRec142[0] - fTemp160;
			double fTemp163 = fRec142[0] + (-2.0 - fTemp160);
			double fTemp164 = ((0.0 - fTemp162) * (0.0 - 0.5 * fTemp161) * (0.0 - 0.3333333333333333 * fTemp163) * ftbl1[((iTemp159 + -1) % 882000 + 882000) % 882000] + (fRec142[0] + (1.0 - fTemp160)) * ((0.0 - fTemp161) * (0.0 - 0.5 * fTemp163) * ftbl1[(iTemp159 % 882000 + 882000) % 882000] + 0.5 * fTemp162 * (0.0 - fTemp163) * ftbl1[((iTemp159 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp162 * fTemp161 * ftbl1[((iTemp159 + 2) % 882000 + 882000) % 882000])) * std::min<double>(1.0, 0.005 * std::fabs(std::fmod(fRec142[0] + fTemp158, fTemp157) - fTemp158));
			double fTemp165 = fTemp164 - fRec140[1];
			fRec140[0] = fRec140[1] + fConst14 * fTemp165;
			double fTemp166 = fRec140[1] + fConst13 * fTemp165;
			double fRec141 = fTemp164 - fTemp166;
			double fTemp167 = fRec141 - fRec138[1];
			fRec138[0] = fRec138[1] + fConst14 * fTemp167;
			double fTemp168 = fRec138[1] + fConst13 * fTemp167;
			double fRec139 = fRec141 - fTemp168;
			double fTemp169 = fRec139 - fRec136[1];
			fRec136[0] = fRec136[1] + fConst14 * fTemp169;
			double fTemp170 = fRec136[1] + fConst13 * fTemp169;
			double fRec137 = fRec139 - fTemp170;
			double fTemp171 = fRec137 - fRec134[1];
			fRec134[0] = fRec134[1] + fConst14 * fTemp171;
			double fTemp172 = fRec134[1] + fConst13 * fTemp171;
			fRec135[IOTA0 & 2097151] = fRec137 - fTemp172;
			fRec133[0] = fRec135[(IOTA0 - iSlow7) & 2097151];
			double fTemp173 = fSlow12 * std::max<double>(0.01, std::min<double>(1.0, 0.0005 * (fTemp74 + fTemp16)));
			double fTemp174 = std::max<double>(1.0, ((fTemp113 > fTemp173) ? fTemp173 : 1.0));
			double fTemp175 = 0.5 * fTemp174;
			fRec152[0] = std::fmod(0.0038314176245210726 * (2.9e+02 - 0.09 * fTemp104) + fRec152[1], fTemp174);
			int iTemp176 = int(fRec152[0]);
			double fTemp177 = std::floor(fRec152[0]);
			double fTemp178 = fRec152[0] + (-1.0 - fTemp177);
			double fTemp179 = fRec152[0] - fTemp177;
			double fTemp180 = fRec152[0] + (-2.0 - fTemp177);
			double fTemp181 = ((0.0 - fTemp179) * (0.0 - 0.5 * fTemp178) * (0.0 - 0.3333333333333333 * fTemp180) * ftbl1[((iTemp176 + -1) % 882000 + 882000) % 882000] + (fRec152[0] + (1.0 - fTemp177)) * ((0.0 - fTemp178) * (0.0 - 0.5 * fTemp180) * ftbl1[(iTemp176 % 882000 + 882000) % 882000] + 0.5 * fTemp179 * (0.0 - fTemp180) * ftbl1[((iTemp176 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp179 * fTemp178 * ftbl1[((iTemp176 + 2) % 882000 + 882000) % 882000])) * std::min<double>(1.0, 0.005 * std::fabs(std::fmod(fRec152[0] + fTemp175, fTemp174) - fTemp175));
			double fTemp182 = fTemp181 - fRec150[1];
			fRec150[0] = fRec150[1] + fConst14 * fTemp182;
			double fTemp183 = fRec150[1] + fConst13 * fTemp182;
			double fRec151 = fTemp181 - fTemp183;
			double fTemp184 = fRec151 - fRec148[1];
			fRec148[0] = fRec148[1] + fConst14 * fTemp184;
			double fTemp185 = fRec148[1] + fConst13 * fTemp184;
			double fRec149 = fRec151 - fTemp185;
			double fTemp186 = fRec149 - fRec146[1];
			fRec146[0] = fRec146[1] + fConst14 * fTemp186;
			double fTemp187 = fRec146[1] + fConst13 * fTemp186;
			double fRec147 = fRec149 - fTemp187;
			double fTemp188 = fRec147 - fRec144[1];
			fRec144[0] = fRec144[1] + fConst14 * fTemp188;
			double fTemp189 = fRec144[1] + fConst13 * fTemp188;
			fRec145[IOTA0 & 4194303] = fRec147 - fTemp189;
			fRec143[0] = fRec145[(IOTA0 - iSlow17) & 4194303];
			double fTemp190 = 1e-06 * fTemp16 * (fRec143[1] + fRec133[1] + fRec127 + fRec85) * fTemp72;
			double fTemp191 = double(input1[i0]) + double(input5[i0]);
			double fTemp192 = fSlow3 * fTemp191 * fRec45[0];
			fRec169[0] = std::max<double>(fRec169[1] - fConst3, std::fabs(fTemp192));
			fVbargraph12 = FAUSTFLOAT(2e+01 * std::log10(std::max<double>(2.2250738585072014e-308, std::max<double>(6.309573444801929e-05, fRec169[0]))));
			double fTemp193 = fTemp192;
			double fTemp194 = fTemp193 - fRec167[1];
			fRec167[0] = fRec167[1] + fConst14 * fTemp194;
			double fTemp195 = fRec167[1] + fConst13 * fTemp194;
			double fRec168 = fTemp193 - fTemp195;
			double fTemp196 = fRec168 - fRec165[1];
			fRec165[0] = fRec165[1] + fConst17 * fTemp196;
			double fTemp197 = fRec165[1] + fConst16 * fTemp196;
			double fRec166 = fTemp197;
			fRec164[0] = fConst18 * std::fabs(fRec166) + fConst11 * fRec164[1];
			fVec12[IOTA0 & 2047] = fRec164[0] + 0.995 * fRec163[1];
			fRec163[0] = fVec12[(IOTA0 - iConst7) & 2047];
			double fTemp198 = fRec163[1] - fRec161[1];
			fRec161[0] = fRec161[1] + fConst21 * fTemp198;
			double fTemp199 = fRec161[1] + fConst20 * fTemp198;
			double fRec162 = fTemp199;
			double fTemp200 = fRec162 - fRec159[1];
			fRec159[0] = fRec159[1] + fConst21 * fTemp200;
			double fTemp201 = fRec159[1] + fConst20 * fTemp200;
			double fRec160 = fTemp201;
			double fTemp202 = fRec160 - fRec157[1];
			fRec157[0] = fRec157[1] + fConst21 * fTemp202;
			double fTemp203 = fRec157[1] + fConst20 * fTemp202;
			double fRec158 = fTemp203;
			double fTemp204 = fRec158 - fRec155[1];
			fRec155[0] = fRec155[1] + fConst21 * fTemp204;
			double fTemp205 = fRec155[1] + fConst20 * fTemp204;
			double fRec156 = fTemp205;
			double fTemp206 = fRec156 - fRec153[1];
			fRec153[0] = fRec153[1] + fConst21 * fTemp206;
			double fTemp207 = fRec153[1] + fConst20 * fTemp206;
			double fRec154 = fTemp207;
			double fTemp208 = 1e+03 * std::max<double>(0.0, std::min<double>(1.0, fRec154));
			fVbargraph13 = FAUSTFLOAT(fTemp208);
			double fTemp209 = 0.001 * fTemp208;
			double fTemp210 = fSlow3 * fTemp191 * fRec51[0];
			fRec174[0] = std::max<double>(fRec174[1] - fConst3, std::fabs(fTemp210));
			fVbargraph14 = FAUSTFLOAT(2e+01 * std::log10(std::max<double>(2.2250738585072014e-308, std::max<double>(6.309573444801929e-05, fRec174[0]))));
			double fTemp211 = fTemp210;
			double fTemp212 = fTemp211 - fRec172[1];
			fRec172[0] = fRec172[1] + fConst14 * fTemp212;
			double fTemp213 = fRec172[1] + fConst13 * fTemp212;
			double fRec173 = fTemp211 - fTemp213;
			double fTemp214 = fRec173 - fRec170[1];
			fRec170[0] = fRec170[1] + fConst17 * fTemp214;
			double fTemp215 = fRec170[1] + fConst16 * fTemp214;
			double fRec171 = fTemp215;
			double fTemp216 = fRec171 * (1.0 - fTemp209);
			fRec8[0] = 0.001 * (fTemp216 + fTemp190 + fTemp44) * fTemp18;
			double fRec9 = fTemp190;
			double fTemp217 = std::max<double>(1.0, ((fTemp113 > fSlow12) ? fSlow12 : 1.0));
			double fTemp218 = 0.5 * fTemp217;
			fRec175[0] = std::fmod(0.0038314176245210726 * (0.02 * fTemp104 + 2.5e+02) + fRec175[1], fTemp217);
			int iTemp219 = int(fRec175[0]);
			double fTemp220 = std::floor(fRec175[0]);
			double fTemp221 = fRec175[0] + (-1.0 - fTemp220);
			double fTemp222 = fRec175[0] - fTemp220;
			double fTemp223 = fRec175[0] + (-2.0 - fTemp220);
			double fRec10 = ((0.0 - fTemp222) * (0.0 - 0.5 * fTemp221) * (0.0 - 0.3333333333333333 * fTemp223) * ftbl1[((iTemp219 + -1) % 882000 + 882000) % 882000] + (fRec175[0] + (1.0 - fTemp220)) * ((0.0 - fTemp221) * (0.0 - 0.5 * fTemp223) * ftbl1[(iTemp219 % 882000 + 882000) % 882000] + 0.5 * fTemp222 * (0.0 - fTemp223) * ftbl1[((iTemp219 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp222 * fTemp221 * ftbl1[((iTemp219 + 2) % 882000 + 882000) % 882000])) * std::min<double>(1.0, 0.005 * std::fabs(std::fmod(fRec175[0] + fTemp218, fTemp217) - fTemp218));
			double fTemp224 = 0.001 * fTemp16;
			double fTemp225 = fSlow12 * std::max<double>(0.01, std::min<double>(1.0, fTemp224));
			double fTemp226 = std::max<double>(1.0, ((fTemp113 > fTemp225) ? fTemp225 : 1.0));
			double fTemp227 = 0.5 * fTemp226;
			fRec176[0] = std::fmod(fRec176[1] + 0.766283, fTemp226);
			int iTemp228 = int(fRec176[0]);
			double fTemp229 = std::floor(fRec176[0]);
			double fTemp230 = fRec176[0] + (-1.0 - fTemp229);
			double fTemp231 = fRec176[0] - fTemp229;
			double fTemp232 = fRec176[0] + (-2.0 - fTemp229);
			double fRec11 = ((0.0 - fTemp231) * (0.0 - 0.5 * fTemp230) * (0.0 - 0.3333333333333333 * fTemp232) * ftbl1[((iTemp228 + -1) % 882000 + 882000) % 882000] + (fRec176[0] + (1.0 - fTemp229)) * ((0.0 - fTemp230) * (0.0 - 0.5 * fTemp232) * ftbl1[(iTemp228 % 882000 + 882000) % 882000] + 0.5 * fTemp231 * (0.0 - fTemp232) * ftbl1[((iTemp228 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp231 * fTemp230 * ftbl1[((iTemp228 + 2) % 882000 + 882000) % 882000])) * std::min<double>(1.0, 0.005 * std::fabs(std::fmod(fRec176[0] + fTemp227, fTemp226) - fTemp227));
			fRec12[IOTA0 & 4194303] = fRec116;
			double fTemp233 = 1e+03 * fRec8[0];
			fVbargraph15 = FAUSTFLOAT(fTemp233);
			double fTemp234 = 0.001 * fTemp233;
			ftbl0[iTemp116] = fTemp234;
			int iTemp235 = fRec182[1] < fRec182[2];
			fRec184[0] = fVec10[(IOTA0 - iSlow15) & 2097151];
			double fTemp236 = 1e+03 * std::max<double>(0.0, std::min<double>(1.0, fRec184[1]));
			fVbargraph16 = FAUSTFLOAT(fTemp236);
			double fTemp237 = 0.001 * fTemp236;
			double fTemp238 = ((iTemp235 + iTemp49) ? fConst3 * std::pow(5e+01, 2.0 * (1.0 - fTemp237) + -1.0) : fRec181[1]);
			fRec181[0] = fTemp238;
			double fTemp239 = fRec182[1] + fTemp238;
			fRec182[0] = fTemp239 - std::floor(fTemp239);
			iRec183[0] = (iTemp235 + iRec183[1] + iTemp49) % 8;
			int iTemp240 = iRec183[0] == 7;
			iVec13[0] = iTemp240;
			int iTemp241 = ((fRec178[1] == 0.0) | (fRec178[1] == 1.0)) & (iTemp240 > iVec13[1]);
			double fTemp242 = 0.047619047619047616 * fTemp76;
			iRec185[0] = 1103515245 * iRec185[1] + 12345;
			double fTemp243 = double(iRec185[0]);
			double fTemp244 = fTemp242 + 4.656612875245797e-11 * fTemp243 * (fTemp242 + 0.023) + 0.023;
			double fTemp245 = fConst3 / std::max<double>(fConst3, fTemp244);
			double fTemp246 = ((iTemp241) ? fTemp245 : fRec179[1]);
			fRec178[0] = ((iTemp241) ? fTemp246 : std::min<double>(1.0, fRec178[1] + fTemp246));
			fRec179[0] = fTemp246;
			int iRec180 = iTemp241;
			fRec177[0] = ((iRec180) ? fTemp244 : fRec177[1]);
			fRec187[0] = fSlow18 + (fRec187[1] - std::floor(fSlow18 + fRec187[1]));
			double fTemp247 = std::fabs(2.0 * (fRec187[0] + (-0.5 - std::floor(fRec187[0] + -0.5))) + -1.0);
			double fTemp248 = 5e+02 * (fTemp247 + -2.0);
			fVbargraph17 = FAUSTFLOAT(fTemp248);
			double fTemp249 = fTemp248;
			double fTemp250 = 0.001 * fTemp249 * (1.0 - 0.01 * fTemp76) + 4.656612875245797e-12 * fTemp243 * fTemp76;
			fRec186[0] = ((iRec180) ? fTemp250 : fRec186[1]);
			double fTemp251 = std::fmod(fSlow12 + std::fmod(fSlow12 * fRec186[0] + fConst0 * fRec178[0] * fRec177[0], fSlow12), fSlow12);
			...
			int iTemp257 = iRec183[0] == 6;
			iVec14[0] = iTemp257;
			int iTemp258 = ((fRec189[1] == 0.0) | (fRec189[1] == 1.0)) & (iTemp257 > iVec14[1]);
			double fTemp259 = ((iTemp258) ? fTemp245 : fRec190[1]);
			fRec189[0] = ((iTemp258) ? fTemp259 : std::min<double>(1.0, fRec189[1] + fTemp259));
			fRec190[0] = fTemp259;
			int iRec191 = iTemp258;
			fRec188[0] = ((iRec191) ? fTemp244 : fRec188[1]);
			fRec192[0] = ((iRec191) ? fTemp250 : fRec192[1]);
			double fTemp260 = std::fmod(fSlow12 + std::fmod(fSlow12 * fRec192[0] + fConst0 * fRec189[0] * fRec188[0], fSlow12), fSlow12);
			...
			int iTemp266 = iRec183[0] == 5;
			iVec15[0] = iTemp266;
			int iTemp267 = ((fRec194[1] == 0.0) | (fRec194[1] == 1.0)) & (iTemp266 > iVec15[1]);
			double fTemp268 = ((iTemp267) ? fTemp245 : fRec195[1]);
			fRec194[0] = ((iTemp267) ? fTemp268 : std::min<double>(1.0, fRec194[1] + fTemp268));
			fRec195[0] = fTemp268;
			int iRec196 = iTemp267;
			fRec193[0] = ((iRec196) ? fTemp244 : fRec193[1]);
			fRec197[0] = ((iRec196) ? fTemp250 : fRec197[1]);
			double fTemp269 = std::fmod(fSlow12 + std::fmod(fSlow12 * fRec197[0] + fConst0 * fRec194[0] * fRec193[0], fSlow12), fSlow12);
			...
			int iTemp275 = iRec183[0] == 4;
			iVec16[0] = iTemp275;
			int iTemp276 = ((fRec199[1] == 0.0) | (fRec199[1] == 1.0)) & (iTemp275 > iVec16[1]);
			double fTemp277 = ((iTemp276) ? fTemp245 : fRec200[1]);
			fRec199[0] = ((iTemp276) ? fTemp277 : std::min<double>(1.0, fRec199[1] + fTemp277));
			fRec200[0] = fTemp277;
			int iRec201 = iTemp276;
			fRec198[0] = ((iRec201) ? fTemp244 : fRec198[1]);
			fRec202[0] = ((iRec201) ? fTemp250 : fRec202[1]);
			double fTemp278 = std::fmod(fSlow12 + std::fmod(fSlow12 * fRec202[0] + fConst0 * fRec199[0] * fRec198[0], fSlow12), fSlow12);
			...
			int iTemp284 = iRec183[0] == 3;
			iVec17[0] = iTemp284;
			int iTemp285 = ((fRec204[1] == 0.0) | (fRec204[1] == 1.0)) & (iTemp284 > iVec17[1]);
			double fTemp286 = ((iTemp285) ? fTemp245 : fRec205[1]);
			fRec204[0] = ((iTemp285) ? fTemp286 : std::min<double>(1.0, fRec204[1] + fTemp286));
			fRec205[0] = fTemp286;
			int iRec206 = iTemp285;
			fRec203[0] = ((iRec206) ? fTemp244 : fRec203[1]);
			fRec207[0] = ((iRec206) ? fTemp250 : fRec207[1]);
			double fTemp287 = std::fmod(fSlow12 + std::fmod(fSlow12 * fRec207[0] + fConst0 * fRec204[0] * fRec203[0], fSlow12), fSlow12);
			...
			int iTemp293 = iRec183[0] == 2;
			iVec18[0] = iTemp293;
			int iTemp294 = ((fRec209[1] == 0.0) | (fRec209[1] == 1.0)) & (iTemp293 > iVec18[1]);
			double fTemp295 = ((iTemp294) ? fTemp245 : fRec210[1]);
			fRec209[0] = ((iTemp294) ? fTemp295 : std::min<double>(1.0, fRec209[1] + fTemp295));
			fRec210[0] = fTemp295;
			int iRec211 = iTemp294;
			fRec208[0] = ((iRec211) ? fTemp244 : fRec208[1]);
			fRec212[0] = ((iRec211) ? fTemp250 : fRec212[1]);
			double fTemp296 = std::fmod(fSlow12 + std::fmod(fSlow12 * fRec212[0] + fConst0 * fRec209[0] * fRec208[0], fSlow12), fSlow12);
			...
			int iTemp302 = iRec183[0] == 1;
			iVec19[0] = iTemp302;
			int iTemp303 = ((fRec214[1] == 0.0) | (fRec214[1] == 1.0)) & (iTemp302 > iVec19[1]);
			double fTemp304 = ((iTemp303) ? fTemp245 : fRec215[1]);
			fRec214[0] = ((iTemp303) ? fTemp304 : std::min<double>(1.0, fRec214[1] + fTemp304));
			fRec215[0] = fTemp304;
			int iRec216 = iTemp303;
			fRec213[0] = ((iRec216) ? fTemp244 : fRec213[1]);
			fRec217[0] = ((iRec216) ? fTemp250 : fRec217[1]);
			double fTemp305 = std::fmod(fSlow12 + std::fmod(fSlow12 * fRec217[0] + fConst0 * fRec214[0] * fRec213[0], fSlow12), fSlow12);
			int iTemp306 = int(fTemp305);
			double fTemp307 = std::floor(fTemp305);
			double fTemp308 = fTemp305 + (-1.0 - fTemp307);
			double fTemp309 = fTemp305 - fTemp307;
			double fTemp310 = fTemp305 + (-2.0 - fTemp307);
			int iTemp311 = iRec183[0] == 0;
			iVec20[0] = iTemp311;
			int iTemp312 = ((fRec219[1] == 0.0) | (fRec219[1] == 1.0)) & (iTemp311 > iVec20[1]);
			double fTemp313 = ((iTemp312) ? fTemp245 : fRec220[1]);
			fRec219[0] = ((iTemp312) ? fTemp313 : std::min<double>(1.0, fRec219[1] + fTemp313));
			fRec220[0] = fTemp313;
			int iRec221 = iTemp312;
			fRec218[0] = ((iRec221) ? fTemp244 : fRec218[1]);
			fRec222[0] = ((iRec221) ? fTemp250 : fRec222[1]);
			double fTemp314 = std::fmod(fSlow12 + std::fmod(fSlow12 * fRec222[0] + fConst0 * fRec219[0] * fRec218[0], fSlow12), fSlow12);
			int iTemp315 = int(fTemp314);
			double fTemp316 = std::floor(fTemp314);
			double fTemp317 = fTemp314 + (-1.0 - fTemp316);
			double fTemp318 = fTemp314 - fTemp316;
			double fTemp319 = fTemp314 + (-2.0 - fTemp316);
			double fTemp320 = mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec219[0])) * ((0.0 - fTemp318) * (0.0 - 0.5 * fTemp317) * (0.0 - 0.3333333333333333 * fTemp319) * ftbl0[((iTemp315 + -1) % 882000 + 882000) % 882000] + (fTemp314 + (1.0 - fTemp316)) * ((0.0 - fTemp317) * (0.0 - 0.5 * fTemp319) * ftbl0[(iTemp315 % 882000 + 882000) % 882000] + 0.5 * fTemp318 * (0.0 - fTemp319) * ftbl0[((iTemp315 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp318 * fTemp317 * ftbl0[((iTemp315 + 2) % 882000 + 882000) % 882000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec214[0])) * ((0.0 - fTemp309) * (0.0 - 0.5 * fTemp308) * (0.0 - 0.3333333333333333 * fTemp310) * ftbl0[((iTemp306 + -1) % 882000 + 882000) % 882000] + (fTemp305 + (1.0 - fTemp307)) * ((0.0 - fTemp308) * (0.0 - 0.5 * fTemp310) * ftbl0[(iTemp306 % 882000 + 882000) % 882000] + 0.5 * fTemp309 * (0.0 - fTemp310) * ftbl0[((iTemp306 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp309 * fTemp308 * ftbl0[((iTemp306 + 2) % 882000 + 882000) % 882000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec209[0])) * ((0.0 - fTemp300) * (0.0 - 0.5 * fTemp299) * (0.0 - 0.3333333333333333 * fTemp301) * ftbl0[((iTemp297 + -1) % 882000 + 882000) % 882000] + (fTemp296 + (1.0 - fTemp298)) * ((0.0 - fTemp299) * (0.0 - 0.5 * fTemp301) * ftbl0[(iTemp297 % 882000 + 882000) % 882000] + 0.5 * fTemp300 * (0.0 - fTemp301) * ftbl0[((iTemp297 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp300 * fTemp299 * ftbl0[((iTemp297 + 2) % 882000 + 882000) % 882000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec204[0])) * ((0.0 - fTemp291) * (0.0 - 0.5 * fTemp290) * (0.0 - 0.3333333333333333 * fTemp292) * ftbl0[((iTemp288 + -1) % 882000 + 882000) % 882000] + (fTemp287 + (1.0 - fTemp289)) * ((0.0 - fTemp290) * (0.0 - 0.5 * fTemp292) * ftbl0[(iTemp288 % 882000 + 882000) % 882000] + 0.5 * fTemp291 * (0.0 - fTemp292) * ftbl0[((iTemp288 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp291 * fTemp290 * ftbl0[((iTemp288 + 2) % 882000 + 882000) % 882000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec199[0])) * ((0.0 - fTemp282) * (0.0 - 0.5 * fTemp281) * (0.0 - 0.3333333333333333 * fTemp283) * ftbl0[((iTemp279 + -1) % 882000 + 882000) % 882000] + (fTemp278 + (1.0 - fTemp280)) * ((0.0 - fTemp281) * (0.0 - 0.5 * fTemp283) * ftbl0[(iTemp279 % 882000 + 882000) % 882000] + 0.5 * fTemp282 * (0.0 - fTemp283) * ftbl0[((iTemp279 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp282 * fTemp281 * ftbl0[((iTemp279 + 2) % 882000 + 882000) % 882000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec194[0])) * ((0.0 - fTemp273) * (0.0 - 0.5 * fTemp272) * (0.0 - 0.3333333333333333 * fTemp274) * ftbl0[((iTemp270 + -1) % 882000 + 882000) % 882000] + (fTemp269 + (1.0 - fTemp271)) * ((0.0 - fTemp272) * (0.0 - 0.5 * fTemp274) * ftbl0[(iTemp270 % 882000 + 882000) % 882000] + 0.5 * fTemp273 * (0.0 - fTemp274) * ftbl0[((iTemp270 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp273 * fTemp272 * ftbl0[((iTemp270 + 2) % 882000 + 882000) % 882000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec189[0])) * ((0.0 - fTemp264) * (0.0 - 0.5 * fTemp263) * (0.0 - 0.3333333333333333 * fTemp265) * ftbl0[((iTemp261 + -1) % 882000 + 882000) % 882000] + (fTemp260 + (1.0 - fTemp262)) * ((0.0 - fTemp263) * (0.0 - 0.5 * fTemp265) * ftbl0[(iTemp261 % 882000 + 882000) % 882000] + 0.5 * fTemp264 * (0.0 - fTemp265) * ftbl0[((iTemp261 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp264 * fTemp263 * ftbl0[((iTemp261 + 2) % 882000 + 882000) % 882000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec178[0])) * ((0.0 - fTemp255) * (0.0 - 0.5 * fTemp254) * (0.0 - 0.3333333333333333 * fTemp256) * ftbl0[((iTemp252 + -1) % 882000 + 882000) % 882000] + (fTemp251 + (1.0 - fTemp253)) * ((0.0 - fTemp254) * (0.0 - 0.5 * fTemp256) * ftbl0[(iTemp252 % 882000 + 882000) % 882000] + 0.5 * fTemp255 * (0.0 - fTemp256) * ftbl0[((iTemp252 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp255 * fTemp254 * ftbl0[((iTemp252 + 2) % 882000 + 882000) % 882000]));
			fRec0[0] = 0.125 * fTemp320;
			int iTemp321 = fRec228[1] < fRec228[2];
			fRec230[0] = fVec10[(IOTA0 - iSlow7) & 2097151];
			double fTemp322 = 1e+03 * std::max<double>(0.0, std::min<double>(1.0, fRec230[1]));
			fVbargraph18 = FAUSTFLOAT(fTemp322);
			double fTemp323 = 0.001 * fTemp322;
			double fTemp324 = ((iTemp321 + iTemp49) ? fConst3 * std::pow(5e+01, 2.0 * (1.0 - fTemp323) + -1.0) : fRec227[1]);
			fRec227[0] = fTemp324;
			double fTemp325 = fRec228[1] + fTemp324;
			fRec228[0] = fTemp325 - std::floor(fTemp325);
			iRec229[0] = (iTemp321 + iRec229[1] + iTemp49) % 8;
			int iTemp326 = iRec229[0] == 7;
			iVec21[0] = iTemp326;
			int iTemp327 = ((fRec224[1] == 0.0) | (fRec224[1] == 1.0)) & (iTemp326 > iVec21[1]);
			double fTemp328 = 0.05 * fTemp155;
			double fTemp329 = fTemp328 + 4.656612875245797e-11 * fTemp243 * (fTemp328 + 0.023) + 0.023;
			double fTemp330 = fConst3 / std::max<double>(fConst3, fTemp329);
			double fTemp331 = ((iTemp327) ? fTemp330 : fRec225[1]);
			fRec224[0] = ((iTemp327) ? fTemp331 : std::min<double>(1.0, fRec224[1] + fTemp331));
			fRec225[0] = fTemp331;
			int iRec226 = iTemp327;
			fRec223[0] = ((iRec226) ? fTemp329 : fRec223[1]);
			double fTemp332 = 5e+02 * (fTemp247 + 1.0);
			fVbargraph19 = FAUSTFLOAT(fTemp332);
			double fTemp333 = fTemp332;
			double fTemp334 = 0.001 * fTemp333 * (1.0 - 0.01 * fTemp155) + 4.656612875245797e-12 * fTemp243 * fTemp155;
			fRec231[0] = ((iRec226) ? fTemp334 : fRec231[1]);
			double fTemp335 = std::fmod(fSlow12 + std::fmod(fSlow12 * fRec231[0] + fConst0 * fRec224[0] * fRec223[0], fSlow12), fSlow12);
			int iTemp336 = int(fTemp335);
			double fTemp337 = std::floor(fTemp335);
			double fTemp338 = fTemp335 + (-1.0 - fTemp337);
			double fTemp339 = fTemp335 - fTemp337;
			double fTemp340 = fTemp335 + (-2.0 - fTemp337);
			int iTemp341 = iRec229[0] == 6;
			iVec22[0] = iTemp341;
			int iTemp342 = ((fRec233[1] == 0.0) | (fRec233[1] == 1.0)) & (iTemp341 > iVec22[1]);
			double fTemp343 = ((iTemp342) ? fTemp330 : fRec234[1]);
			fRec233[0] = ((iTemp342) ? fTemp343 : std::min<double>(1.0, fRec233[1] + fTemp343));
			fRec234[0] = fTemp343;
			int iRec235 = iTemp342;
			fRec232[0] = ((iRec235) ? fTemp329 : fRec232[1]);
			fRec236[0] = ((iRec235) ? fTemp334 : fRec236[1]);
			double fTemp344 = std::fmod(fSlow12 + std::fmod(fSlow12 * fRec236[0] + fConst0 * fRec233[0] * fRec232[0], fSlow12), fSlow12);
			...
			int iTemp350 = iRec229[0] == 5;
			iVec23[0] = iTemp350;
			int iTemp351 = ((fRec238[1] == 0.0) | (fRec238[1] == 1.0)) & (iTemp350 > iVec23[1]);
			double fTemp352 = ((iTemp351) ? fTemp330 : fRec239[1]);
			fRec238[0] = ((iTemp351) ? fTemp352 : std::min<double>(1.0, fRec238[1] + fTemp352));
			fRec239[0] = fTemp352;
			int iRec240 = iTemp351;
			fRec237[0] = ((iRec240) ? fTemp329 : fRec237[1]);
			fRec241[0] = ((iRec240) ? fTemp334 : fRec241[1]);
			double fTemp353 = std::fmod(fSlow12 + std::fmod(fSlow12 * fRec241[0] + fConst0 * fRec238[0] * fRec237[0], fSlow12), fSlow12);
			...
			int iTemp359 = iRec229[0] == 4;
			iVec24[0] = iTemp359;
			int iTemp360 = ((fRec243[1] == 0.0) | (fRec243[1] == 1.0)) & (iTemp359 > iVec24[1]);
			double fTemp361 = ((iTemp360) ? fTemp330 : fRec244[1]);
			fRec243[0] = ((iTemp360) ? fTemp361 : std::min<double>(1.0, fRec243[1] + fTemp361));
			fRec244[0] = fTemp361;
			int iRec245 = iTemp360;
			fRec242[0] = ((iRec245) ? fTemp329 : fRec242[1]);
			fRec246[0] = ((iRec245) ? fTemp334 : fRec246[1]);
			double fTemp362 = std::fmod(fSlow12 + std::fmod(fSlow12 * fRec246[0] + fConst0 * fRec243[0] * fRec242[0], fSlow12), fSlow12);
			...
			int iTemp368 = iRec229[0] == 3;
			iVec25[0] = iTemp368;
			int iTemp369 = ((fRec248[1] == 0.0) | (fRec248[1] == 1.0)) & (iTemp368 > iVec25[1]);
			double fTemp370 = ((iTemp369) ? fTemp330 : fRec249[1]);
			fRec248[0] = ((iTemp369) ? fTemp370 : std::min<double>(1.0, fRec248[1] + fTemp370));
			fRec249[0] = fTemp370;
			int iRec250 = iTemp369;
			fRec247[0] = ((iRec250) ? fTemp329 : fRec247[1]);
			fRec251[0] = ((iRec250) ? fTemp334 : fRec251[1]);
			double fTemp371 = std::fmod(fSlow12 + std::fmod(fSlow12 * fRec251[0] + fConst0 * fRec248[0] * fRec247[0], fSlow12), fSlow12);
			...
			int iTemp377 = iRec229[0] == 2;
			iVec26[0] = iTemp377;
			int iTemp378 = ((fRec253[1] == 0.0) | (fRec253[1] == 1.0)) & (iTemp377 > iVec26[1]);
			double fTemp379 = ((iTemp378) ? fTemp330 : fRec254[1]);
			fRec253[0] = ((iTemp378) ? fTemp379 : std::min<double>(1.0, fRec253[1] + fTemp379));
			fRec254[0] = fTemp379;
			int iRec255 = iTemp378;
			fRec252[0] = ((iRec255) ? fTemp329 : fRec252[1]);
			fRec256[0] = ((iRec255) ? fTemp334 : fRec256[1]);
			double fTemp380 = std::fmod(fSlow12 + std::fmod(fSlow12 * fRec256[0] + fConst0 * fRec253[0] * fRec252[0], fSlow12), fSlow12);
			...
			int iTemp386 = iRec229[0] == 1;
			iVec27[0] = iTemp386;
			int iTemp387 = ((fRec258[1] == 0.0) | (fRec258[1] == 1.0)) & (iTemp386 > iVec27[1]);
			double fTemp388 = ((iTemp387) ? fTemp330 : fRec259[1]);
			fRec258[0] = ((iTemp387) ? fTemp388 : std::min<double>(1.0, fRec258[1] + fTemp388));
			fRec259[0] = fTemp388;
			int iRec260 = iTemp387;
			fRec257[0] = ((iRec260) ? fTemp329 : fRec257[1]);
			fRec261[0] = ((iRec260) ? fTemp334 : fRec261[1]);
			double fTemp389 = std::fmod(fSlow12 + std::fmod(fSlow12 * fRec261[0] + fConst0 * fRec258[0] * fRec257[0], fSlow12), fSlow12);
			...
			int iTemp395 = iRec229[0] == 0;
			iVec28[0] = iTemp395;
			int iTemp396 = ((fRec263[1] == 0.0) | (fRec263[1] == 1.0)) & (iTemp395 > iVec28[1]);
			double fTemp397 = ((iTemp396) ? fTemp330 : fRec264[1]);
			fRec263[0] = ((iTemp396) ? fTemp397 : std::min<double>(1.0, fRec263[1] + fTemp397));
			fRec264[0] = fTemp397;
			int iRec265 = iTemp396;
			fRec262[0] = ((iRec265) ? fTemp329 : fRec262[1]);
			fRec266[0] = ((iRec265) ? fTemp334 : fRec266[1]);
			double fTemp398 = std::fmod(fSlow12 + std::fmod(fSlow12 * fRec266[0] + fConst0 * fRec263[0] * fRec262[0], fSlow12), fSlow12);
			...
			double fTemp404 = mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec263[0])) * ((0.0 - fTemp402) * (0.0 - 0.5 * fTemp401) * (0.0 - 0.3333333333333333 * fTemp403) * ftbl0[((iTemp399 + -1) % 882000 + 882000) % 882000] + (fTemp398 + (1.0 - fTemp400)) * ((0.0 - fTemp401) * (0.0 - 0.5 * fTemp403) * ftbl0[(iTemp399 % 882000 + 882000) % 882000] + 0.5 * fTemp402 * (0.0 - fTemp403) * ftbl0[((iTemp399 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp402 * fTemp401 * ftbl0[((iTemp399 + 2) % 882000 + 882000) % 882000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec258[0])) * ((0.0 - fTemp393) * (0.0 - 0.5 * fTemp392) * (0.0 - 0.3333333333333333 * fTemp394) * ftbl0[((iTemp390 + -1) % 882000 + 882000) % 882000] + (fTemp389 + (1.0 - fTemp391)) * ((0.0 - fTemp392) * (0.0 - 0.5 * fTemp394) * ftbl0[(iTemp390 % 882000 + 882000) % 882000] + 0.5 * fTemp393 * (0.0 - fTemp394) * ftbl0[((iTemp390 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp393 * fTemp392 * ftbl0[((iTemp390 + 2) % 882000 + 882000) % 882000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec253[0])) * ((0.0 - fTemp384) * (0.0 - 0.5 * fTemp383) * (0.0 - 0.3333333333333333 * fTemp385) * ftbl0[((iTemp381 + -1) % 882000 + 882000) % 882000] + (fTemp380 + (1.0 - fTemp382)) * ((0.0 - fTemp383) * (0.0 - 0.5 * fTemp385) * ftbl0[(iTemp381 % 882000 + 882000) % 882000] + 0.5 * fTemp384 * (0.0 - fTemp385) * ftbl0[((iTemp381 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp384 * fTemp383 * ftbl0[((iTemp381 + 2) % 882000 + 882000) % 882000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec248[0])) * ((0.0 - fTemp375) * (0.0 - 0.5 * fTemp374) * (0.0 - 0.3333333333333333 * fTemp376) * ftbl0[((iTemp372 + -1) % 882000 + 882000) % 882000] + (fTemp371 + (1.0 - fTemp373)) * ((0.0 - fTemp374) * (0.0 - 0.5 * fTemp376) * ftbl0[(iTemp372 % 882000 + 882000) % 882000] + 0.5 * fTemp375 * (0.0 - fTemp376) * ftbl0[((iTemp372 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp375 * fTemp374 * ftbl0[((iTemp372 + 2) % 882000 + 882000) % 882000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec243[0])) * ((0.0 - fTemp366) * (0.0 - 0.5 * fTemp365) * (0.0 - 0.3333333333333333 * fTemp367) * ftbl0[((iTemp363 + -1) % 882000 + 882000) % 882000] + (fTemp362 + (1.0 - fTemp364)) * ((0.0 - fTemp365) * (0.0 - 0.5 * fTemp367) * ftbl0[(iTemp363 % 882000 + 882000) % 882000] + 0.5 * fTemp366 * (0.0 - fTemp367) * ftbl0[((iTemp363 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp366 * fTemp365 * ftbl0[((iTemp363 + 2) % 882000 + 882000) % 882000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec238[0])) * ((0.0 - fTemp357) * (0.0 - 0.5 * fTemp356) * (0.0 - 0.3333333333333333 * fTemp358) * ftbl0[((iTemp354 + -1) % 882000 + 882000) % 882000] + (fTemp353 + (1.0 - fTemp355)) * ((0.0 - fTemp356) * (0.0 - 0.5 * fTemp358) * ftbl0[(iTemp354 % 882000 + 882000) % 882000] + 0.5 * fTemp357 * (0.0 - fTemp358) * ftbl0[((iTemp354 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp357 * fTemp356 * ftbl0[((iTemp354 + 2) % 882000 + 882000) % 882000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec233[0])) * ((0.0 - fTemp348) * (0.0 - 0.5 * fTemp347) * (0.0 - 0.3333333333333333 * fTemp349) * ftbl0[((iTemp345 + -1) % 882000 + 882000) % 882000] + (fTemp344 + (1.0 - fTemp346)) * ((0.0 - fTemp347) * (0.0 - 0.5 * fTemp349) * ftbl0[(iTemp345 % 882000 + 882000) % 882000] + 0.5 * fTemp348 * (0.0 - fTemp349) * ftbl0[((iTemp345 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp348 * fTemp347 * ftbl0[((iTemp345 + 2) % 882000 + 882000) % 882000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec224[0])) * ((0.0 - fTemp339) * (0.0 - 0.5 * fTemp338) * (0.0 - 0.3333333333333333 * fTemp340) * ftbl0[((iTemp336 + -1) % 882000 + 882000) % 882000] + (fTemp335 + (1.0 - fTemp337)) * ((0.0 - fTemp338) * (0.0 - 0.5 * fTemp340) * ftbl0[(iTemp336 % 882000 + 882000) % 882000] + 0.5 * fTemp339 * (0.0 - fTemp340) * ftbl0[((iTemp336 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp339 * fTemp338 * ftbl0[((iTemp336 + 2) % 882000 + 882000) % 882000]));
			fRec1[0] = 0.125 * fTemp404;
			double fTemp405 = 1.0 - fTemp224;
			double fTemp406 = 1e+03 * fTemp70;
			fVbargraph20 = FAUSTFLOAT(fTemp406);
			double fTemp407 = fTemp406;
			double fTemp408 = 0.001 * fTemp407;
			double fTemp409 = fRec267[1] + fSlow19 * (1.0 - fTemp408);
			fRec267[0] = fTemp409 - std::floor(fTemp409);
			double fTemp410 = 1e+03 * std::fabs(2.0 * (fRec267[0] + (-0.5 - std::floor(fRec267[0] + -0.5))) + -1.0);
			fVbargraph21 = FAUSTFLOAT(fTemp410);
			double fTemp411 = fTemp410;
			double fTemp412 = 0.001 * fTemp411;
			fRec280[0] = fConst18 * std::fabs(fRec0[1] + fRec1[1]) + fConst11 * fRec280[1];
			fVec29[IOTA0 & 2047] = fRec280[0] + 0.97 * fRec279[1];
			fRec279[0] = fVec29[(IOTA0 - iConst7) & 2047];
			double fTemp413 = fRec279[1] - fRec277[1];
			fRec277[0] = fRec277[1] + fConst21 * fTemp413;
			double fTemp414 = fRec277[1] + fConst20 * fTemp413;
			double fRec278 = fTemp414;
			double fTemp415 = fRec278 - fRec275[1];
			fRec275[0] = fRec275[1] + fConst21 * fTemp415;
			double fTemp416 = fRec275[1] + fConst20 * fTemp415;
			double fRec276 = fTemp416;
			double fTemp417 = fRec276 - fRec273[1];
			fRec273[0] = fRec273[1] + fConst21 * fTemp417;
			double fTemp418 = fRec273[1] + fConst20 * fTemp417;
			double fRec274 = fTemp418;
			double fTemp419 = fRec274 - fRec271[1];
			fRec271[0] = fRec271[1] + fConst21 * fTemp419;
			double fTemp420 = fRec271[1] + fConst20 * fTemp419;
			double fRec272 = fTemp420;
			double fTemp421 = fRec272 - fRec269[1];
			fRec269[0] = fRec269[1] + fConst21 * fTemp421;
			double fTemp422 = fRec269[1] + fConst20 * fTemp421;
			double fRec270 = fTemp422;
			fVec30[IOTA0 & 8388607] = fRec270 + fSlow20 * fRec268[1];
			fRec268[0] = fVec30[(IOTA0 - iSlow21) & 8388607];
			double fTemp423 = 1e+03 * std::max<double>(0.0, std::min<double>(1.0, 1.0 - 0.5 * (fRec270 + fRec268[1])));
			fVbargraph22 = FAUSTFLOAT(fTemp423);
			double fTemp424 = fTemp423;
			double fTemp425 = fRec9 * fTemp16;
			fVec31[IOTA0 & 16383] = fTemp425;
			double fTemp426 = 0.001 * fTemp425 * fTemp424 * (1.0 - fTemp412);
			fVbargraph23 = FAUSTFLOAT(fTemp426);
			double fTemp427 = fTemp426;
			double fTemp428 = fTemp44 * fTemp424;
			fVbargraph24 = FAUSTFLOAT(fTemp428);
			double fTemp429 = fTemp428;
			double fTemp430 = fRec11 - fRec289[1];
			fRec289[0] = fRec289[1] + fConst14 * fTemp430;
			double fTemp431 = fRec289[1] + fConst13 * fTemp430;
			double fRec290 = fRec11 - fTemp431;
			double fTemp432 = fRec290 - fRec287[1];
			fRec287[0] = fRec287[1] + fConst14 * fTemp432;
			double fTemp433 = fRec287[1] + fConst13 * fTemp432;
			double fRec288 = fRec290 - fTemp433;
			double fTemp434 = fRec288 - fRec285[1];
			fRec285[0] = fRec285[1] + fConst14 * fTemp434;
			double fTemp435 = fRec285[1] + fConst13 * fTemp434;
			double fRec286 = fRec288 - fTemp435;
			double fTemp436 = fRec286 - fRec283[1];
			fRec283[0] = fRec283[1] + fConst14 * fTemp436;
			double fTemp437 = fRec283[1] + fConst13 * fTemp436;
			fRec284[IOTA0 & 2097151] = fRec286 - fTemp437;
			fRec282[0] = fRec284[(IOTA0 - iSlow22) & 2097151];
			double fTemp438 = 1e+03 * fRec282[1];
			fVbargraph25 = FAUSTFLOAT(fTemp438);
			double fTemp439 = fTemp438;
			fVec32[IOTA0 & 8191] = fTemp439;
			fRec281[0] = 0.001 * fVec32[(IOTA0 - iConst34) & 8191];
			double fTemp440 = fRec10 - fRec298[1];
			fRec298[0] = fRec298[1] + fConst14 * fTemp440;
			double fTemp441 = fRec298[1] + fConst13 * fTemp440;
			double fRec299 = fRec10 - fTemp441;
			double fTemp442 = fRec299 - fRec296[1];
			fRec296[0] = fRec296[1] + fConst14 * fTemp442;
			double fTemp443 = fRec296[1] + fConst13 * fTemp442;
			double fRec297 = fRec299 - fTemp443;
			double fTemp444 = fRec297 - fRec294[1];
			fRec294[0] = fRec294[1] + fConst14 * fTemp444;
			double fTemp445 = fRec294[1] + fConst13 * fTemp444;
			double fRec295 = fRec297 - fTemp445;
			double fTemp446 = fRec295 - fRec292[1];
			fRec292[0] = fRec292[1] + fConst14 * fTemp446;
			double fTemp447 = fRec292[1] + fConst13 * fTemp446;
			fRec293[IOTA0 & 2097151] = fRec295 - fTemp447;
			fRec291[0] = fRec293[(IOTA0 - iSlow15) & 2097151];
			double fTemp448 = 1e+03 * fRec291[1];
			fVbargraph26 = FAUSTFLOAT(fTemp448);
			double fTemp449 = fTemp448;
			fVec33[IOTA0 & 8191] = fTemp449;
			fRec300[0] = fSlow23 + (fRec300[1] - std::floor(fSlow23 + fRec300[1]));
			double fTemp450 = 1e+03 * std::fabs(2.0 * (fRec300[0] + (-0.5 - std::floor(fRec300[0] + -0.5))) + -1.0);
			fVbargraph27 = FAUSTFLOAT(fTemp450);
			double fTemp451 = fTemp450;
			fRec301[0] = 0.001 * fVec33[(IOTA0 - iConst35) & 8191];
			double fTemp452 = 0.001 * fTemp451;
			double fTemp453 = 1.0 - fTemp452;
			fRec302[0] = fSlow24 + fConst5 * fRec302[1];
			double fTemp454 = fRec302[0] * (0.000125 * fTemp16 * fTemp404 + fTemp453 * (fRec301[1] + fRec281[1]) + fTemp451 * (1e-06 * fTemp449 + 0.001 * fRec281[1]) + 0.001 * (fTemp429 + fTemp427) + 0.125 * fTemp320 * fTemp405);
			fVec34[IOTA0 & 16383] = fTemp454;
			double fTemp455 = 1e+03 * fTemp454;
			fVbargraph28 = FAUSTFLOAT(fTemp455);
			double fRec2 = 0.001 * fTemp455;
			fRec303[0] = fRec12[(IOTA0 - iSlow25) & 4194303];
			double fTemp456 = fTemp424 * fRec303[1];
			fVbargraph29 = FAUSTFLOAT(fTemp456);
			double fTemp457 = fTemp456;
			double fTemp458 = 1.0000000000000002e-06 * fTemp424 * fTemp411 * fVec31[(IOTA0 - int(std::min<double>(fConst37, double(std::max<int>(0, std::max<int>(0, int(fConst38 * fTemp407))))))) & 16383];
			fVbargraph30 = FAUSTFLOAT(fTemp458);
			double fTemp459 = fTemp458;
			double fTemp460 = fTemp216 * fTemp424;
			fVbargraph31 = FAUSTFLOAT(fTemp460);
			double fTemp461 = fTemp460;
			double fTemp462 = fRec302[0] * (0.125 * fTemp404 * fTemp405 + 1e-06 * fTemp451 * fTemp439 + 0.001 * (fTemp449 * fTemp453 + fRec301[1] * fTemp451 + fTemp453 * fTemp439 + fTemp461 + fTemp459 + fTemp457) + 0.000125 * fTemp16 * fTemp320);
			fVec35[IOTA0 & 16383] = fTemp462;
			double fTemp463 = 1e+03 * fTemp462;
			fVbargraph32 = FAUSTFLOAT(fTemp463);
			double fRec3 = 0.001 * fTemp463;
			fRec304[0] = fVec35[(IOTA0 - iSlow27) & 16383];
			double fTemp464 = 1e+03 * fRec304[1];
			fVbargraph33 = FAUSTFLOAT(fTemp464);
			double fRec4 = 0.001 * fTemp464;
			fRec305[0] = fVec34[(IOTA0 - iSlow27) & 16383];
			double fTemp465 = 1e+03 * fRec305[1];
			fVbargraph34 = FAUSTFLOAT(fTemp465);
			double fRec5 = 0.001 * fTemp465;
			fRec306[0] = fVec34[(IOTA0 - iSlow28) & 16383];
			double fTemp466 = 1e+03 * fRec306[1];
			fVbargraph35 = FAUSTFLOAT(fTemp466);
			double fRec6 = 0.001 * fTemp466;
			fRec307[0] = fVec35[(IOTA0 - iSlow28) & 16383];
			double fTemp467 = 1e+03 * fRec307[1];
			fVbargraph36 = FAUSTFLOAT(fTemp467);
			double fRec7 = 0.001 * fTemp467;
	...
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1a/sig_ 5", fVbargraph18, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1a/sig_ 6", fVbargraph7, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1a/sig_ 7", fVbargraph20, -1e+03, 1e+03);
	...
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1b/sig_ 2", fVbargraph22, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1b/sig_ 3", fVbargraph17, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1b/sig_ 4", fVbargraph19, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1b/sig_ 5", fVbargraph2, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1b/sig_ 6", fVbargraph21, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1b/sig_ 7", fVbargraph27, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 2a/sig_ 0", fVbargraph15, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 2a/sig_ 1", fVbargraph24, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 2a/sig_ 2", fVbargraph31, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 2a/sig_ 3", fVbargraph30, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 2a/sig_ 4", fVbargraph23, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 2a/sig_ 5", fVbargraph26, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 2a/sig_ 6", fVbargraph25, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 2a/sig_ 7", fVbargraph29, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 3/sig_ 0", fVbargraph28, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 3/sig_ 1", fVbargraph32, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 3/sig_ 2", fVbargraph33, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 3/sig_ 3", fVbargraph34, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 3/sig_ 4", fVbargraph35, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 3/sig_ 5", fVbargraph36, -1e+03, 1e+03);
	FAUST_ADDNUMENTRY("System Variables/Var 1", fEntry0, 2e+01, 1.0, 2e+01, 1.0);
	FAUST_ADDNUMENTRY("System Variables/Var 2", fEntry1, 1e+02, 1.0, 1e+04, 1.0);
	FAUST_ADDNUMENTRY("System Variables/Var 3", fEntry2, 0.5, 0.0, 1.0, 0.001);
	FAUST_ADDNUMENTRY("System Variables/Var 4", fEntry3, 2e+01, 1.0, 2e+01, 1.0);
	...
	#define FAUST_LIST_ACTIVES(p) \
		...
		p(NUMENTRY, Var_1, "System Variables/Var 1", fEntry0, 2e+01, 1.0, 2e+01, 1.0) \
		p(NUMENTRY, Var_2, "System Variables/Var 2", fEntry1, 1e+02, 1.0, 1e+04, 1.0) \
		p(NUMENTRY, Var_3, "System Variables/Var 3", fEntry2, 0.5, 0.0, 1.0, 0.001) \
		p(NUMENTRY, Var_4, "System Variables/Var 4", fEntry3, 2e+01, 1.0, 2e+01, 1.0) \
	...
	#define FAUST_LIST_PASSIVES(p) \
		...
		p(VERTICALBARGRAPH, sig__5, "System Inspectors/Signal Flow 1a/sig_ 5", fVbargraph18, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__6, "System Inspectors/Signal Flow 1a/sig_ 6", fVbargraph7, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__7, "System Inspectors/Signal Flow 1a/sig_ 7", fVbargraph20, 0.0, -1e+03, 1e+03, 0.0) \
		...
		p(VERTICALBARGRAPH, sig__2, "System Inspectors/Signal Flow 1b/sig_ 2", fVbargraph22, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__3, "System Inspectors/Signal Flow 1b/sig_ 3", fVbargraph17, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__4, "System Inspectors/Signal Flow 1b/sig_ 4", fVbargraph19, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__5, "System Inspectors/Signal Flow 1b/sig_ 5", fVbargraph2, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__6, "System Inspectors/Signal Flow 1b/sig_ 6", fVbargraph21, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__7, "System Inspectors/Signal Flow 1b/sig_ 7", fVbargraph27, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__0, "System Inspectors/Signal Flow 2a/sig_ 0", fVbargraph15, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__1, "System Inspectors/Signal Flow 2a/sig_ 1", fVbargraph24, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__2, "System Inspectors/Signal Flow 2a/sig_ 2", fVbargraph31, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__3, "System Inspectors/Signal Flow 2a/sig_ 3", fVbargraph30, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__4, "System Inspectors/Signal Flow 2a/sig_ 4", fVbargraph23, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__5, "System Inspectors/Signal Flow 2a/sig_ 5", fVbargraph26, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__6, "System Inspectors/Signal Flow 2a/sig_ 6", fVbargraph25, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__7, "System Inspectors/Signal Flow 2a/sig_ 7", fVbargraph29, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__0, "System Inspectors/Signal Flow 3/sig_ 0", fVbargraph28, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__1, "System Inspectors/Signal Flow 3/sig_ 1", fVbargraph32, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__2, "System Inspectors/Signal Flow 3/sig_ 2", fVbargraph33, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__3, "System Inspectors/Signal Flow 3/sig_ 3", fVbargraph34, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__4, "System Inspectors/Signal Flow 3/sig_ 4", fVbargraph35, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__5, "System Inspectors/Signal Flow 3/sig_ 5", fVbargraph36, 0.0, -1e+03, 1e+03, 0.0) \
