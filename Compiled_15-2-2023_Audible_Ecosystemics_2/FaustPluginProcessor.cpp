...
class mydsp : public base_dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst1 = 0.16666666666666666 / fConst0;
		fConst2 = std::tan(78.53981633974483 / fConst0);
		fConst3 = fConst2 + 0.6180339887498949;
		fConst4 = fConst2 + 1.618033988749895;
		fConst5 = std::exp(0.0 - 10.000000000040254 / fConst0);
		fConst6 = 1.0 / fConst0;
		fConst7 = 44.1 / fConst0;
		fConst8 = 1.0 - fConst7;
		fConst9 = 1.0 - fConst5;
		iConst10 = int(std::max<double>(0.0, 0.01 * fConst0 + -1.0));
		fConst11 = fConst2 / (fConst2 + 1.0);
		fConst12 = 2.0 * fConst11;
		double fConst13 = fConst2 * fConst4 + 1.0;
		fConst14 = fConst2 / fConst13;
		fConst15 = 2.0 * fConst14;
		fConst16 = 2.0 * fConst2;
		double fConst17 = fConst2 * fConst3 + 1.0;
	...
	virtual void instanceClear() {
		...
		for (int l60 = 0; l60 < 2097152; l60 = l60 + 1) {
			fVec10[l60] = 0.0;
		}
		...
		for (int l96 = 0; l96 < 2097152; l96 = l96 + 1) {
			fRec124[l96] = 0.0;
		}
		...
		for (int l122 = 0; l122 < 4194304; l122 = l122 + 1) {
			fRec12[l122] = 0.0;
		}
		...
		for (int l219 = 0; l219 < 2097152; l219 = l219 + 1) {
			fRec253[l219] = 0.0;
		}
		for (int l220 = 0; l220 < 2; l220 = l220 + 1) {
			fRec250[l220] = 0.0;
		}
		for (int l221 = 0; l221 < 8192; l221 = l221 + 1) {
			fVec29[l221] = 0.0;
		}
		...
		for (int l227 = 0; l227 < 2097152; l227 = l227 + 1) {
			fRec260[l227] = 0.0;
		}
		...
		for (int l241 = 0; l241 < 8388608; l241 = l241 + 1) {
			fVec32[l241] = 0.0;
		}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalBargraph("Mic SF1A Sum", &fVbargraph0, FAUSTFLOAT(-8e+01), FAUSTFLOAT(2e+01));
		ui_interface->declare(&fVslider0, "unit", "db");
		ui_interface->addVerticalSlider("SF_1A", &fVslider0, FAUSTFLOAT(0.0), FAUSTFLOAT(-84.0), FAUSTFLOAT(24.0), FAUSTFLOAT(0.001));
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("Signal Flow 1B");
		ui_interface->declare(&fVbargraph3, "unit", "dB");
		ui_interface->addVerticalBargraph("Mic1 SF1B", &fVbargraph3, FAUSTFLOAT(-8e+01), FAUSTFLOAT(2e+01));
		ui_interface->declare(&fVbargraph12, "unit", "dB");
		ui_interface->addVerticalBargraph("Mic2 SF1B", &fVbargraph12, FAUSTFLOAT(-8e+01), FAUSTFLOAT(2e+01));
		ui_interface->declare(&fVslider1, "unit", "db");
		ui_interface->addVerticalSlider("SF_1B", &fVslider1, FAUSTFLOAT(0.0), FAUSTFLOAT(-84.0), FAUSTFLOAT(24.0), FAUSTFLOAT(0.001));
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("Signal Flow 2A");
		ui_interface->declare(&fVbargraph5, "unit", "dB");
		ui_interface->addVerticalBargraph("Mic1 SF2A", &fVbargraph5, FAUSTFLOAT(-8e+01), FAUSTFLOAT(2e+01));
		ui_interface->declare(&fVbargraph14, "unit", "dB");
		ui_interface->addVerticalBargraph("Mic2 SF2A", &fVbargraph14, FAUSTFLOAT(-8e+01), FAUSTFLOAT(2e+01));
		ui_interface->declare(&fVslider2, "unit", "db");
		ui_interface->addVerticalSlider("SF_2A", &fVslider2, FAUSTFLOAT(0.0), FAUSTFLOAT(-84.0), FAUSTFLOAT(24.0), FAUSTFLOAT(0.001));
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("Signal Flow 3");
		ui_interface->declare(&fVslider3, "unit", "db");
		ui_interface->addVerticalSlider("SF_3", &fVslider3, FAUSTFLOAT(0.0), FAUSTFLOAT(-84.0), FAUSTFLOAT(24.0), FAUSTFLOAT(0.001));
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->openVerticalBox("Mixer ON/OFF");
		ui_interface->addCheckButton("mute/unmute", &fCheckbox0);
		ui_interface->closeBox();
		...
		ui_interface->addVerticalBargraph("sig_101", &fVbargraph6, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("diffHL Centroid");
		ui_interface->declare(&fVbargraph9, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_100", &fVbargraph9, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->closeBox();
		ui_interface->declare(&fVbargraph10, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 0", &fVbargraph10, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph8, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 1", &fVbargraph8, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph11, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 2", &fVbargraph11, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph1, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 3", &fVbargraph1, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph16, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 4", &fVbargraph16, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph19, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 5", &fVbargraph19, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph7, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 6", &fVbargraph7, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph25, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 7", &fVbargraph25, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("Signal Flow 1b");
		ui_interface->declare(&fVbargraph4, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 0", &fVbargraph4, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph13, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 1", &fVbargraph13, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph27, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 2", &fVbargraph27, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph17, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 3", &fVbargraph17, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph20, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 4", &fVbargraph20, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph2, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 5", &fVbargraph2, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph26, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 6", &fVbargraph26, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph24, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 7", &fVbargraph24, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("Signal Flow 2a");
		ui_interface->declare(&fVbargraph15, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 0", &fVbargraph15, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph29, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 1", &fVbargraph29, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph33, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 2", &fVbargraph33, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph32, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 3", &fVbargraph32, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph28, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 4", &fVbargraph28, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph23, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 5", &fVbargraph23, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph22, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 6", &fVbargraph22, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph31, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 7", &fVbargraph31, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("Signal Flow 3");
		ui_interface->openHorizontalBox("Granular Sampling 1");
		ui_interface->declare(&fVbargraph18, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_180", &fVbargraph18, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("Granular Sampling 2");
		ui_interface->declare(&fVbargraph21, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_181", &fVbargraph21, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->closeBox();
		ui_interface->declare(&fVbargraph30, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 0", &fVbargraph30, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph34, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 1", &fVbargraph34, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		...
		ui_interface->addVerticalBargraph("sig_ 3", &fVbargraph36, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph37, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 4", &fVbargraph37, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph38, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 5", &fVbargraph38, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->closeBox();
		ui_interface->closeBox();
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		double fSlow4 = fConst7 * std::pow(1e+01, 0.05 * double(fVslider1));
		double fSlow5 = fConst7 * std::pow(1e+01, 0.05 * double(fVslider2));
		double fSlow6 = 0.001 * fSlow3;
		int iSlow7 = int(std::max<double>(0.0, fConst41 * fSlow0 + -1.0));
		double fSlow8 = double(fEntry1);
		double fSlow9 = std::tan(fConst42 * std::max<double>(2.220446049250313e-16, std::min<double>(2.048e+04, fSlow8)));
		double fSlow10 = fSlow9 + 1.0000000000000002;
		double fSlow11 = fSlow9 / (fSlow9 + 1.0);
		double fSlow12 = 2.0 * fSlow11;
		double fSlow13 = fSlow9 * fSlow10 + 1.0;
		double fSlow14 = fSlow9 / fSlow13;
		double fSlow15 = 2.0 * fSlow14;
		double fSlow16 = 2.0 * fSlow9;
		double fSlow17 = 1.0 / fSlow13;
		double fSlow18 = 4.41e+04 * fSlow0;
		int iSlow19 = int(fSlow18);
		double fSlow20 = 2.0 * fSlow8;
		int iSlow21 = int(std::max<double>(0.0, fConst59 * fSlow0 + -1.0));
		double fSlow22 = 0.0005 * fSlow8;
		int iSlow23 = int(std::max<double>(0.0, fConst0 * fSlow0 + -1.0));
		double fSlow24 = fConst60 / fSlow0;
		int iSlow25 = int(std::max<double>(0.0, fConst61 * fSlow0 + -1.0));
		double fSlow26 = fConst6 / fSlow0;
		double fSlow27 = fConst6 * fSlow0;
		double fSlow28 = 0.5 * (1.0 - double(fEntry2));
		int iSlow29 = int(std::max<double>(0.0, fConst64 * fSlow0 + -1.0));
		double fSlow30 = fConst7 * std::pow(1e+01, 0.05 * double(fVslider3));
		int iSlow31 = int(std::max<double>(0.0, fConst65 * fSlow0 + -1.0));
		double fSlow32 = double(fEntry3);
		int iSlow33 = int(std::max<double>(0.0, fConst68 * fSlow32 + -1.0));
		int iSlow34 = int(std::max<double>(0.0, fConst69 * fSlow32 + -1.0));
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			iVec0[0] = 1;
			fRec13[0] = fSlow1 + (fRec13[1] - std::floor(fSlow1 + fRec13[1]));
			double fTemp0 = double(input3[i0]) + double(input7[i0]);
			double fTemp1 = double(input2[i0]) + double(input6[i0]);
			fRec25[0] = fSlow2 + fConst8 * fRec25[1];
			double fTemp2 = fRec25[0] * (fTemp1 + fTemp0);
			double fTemp3 = fSlow3 * fTemp2;
			fRec24[0] = std::max<double>(fRec24[1] - fConst6, std::fabs(fTemp3));
			fVbargraph0 = FAUSTFLOAT(2e+01 * std::log10(std::max<double>(2.2250738585072014e-308, std::max<double>(6.309573444801929e-05, fRec24[0]))));
			fRec23[0] = fConst9 * std::fabs(fTemp3) + fConst5 * fRec23[1];
			fVec1[IOTA0 & 2047] = fRec23[0] + 0.9 * fRec22[1];
			fRec22[0] = fVec1[(IOTA0 - iConst10) & 2047];
			double fTemp4 = fRec22[1] - fRec20[1];
			fRec20[0] = fRec20[1] + fConst12 * fTemp4;
			double fTemp5 = fRec20[1] + fConst11 * fTemp4;
			double fRec21 = fTemp5;
			double fTemp6 = fRec21 - (fConst4 * fRec17[1] + fRec18[1]);
			fRec17[0] = fRec17[1] + fConst15 * fTemp6;
			double fTemp7 = fRec17[1] + fConst14 * fTemp6;
			fRec18[0] = fRec18[1] + fConst16 * fTemp7;
			double fTemp8 = fRec18[1] + fConst2 * fTemp7;
			double fRec19 = fTemp8;
			double fTemp9 = fRec19 - (fConst3 * fRec14[1] + fRec15[1]);
			fRec14[0] = fRec14[1] + fConst19 * fTemp9;
			double fTemp10 = fRec14[1] + fConst18 * fTemp9;
			fRec15[0] = fRec15[1] + fConst16 * fTemp10;
			double fTemp11 = fRec15[1] + fConst2 * fTemp10;
			double fRec16 = fTemp11;
			double fTemp12 = std::max<double>(0.0, std::min<double>(1.0, 1.0 - mydsp_faustpower2_f(fRec16)));
			fVec2[IOTA0 & 2097151] = fTemp12;
			double fTemp13 = 1e+03 * fTemp12;
			fVbargraph1 = FAUSTFLOAT(fTemp13);
			double fTemp14 = fTemp13;
			double fTemp15 = fTemp14 * std::fabs(2.0 * (fRec13[0] + (-0.5 - std::floor(fRec13[0] + -0.5))) + -1.0);
			fVbargraph2 = FAUSTFLOAT(fTemp15);
			double fTemp16 = fTemp15;
			fRec41[0] = fSlow4 + fConst8 * fRec41[1];
			double fTemp17 = double(input0[i0]) + double(input4[i0]);
			double fTemp18 = fSlow3 * fTemp17 * fRec41[0];
			fRec40[0] = std::max<double>(fRec40[1] - fConst6, std::fabs(fTemp18));
			fVbargraph3 = FAUSTFLOAT(2e+01 * std::log10(std::max<double>(2.2250738585072014e-308, std::max<double>(6.309573444801929e-05, fRec40[0]))));
			double fTemp19 = fTemp18;
			double fTemp20 = fTemp19 - fRec38[1];
			fRec38[0] = fRec38[1] + fConst26 * fTemp20;
			double fTemp21 = fRec38[1] + fConst25 * fTemp20;
			double fRec39 = fTemp19 - fTemp21;
			double fTemp22 = fRec39 - fRec36[1];
			fRec36[0] = fRec36[1] + fConst29 * fTemp22;
			double fTemp23 = fRec36[1] + fConst28 * fTemp22;
			double fRec37 = fTemp23;
			fRec35[0] = fConst30 * std::fabs(fRec37) + fConst23 * fRec35[1];
			fVec3[IOTA0 & 2047] = fRec35[0] + 0.995 * fRec34[1];
			fRec34[0] = fVec3[(IOTA0 - iConst10) & 2047];
			double fTemp24 = fRec34[1] - fRec32[1];
			fRec32[0] = fRec32[1] + fConst32 * fTemp24;
			double fTemp25 = fRec32[1] + fConst31 * fTemp24;
			double fRec33 = fTemp25;
			double fTemp26 = fRec33 - (fConst22 * fRec29[1] + fRec30[1]);
			fRec29[0] = fRec29[1] + fConst35 * fTemp26;
			double fTemp27 = fRec29[1] + fConst34 * fTemp26;
			fRec30[0] = fRec30[1] + fConst36 * fTemp27;
			double fTemp28 = fRec30[1] + fConst20 * fTemp27;
			double fRec31 = fTemp28;
			double fTemp29 = fRec31 - (fConst21 * fRec26[1] + fRec27[1]);
			fRec26[0] = fRec26[1] + fConst39 * fTemp29;
			double fTemp30 = fRec26[1] + fConst38 * fTemp29;
			fRec27[0] = fRec27[1] + fConst36 * fTemp30;
			double fTemp31 = fRec27[1] + fConst20 * fTemp30;
			double fRec28 = fTemp31;
			double fTemp32 = 1e+03 * std::max<double>(0.0, std::min<double>(1.0, fRec28));
			fVbargraph4 = FAUSTFLOAT(fTemp32);
			double fTemp33 = 0.001 * fTemp32;
			fRec47[0] = fSlow5 + fConst8 * fRec47[1];
			double fTemp34 = fSlow3 * fTemp17 * fRec47[0];
			fRec46[0] = std::max<double>(fRec46[1] - fConst6, std::fabs(fTemp34));
			fVbargraph5 = FAUSTFLOAT(2e+01 * std::log10(std::max<double>(2.2250738585072014e-308, std::max<double>(6.309573444801929e-05, fRec46[0]))));
			double fTemp35 = fTemp34;
			double fTemp36 = fTemp35 - fRec44[1];
			fRec44[0] = fRec44[1] + fConst26 * fTemp36;
			double fTemp37 = fRec44[1] + fConst25 * fTemp36;
			double fRec45 = fTemp35 - fTemp37;
			double fTemp38 = fRec45 - fRec42[1];
			fRec42[0] = fRec42[1] + fConst29 * fTemp38;
			double fTemp39 = fRec42[1] + fConst28 * fTemp38;
			double fRec43 = fTemp39;
			double fTemp40 = fRec43 * (1.0 - fTemp33);
			int iTemp41 = double(iRec62[1]) >= (fRec64[1] + -1.0);
			int iTemp42 = double(iRec66[1]) >= (fRec68[1] + -1.0);
			double fTemp43 = std::fabs(fSlow3 * fTemp0 * fRec25[0]);
			double fTemp44 = std::max<double>(fTemp43, fRec67[1] * (1.0 - double(iTemp42)));
			fVec4[0] = fTemp44;
			fRec65[0] = ((iTemp42) ? fVec4[1] : fRec65[1]);
			iRec66[0] = ((iTemp42) ? 1 : iRec66[1] + 1);
			fRec67[0] = fTemp44;
			int iTemp45 = 1 - iVec0[1];
			fRec70[0] = fConst30 * fTemp43 + fConst23 * fRec70[1];
			fVec5[IOTA0 & 2047] = fRec70[0] + 0.95 * fRec69[1];
			fRec69[0] = fVec5[(IOTA0 - iConst10) & 2047];
			double fTemp46 = std::fabs(fSlow3 * fTemp1 * fRec25[0]);
			fRec72[0] = fConst30 * fTemp46 + fConst23 * fRec72[1];
			fVec6[IOTA0 & 2047] = fRec72[0] + 0.95 * fRec71[1];
			fRec71[0] = fVec6[(IOTA0 - iConst10) & 2047];
			double fTemp47 = fConst0 * std::max<double>(0.0, std::min<double>(1e+03, 6.0 * (fRec71[1] + fRec69[1] + 1.0)));
			fRec68[0] = ((iTemp42 + iTemp45) ? fTemp47 : fRec68[1]);
			int iTemp48 = double(iRec74[1]) >= (fRec76[1] + -1.0);
			double fTemp49 = std::max<double>(fTemp46, fRec75[1] * (1.0 - double(iTemp48)));
			fVec7[0] = fTemp49;
			fRec73[0] = ((iTemp48) ? fVec7[1] : fRec73[1]);
			iRec74[0] = ((iTemp48) ? 1 : iRec74[1] + 1);
			fRec75[0] = fTemp49;
			fRec76[0] = ((iTemp48 + iTemp45) ? fTemp47 : fRec76[1]);
			double fTemp50 = std::max<double>(std::fabs(fRec73[0] - fRec65[0]), fRec63[1] * (1.0 - double(iTemp41)));
			fVec8[0] = fTemp50;
			fRec61[IOTA0 & 4194303] = ((iTemp41) ? fVec8[1] : fRec61[(IOTA0 - 1) & 4194303]);
			iRec62[0] = ((iTemp41) ? 1 : iRec62[1] + 1);
			fRec63[0] = fTemp50;
			fRec64[0] = ((iTemp41 + iTemp45) ? fTemp47 : fRec64[1]);
			fRec60[0] = fRec61[(IOTA0 - iConst40) & 4194303];
			double fTemp51 = 0.5 * (fRec61[IOTA0 & 4194303] + fRec60[1]);
			double fTemp52 = fTemp51 - fRec58[1];
			fRec58[0] = fRec58[1] + fConst32 * fTemp52;
			double fTemp53 = fRec58[1] + fConst31 * fTemp52;
			double fRec59 = fTemp53;
			double fTemp54 = 1e+03 * fRec59;
			fVbargraph6 = FAUSTFLOAT(fTemp54);
			double fTemp55 = fTemp54;
			fRec57[0] = fConst30 * std::fabs(fSlow6 * fTemp2 * fTemp55) + fConst23 * fRec57[1];
			fVec9[IOTA0 & 2047] = fRec57[0] + 0.995 * fRec56[1];
			fRec56[0] = fVec9[(IOTA0 - iConst10) & 2047];
			double fTemp56 = fRec56[1] - fRec54[1];
			fRec54[0] = fRec54[1] + fConst12 * fTemp56;
			double fTemp57 = fRec54[1] + fConst11 * fTemp56;
			double fRec55 = fTemp57;
			double fTemp58 = fRec55 - (fConst4 * fRec51[1] + fRec52[1]);
			fRec51[0] = fRec51[1] + fConst15 * fTemp58;
			double fTemp59 = fRec51[1] + fConst14 * fTemp58;
			fRec52[0] = fRec52[1] + fConst16 * fTemp59;
			double fTemp60 = fRec52[1] + fConst2 * fTemp59;
			double fRec53 = fTemp60;
			double fTemp61 = fRec53 - (fConst3 * fRec48[1] + fRec49[1]);
			fRec48[0] = fRec48[1] + fConst19 * fTemp61;
			double fTemp62 = fRec48[1] + fConst18 * fTemp61;
			fRec49[0] = fRec49[1] + fConst16 * fTemp62;
			double fTemp63 = fRec49[1] + fConst2 * fTemp62;
			double fRec50 = fTemp63;
			double fTemp64 = std::max<double>(0.0, std::min<double>(1.0, fRec50));
			fVec10[IOTA0 & 2097151] = fTemp64;
			double fTemp65 = 1e+03 * std::max<double>(0.0, std::min<double>(1.0, ((fTemp64 <= 0.5) ? 1.0 : 2.0 * (1.0 - fTemp64))));
			fVbargraph7 = FAUSTFLOAT(fTemp65);
			double fTemp66 = fTemp65;
			fRec82[0] = fVec2[(IOTA0 - iSlow7) & 2097151];
			double fTemp67 = 1e+03 * std::max<double>(0.0, std::min<double>(1.0, fRec82[1]));
			fVbargraph8 = FAUSTFLOAT(fTemp67);
			double fTemp68 = fTemp67;
			double fTemp69 = 0.001 * fTemp68;
			double fTemp70 = 1.0 - fTemp69;
			double fTemp71 = fSlow8 * fTemp70;
			double fTemp72 = fTemp71 - fRec80[1];
			fRec80[0] = fRec80[1] + fConst45 * fTemp72;
			double fTemp73 = fRec80[1] + fConst44 * fTemp72;
			double fRec81 = fTemp73;
			double fTemp74 = std::max<double>(2e+01, std::min<double>(2.048e+04, fRec81));
			double fTemp75 = std::tan(fConst42 * fTemp74);
			double fTemp76 = fTemp3 - fRec98[1];
			fRec98[0] = fRec98[1] + fSlow12 * fTemp76;
			double fTemp77 = fRec98[1] + fSlow11 * fTemp76;
			double fRec99 = fTemp77;
			double fRec100 = fTemp3 - fTemp77;
			double fTemp78 = fRec99 - (fSlow10 * fRec95[1] + fRec96[1]);
			fRec95[0] = fRec95[1] + fSlow15 * fTemp78;
			double fTemp79 = fRec95[1] + fSlow14 * fTemp78;
			fRec96[0] = fRec96[1] + fSlow16 * fTemp79;
			double fTemp80 = fRec96[1] + fSlow9 * fTemp79;
			double fRec97 = fTemp80;
			fRec94[0] = fConst9 * std::fabs(fRec97) + fConst5 * fRec94[1];
			double fTemp81 = fRec100 - (fSlow10 * fRec102[1] + fRec103[1]);
			fRec102[0] = fRec102[1] + fSlow15 * fTemp81;
			double fTemp82 = fRec102[1] + fSlow14 * fTemp81;
			fRec103[0] = fRec103[1] + fSlow16 * fTemp82;
			double fTemp83 = fSlow17 * fTemp81;
			double fRec104 = fTemp83;
			fRec101[0] = fConst47 * std::fabs(fRec104) + fConst46 * fRec101[1];
			double fTemp84 = 1e+03 * (fRec101[0] - fRec94[0]);
			fVbargraph9 = FAUSTFLOAT(fTemp84);
			fVec11[IOTA0 & 2047] = 0.995 * fRec93[1] + 0.001 * fTemp84 * (1.0 - 0.001 * fTemp55);
			fRec93[0] = fVec11[(IOTA0 - iConst10) & 2047];
			double fTemp85 = fRec93[1] - fRec91[1];
			fRec91[0] = fRec91[1] + fConst12 * fTemp85;
			double fTemp86 = fRec91[1] + fConst11 * fTemp85;
			double fRec92 = fTemp86;
			double fTemp87 = fRec92 - (fConst4 * fRec88[1] + fRec89[1]);
			fRec88[0] = fRec88[1] + fConst15 * fTemp87;
			double fTemp88 = fRec88[1] + fConst14 * fTemp87;
			fRec89[0] = fRec89[1] + fConst16 * fTemp88;
			double fTemp89 = fRec89[1] + fConst2 * fTemp88;
			double fRec90 = fTemp89;
			double fTemp90 = fRec90 - (fConst3 * fRec85[1] + fRec86[1]);
			fRec85[0] = fRec85[1] + fConst19 * fTemp90;
			double fTemp91 = fRec85[1] + fConst18 * fTemp90;
			fRec86[0] = fRec86[1] + fConst16 * fTemp91;
			double fTemp92 = fRec86[1] + fConst2 * fTemp91;
			double fRec87 = fTemp92;
			double fTemp93 = 1e+03 * std::max<double>(0.0, std::min<double>(1.0, 0.5 * (fRec87 + 1.0)));
			fVbargraph10 = FAUSTFLOAT(fTemp93);
			double fTemp94 = fTemp93;
			double fTemp95 = 0.001 * fTemp94;
			double fTemp96 = 8e+02 * (1.0 - fTemp95);
			double fTemp97 = fTemp96 - fRec83[1];
			fRec83[0] = fRec83[1] + fConst45 * fTemp97;
			double fTemp98 = fRec83[1] + fConst44 * fTemp97;
			double fRec84 = fTemp98;
			double fTemp99 = std::max<double>(0.01, std::min<double>(1e+02, std::max<double>(1.0, std::min<double>(2.048e+04, fRec84)) / fTemp74));
			double fTemp100 = 1.0 / fTemp99 + fTemp75;
			double fTemp101 = fTemp75 * fTemp100 + 1.0;
			double fTemp102 = fSlow18 * std::max<double>(0.01, std::min<double>(1.0, fTemp70));
			iRec111[0] = (iVec0[1] + iRec111[1]) % iSlow19;
			double fTemp103 = double(iRec111[0]);
			double fTemp104 = std::max<double>(1.0, ((fTemp103 > fTemp102) ? fTemp102 : 1.0));
			double fTemp105 = 0.5 * fTemp104;
			fRec112[0] = std::fmod(0.0038314176245210726 * (fSlow20 - fTemp94) + fRec112[1], fTemp104);
			int iTemp106 = std::max<int>(0, std::min<int>(iRec111[0], 881999));
			ftbl1[iTemp106] = fRec8[1];
			int iTemp107 = int(fRec112[0]);
			double fTemp108 = std::floor(fRec112[0]);
			double fTemp109 = fRec112[0] + (-1.0 - fTemp108);
			double fTemp110 = fRec112[0] - fTemp108;
			double fTemp111 = fRec112[0] + (-2.0 - fTemp108);
			double fTemp112 = ((0.0 - fTemp110) * (0.0 - 0.5 * fTemp109) * (0.0 - 0.3333333333333333 * fTemp111) * ftbl1[((iTemp107 + -1) % 882000 + 882000) % 882000] + (fRec112[0] + (1.0 - fTemp108)) * ((0.0 - fTemp109) * (0.0 - 0.5 * fTemp111) * ftbl1[(iTemp107 % 882000 + 882000) % 882000] + 0.5 * fTemp110 * (0.0 - fTemp111) * ftbl1[((iTemp107 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp110 * fTemp109 * ftbl1[((iTemp107 + 2) % 882000 + 882000) % 882000])) * std::min<double>(1.0, 0.005 * std::fabs(std::fmod(fRec112[0] + fTemp105, fTemp104) - fTemp105));
			double fTemp113 = fTemp112 - (fConst49 * fRec108[1] + fRec109[1]);
			fRec108[0] = fRec108[1] + fConst52 * fTemp113;
			double fTemp114 = fRec108[1] + fConst51 * fTemp113;
			fRec109[0] = fRec109[1] + fConst53 * fTemp114;
			double fTemp115 = fConst54 * fTemp113;
			double fRec110 = fTemp115;
			double fTemp116 = fRec110 - (fConst48 * fRec105[1] + fRec106[1]);
			fRec105[0] = fRec105[1] + fConst57 * fTemp116;
			double fTemp117 = fRec105[1] + fConst56 * fTemp116;
			fRec106[0] = fRec106[1] + fConst53 * fTemp117;
			double fTemp118 = fConst58 * fTemp116;
			double fRec107 = fTemp118;
			double fTemp119 = fRec107 - (fRec77[1] * fTemp100 + fRec78[1]);
			double fTemp120 = fTemp75 * fTemp119 / fTemp101;
			fRec77[0] = fRec77[1] + 2.0 * fTemp120;
			double fTemp121 = fRec77[1] + fTemp120;
			double fTemp122 = fTemp75 * fTemp121;
			fRec78[0] = fRec78[1] + 2.0 * fTemp122;
			double fTemp123 = fTemp121 / fTemp99;
			double fRec79 = fTemp123;
			fRec118[0] = fVec2[(IOTA0 - iSlow21) & 2097151];
			double fTemp124 = 1e+03 * std::max<double>(0.0, std::min<double>(1.0, fRec118[1]));
			fVbargraph11 = FAUSTFLOAT(fTemp124);
			double fTemp125 = fTemp124;
			double fTemp126 = fSlow22 * fTemp125;
			double fTemp127 = fTemp126 - fRec116[1];
			fRec116[0] = fRec116[1] + fConst45 * fTemp127;
			double fTemp128 = fRec116[1] + fConst44 * fTemp127;
			double fRec117 = fTemp128;
			double fTemp129 = std::max<double>(2e+01, std::min<double>(2.048e+04, fRec117));
			double fTemp130 = std::tan(fConst42 * fTemp129);
			double fTemp131 = 0.4 * fTemp94;
			double fTemp132 = fTemp131 - fRec119[1];
			fRec119[0] = fRec119[1] + fConst45 * fTemp132;
			double fTemp133 = fRec119[1] + fConst44 * fTemp132;
			double fRec120 = fTemp133;
			double fTemp134 = std::max<double>(0.01, std::min<double>(1e+02, std::max<double>(1.0, std::min<double>(2.048e+04, fRec120)) / fTemp129));
			double fTemp135 = 1.0 / fTemp134 + fTemp130;
			double fTemp136 = fTemp130 * fTemp135 + 1.0;
			double fTemp137 = fRec107 - (fRec113[1] * fTemp135 + fRec114[1]);
			double fTemp138 = fTemp130 * fTemp137 / fTemp136;
			fRec113[0] = fRec113[1] + 2.0 * fTemp138;
			double fTemp139 = fRec113[1] + fTemp138;
			double fTemp140 = fTemp130 * fTemp139;
			fRec114[0] = fRec114[1] + 2.0 * fTemp140;
			double fTemp141 = fTemp139 / fTemp134;
			double fRec115 = fTemp141;
			double fTemp142 = 0.001 * fTemp125;
			double fTemp143 = 1.0 - fTemp142;
			double fTemp144 = fSlow18 * std::max<double>(0.01, std::min<double>(1.0, fTemp143));
			double fTemp145 = std::max<double>(1.0, ((fTemp103 > fTemp144) ? fTemp144 : 1.0));
			double fTemp146 = 0.5 * fTemp145;
			fRec128[0] = std::fmod(0.0038314176245210726 * (fSlow8 + fTemp94) + fRec128[1], fTemp145);
			int iTemp147 = int(fRec128[0]);
			double fTemp148 = std::floor(fRec128[0]);
			double fTemp149 = fRec128[0] + (-1.0 - fTemp148);
			double fTemp150 = fRec128[0] - fTemp148;
			double fTemp151 = fRec128[0] + (-2.0 - fTemp148);
			double fTemp152 = ((0.0 - fTemp150) * (0.0 - 0.5 * fTemp149) * (0.0 - 0.3333333333333333 * fTemp151) * ftbl1[((iTemp147 + -1) % 882000 + 882000) % 882000] + (fRec128[0] + (1.0 - fTemp148)) * ((0.0 - fTemp149) * (0.0 - 0.5 * fTemp151) * ftbl1[(iTemp147 % 882000 + 882000) % 882000] + 0.5 * fTemp150 * (0.0 - fTemp151) * ftbl1[((iTemp147 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp150 * fTemp149 * ftbl1[((iTemp147 + 2) % 882000 + 882000) % 882000])) * std::min<double>(1.0, 0.005 * std::fabs(std::fmod(fRec128[0] + fTemp146, fTemp145) - fTemp146));
			double fTemp153 = fTemp152 - (fConst49 * fRec125[1] + fRec126[1]);
			fRec125[0] = fRec125[1] + fConst52 * fTemp153;
			double fTemp154 = fRec125[1] + fConst51 * fTemp153;
			fRec126[0] = fRec126[1] + fConst53 * fTemp154;
			double fTemp155 = fConst54 * fTemp153;
			double fRec127 = fTemp155;
			double fTemp156 = fRec127 - (fConst48 * fRec122[1] + fRec123[1]);
			fRec122[0] = fRec122[1] + fConst57 * fTemp156;
			double fTemp157 = fRec122[1] + fConst56 * fTemp156;
			fRec123[0] = fRec123[1] + fConst53 * fTemp157;
			double fTemp158 = fConst58 * fTemp156;
			fRec124[IOTA0 & 2097151] = fTemp158;
			fRec121[0] = fRec124[(IOTA0 - iSlow7) & 2097151];
			double fTemp159 = fSlow18 * std::max<double>(0.01, std::min<double>(1.0, 0.0005 * (fTemp68 + fTemp14)));
			double fTemp160 = std::max<double>(1.0, ((fTemp103 > fTemp159) ? fTemp159 : 1.0));
			double fTemp161 = 0.5 * fTemp160;
			fRec136[0] = std::fmod(0.0038314176245210726 * (2.9e+02 - 0.09 * fTemp94) + fRec136[1], fTemp160);
			int iTemp162 = int(fRec136[0]);
			double fTemp163 = std::floor(fRec136[0]);
			double fTemp164 = fRec136[0] + (-1.0 - fTemp163);
			double fTemp165 = fRec136[0] - fTemp163;
			double fTemp166 = fRec136[0] + (-2.0 - fTemp163);
			double fTemp167 = ((0.0 - fTemp165) * (0.0 - 0.5 * fTemp164) * (0.0 - 0.3333333333333333 * fTemp166) * ftbl1[((iTemp162 + -1) % 882000 + 882000) % 882000] + (fRec136[0] + (1.0 - fTemp163)) * ((0.0 - fTemp164) * (0.0 - 0.5 * fTemp166) * ftbl1[(iTemp162 % 882000 + 882000) % 882000] + 0.5 * fTemp165 * (0.0 - fTemp166) * ftbl1[((iTemp162 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp165 * fTemp164 * ftbl1[((iTemp162 + 2) % 882000 + 882000) % 882000])) * std::min<double>(1.0, 0.005 * std::fabs(std::fmod(fRec136[0] + fTemp161, fTemp160) - fTemp161));
			double fTemp168 = fTemp167 - (fConst49 * fRec133[1] + fRec134[1]);
			fRec133[0] = fRec133[1] + fConst52 * fTemp168;
			double fTemp169 = fRec133[1] + fConst51 * fTemp168;
			fRec134[0] = fRec134[1] + fConst53 * fTemp169;
			double fTemp170 = fConst54 * fTemp168;
			double fRec135 = fTemp170;
			double fTemp171 = fRec135 - (fConst48 * fRec130[1] + fRec131[1]);
			fRec130[0] = fRec130[1] + fConst57 * fTemp171;
			double fTemp172 = fRec130[1] + fConst56 * fTemp171;
			fRec131[0] = fRec131[1] + fConst53 * fTemp172;
			double fTemp173 = fConst58 * fTemp171;
			fRec132[IOTA0 & 4194303] = fTemp173;
			fRec129[0] = fRec132[(IOTA0 - iSlow23) & 4194303];
			double fTemp174 = 1e-06 * fTemp14 * (fRec129[1] + fRec121[1] + fRec115 + fRec79) * fTemp66;
			double fTemp175 = double(input1[i0]) + double(input5[i0]);
			double fTemp176 = fSlow3 * fTemp175 * fRec41[0];
			fRec151[0] = std::max<double>(fRec151[1] - fConst6, std::fabs(fTemp176));
			fVbargraph12 = FAUSTFLOAT(2e+01 * std::log10(std::max<double>(2.2250738585072014e-308, std::max<double>(6.309573444801929e-05, fRec151[0]))));
			double fTemp177 = fTemp176;
			double fTemp178 = fTemp177 - fRec149[1];
			fRec149[0] = fRec149[1] + fConst26 * fTemp178;
			double fTemp179 = fRec149[1] + fConst25 * fTemp178;
			double fRec150 = fTemp177 - fTemp179;
			double fTemp180 = fRec150 - fRec147[1];
			fRec147[0] = fRec147[1] + fConst29 * fTemp180;
			double fTemp181 = fRec147[1] + fConst28 * fTemp180;
			double fRec148 = fTemp181;
			fRec146[0] = fConst30 * std::fabs(fRec148) + fConst23 * fRec146[1];
			fVec12[IOTA0 & 2047] = fRec146[0] + 0.995 * fRec145[1];
			fRec145[0] = fVec12[(IOTA0 - iConst10) & 2047];
			double fTemp182 = fRec145[1] - fRec143[1];
			fRec143[0] = fRec143[1] + fConst32 * fTemp182;
			double fTemp183 = fRec143[1] + fConst31 * fTemp182;
			double fRec144 = fTemp183;
			double fTemp184 = fRec144 - (fConst22 * fRec140[1] + fRec141[1]);
			fRec140[0] = fRec140[1] + fConst35 * fTemp184;
			double fTemp185 = fRec140[1] + fConst34 * fTemp184;
			fRec141[0] = fRec141[1] + fConst36 * fTemp185;
			double fTemp186 = fRec141[1] + fConst20 * fTemp185;
			double fRec142 = fTemp186;
			double fTemp187 = fRec142 - (fConst21 * fRec137[1] + fRec138[1]);
			fRec137[0] = fRec137[1] + fConst39 * fTemp187;
			double fTemp188 = fRec137[1] + fConst38 * fTemp187;
			fRec138[0] = fRec138[1] + fConst36 * fTemp188;
			double fTemp189 = fRec138[1] + fConst20 * fTemp188;
			double fRec139 = fTemp189;
			double fTemp190 = 1e+03 * std::max<double>(0.0, std::min<double>(1.0, fRec139));
			fVbargraph13 = FAUSTFLOAT(fTemp190);
			double fTemp191 = 0.001 * fTemp190;
			double fTemp192 = fSlow3 * fTemp175 * fRec47[0];
			fRec156[0] = std::max<double>(fRec156[1] - fConst6, std::fabs(fTemp192));
			fVbargraph14 = FAUSTFLOAT(2e+01 * std::log10(std::max<double>(2.2250738585072014e-308, std::max<double>(6.309573444801929e-05, fRec156[0]))));
			double fTemp193 = fTemp192;
			double fTemp194 = fTemp193 - fRec154[1];
			fRec154[0] = fRec154[1] + fConst26 * fTemp194;
			double fTemp195 = fRec154[1] + fConst25 * fTemp194;
			double fRec155 = fTemp193 - fTemp195;
			double fTemp196 = fRec155 - fRec152[1];
			fRec152[0] = fRec152[1] + fConst29 * fTemp196;
			double fTemp197 = fRec152[1] + fConst28 * fTemp196;
			double fRec153 = fTemp197;
			double fTemp198 = fRec153 * (1.0 - fTemp191);
			fRec8[0] = 0.001 * (fTemp198 + fTemp174 + fTemp40) * fTemp16;
			double fRec9 = fTemp174;
			double fTemp199 = std::max<double>(1.0, ((fTemp103 > fSlow18) ? fSlow18 : 1.0));
			double fTemp200 = 0.5 * fTemp199;
			fRec157[0] = std::fmod(0.0038314176245210726 * (0.02 * fTemp94 + 2.5e+02) + fRec157[1], fTemp199);
			int iTemp201 = int(fRec157[0]);
			double fTemp202 = std::floor(fRec157[0]);
			double fTemp203 = fRec157[0] + (-1.0 - fTemp202);
			double fTemp204 = fRec157[0] - fTemp202;
			double fTemp205 = fRec157[0] + (-2.0 - fTemp202);
			double fRec10 = ((0.0 - fTemp204) * (0.0 - 0.5 * fTemp203) * (0.0 - 0.3333333333333333 * fTemp205) * ftbl1[((iTemp201 + -1) % 882000 + 882000) % 882000] + (fRec157[0] + (1.0 - fTemp202)) * ((0.0 - fTemp203) * (0.0 - 0.5 * fTemp205) * ftbl1[(iTemp201 % 882000 + 882000) % 882000] + 0.5 * fTemp204 * (0.0 - fTemp205) * ftbl1[((iTemp201 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp204 * fTemp203 * ftbl1[((iTemp201 + 2) % 882000 + 882000) % 882000])) * std::min<double>(1.0, 0.005 * std::fabs(std::fmod(fRec157[0] + fTemp200, fTemp199) - fTemp200));
			double fTemp206 = 0.001 * fTemp14;
			double fTemp207 = fSlow18 * std::max<double>(0.01, std::min<double>(1.0, fTemp206));
			double fTemp208 = std::max<double>(1.0, ((fTemp103 > fTemp207) ? fTemp207 : 1.0));
			double fTemp209 = 0.5 * fTemp208;
			fRec158[0] = std::fmod(fRec158[1] + 0.766283, fTemp208);
			int iTemp210 = int(fRec158[0]);
			double fTemp211 = std::floor(fRec158[0]);
			double fTemp212 = fRec158[0] + (-1.0 - fTemp211);
			double fTemp213 = fRec158[0] - fTemp211;
			double fTemp214 = fRec158[0] + (-2.0 - fTemp211);
			double fRec11 = ((0.0 - fTemp213) * (0.0 - 0.5 * fTemp212) * (0.0 - 0.3333333333333333 * fTemp214) * ftbl1[((iTemp210 + -1) % 882000 + 882000) % 882000] + (fRec158[0] + (1.0 - fTemp211)) * ((0.0 - fTemp212) * (0.0 - 0.5 * fTemp214) * ftbl1[(iTemp210 % 882000 + 882000) % 882000] + 0.5 * fTemp213 * (0.0 - fTemp214) * ftbl1[((iTemp210 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp213 * fTemp212 * ftbl1[((iTemp210 + 2) % 882000 + 882000) % 882000])) * std::min<double>(1.0, 0.005 * std::fabs(std::fmod(fRec158[0] + fTemp209, fTemp208) - fTemp209));
			fRec12[IOTA0 & 4194303] = fRec107;
			double fTemp215 = 1e+03 * fRec8[0];
			fVbargraph15 = FAUSTFLOAT(fTemp215);
			double fTemp216 = 0.001 * fTemp215;
			ftbl0[iTemp106] = fTemp216;
			int iTemp217 = fRec164[1] < fRec164[2];
			fRec166[0] = fVec10[(IOTA0 - iSlow21) & 2097151];
			double fTemp218 = 1e+03 * std::max<double>(0.0, std::min<double>(1.0, fRec166[1]));
			fVbargraph16 = FAUSTFLOAT(fTemp218);
			double fTemp219 = 0.001 * fTemp218;
			double fTemp220 = ((iTemp217 + iTemp45) ? fConst6 * std::pow(5e+01, 2.0 * (1.0 - fTemp219) + -1.0) : fRec163[1]);
			fRec163[0] = fTemp220;
			double fTemp221 = fRec164[1] + fTemp220;
			fRec164[0] = fTemp221 - std::floor(fTemp221);
			iRec165[0] = (iTemp217 + iRec165[1] + iTemp45) % 8;
			int iTemp222 = iRec165[0] == 7;
			iVec13[0] = iTemp222;
			int iTemp223 = ((fRec160[1] == 0.0) | (fRec160[1] == 1.0)) & (iTemp222 > iVec13[1]);
			double fTemp224 = 0.047619047619047616 * fTemp70;
			iRec167[0] = 1103515245 * iRec167[1] + 12345;
			double fTemp225 = double(iRec167[0]);
			double fTemp226 = fTemp224 + 4.656612875245797e-11 * fTemp225 * (fTemp224 + 0.023) + 0.023;
			double fTemp227 = fConst6 / std::max<double>(fConst6, fTemp226);
			double fTemp228 = ((iTemp223) ? fTemp227 : fRec161[1]);
			fRec160[0] = ((iTemp223) ? fTemp228 : std::min<double>(1.0, fRec160[1] + fTemp228));
			fRec161[0] = fTemp228;
			int iRec162 = iTemp223;
			fRec159[0] = ((iRec162) ? fTemp226 : fRec159[1]);
			fRec169[0] = fSlow24 + (fRec169[1] - std::floor(fSlow24 + fRec169[1]));
			double fTemp229 = std::fabs(2.0 * (fRec169[0] + (-0.5 - std::floor(fRec169[0] + -0.5))) + -1.0);
			double fTemp230 = 5e+02 * (fTemp229 + -2.0);
			fVbargraph17 = FAUSTFLOAT(fTemp230);
			double fTemp231 = fTemp230;
			double fTemp232 = 0.001 * fTemp231 * (1.0 - 0.01 * fTemp70) + 4.656612875245797e-12 * fTemp225 * fTemp70;
			fRec168[0] = ((iRec162) ? fTemp232 : fRec168[1]);
			double fTemp233 = std::fmod(fSlow18 + std::fmod(fSlow18 * fRec168[0] + fConst0 * fRec160[0] * fRec159[0], fSlow18), fSlow18);
			int iTemp234 = int(fTemp233);
			double fTemp235 = std::floor(fTemp233);
			double fTemp236 = fTemp233 + (-1.0 - fTemp235);
			double fTemp237 = fTemp233 - fTemp235;
			double fTemp238 = fTemp233 + (-2.0 - fTemp235);
			int iTemp239 = iRec165[0] == 6;
			iVec14[0] = iTemp239;
			int iTemp240 = ((fRec171[1] == 0.0) | (fRec171[1] == 1.0)) & (iTemp239 > iVec14[1]);
			double fTemp241 = ((iTemp240) ? fTemp227 : fRec172[1]);
			fRec171[0] = ((iTemp240) ? fTemp241 : std::min<double>(1.0, fRec171[1] + fTemp241));
			fRec172[0] = fTemp241;
			int iRec173 = iTemp240;
			fRec170[0] = ((iRec173) ? fTemp226 : fRec170[1]);
			fRec174[0] = ((iRec173) ? fTemp232 : fRec174[1]);
			double fTemp242 = std::fmod(fSlow18 + std::fmod(fSlow18 * fRec174[0] + fConst0 * fRec171[0] * fRec170[0], fSlow18), fSlow18);
			int iTemp243 = int(fTemp242);
			double fTemp244 = std::floor(fTemp242);
			double fTemp245 = fTemp242 + (-1.0 - fTemp244);
			double fTemp246 = fTemp242 - fTemp244;
			double fTemp247 = fTemp242 + (-2.0 - fTemp244);
			int iTemp248 = iRec165[0] == 5;
			iVec15[0] = iTemp248;
			int iTemp249 = ((fRec176[1] == 0.0) | (fRec176[1] == 1.0)) & (iTemp248 > iVec15[1]);
			double fTemp250 = ((iTemp249) ? fTemp227 : fRec177[1]);
			fRec176[0] = ((iTemp249) ? fTemp250 : std::min<double>(1.0, fRec176[1] + fTemp250));
			fRec177[0] = fTemp250;
			int iRec178 = iTemp249;
			fRec175[0] = ((iRec178) ? fTemp226 : fRec175[1]);
			fRec179[0] = ((iRec178) ? fTemp232 : fRec179[1]);
			double fTemp251 = std::fmod(fSlow18 + std::fmod(fSlow18 * fRec179[0] + fConst0 * fRec176[0] * fRec175[0], fSlow18), fSlow18);
			int iTemp252 = int(fTemp251);
			double fTemp253 = std::floor(fTemp251);
			double fTemp254 = fTemp251 + (-1.0 - fTemp253);
			double fTemp255 = fTemp251 - fTemp253;
			double fTemp256 = fTemp251 + (-2.0 - fTemp253);
			int iTemp257 = iRec165[0] == 4;
			iVec16[0] = iTemp257;
			int iTemp258 = ((fRec181[1] == 0.0) | (fRec181[1] == 1.0)) & (iTemp257 > iVec16[1]);
			double fTemp259 = ((iTemp258) ? fTemp227 : fRec182[1]);
			fRec181[0] = ((iTemp258) ? fTemp259 : std::min<double>(1.0, fRec181[1] + fTemp259));
			fRec182[0] = fTemp259;
			int iRec183 = iTemp258;
			fRec180[0] = ((iRec183) ? fTemp226 : fRec180[1]);
			fRec184[0] = ((iRec183) ? fTemp232 : fRec184[1]);
			double fTemp260 = std::fmod(fSlow18 + std::fmod(fSlow18 * fRec184[0] + fConst0 * fRec181[0] * fRec180[0], fSlow18), fSlow18);
			int iTemp261 = int(fTemp260);
			double fTemp262 = std::floor(fTemp260);
			double fTemp263 = fTemp260 + (-1.0 - fTemp262);
			double fTemp264 = fTemp260 - fTemp262;
			double fTemp265 = fTemp260 + (-2.0 - fTemp262);
			int iTemp266 = iRec165[0] == 3;
			iVec17[0] = iTemp266;
			int iTemp267 = ((fRec186[1] == 0.0) | (fRec186[1] == 1.0)) & (iTemp266 > iVec17[1]);
			double fTemp268 = ((iTemp267) ? fTemp227 : fRec187[1]);
			fRec186[0] = ((iTemp267) ? fTemp268 : std::min<double>(1.0, fRec186[1] + fTemp268));
			fRec187[0] = fTemp268;
			int iRec188 = iTemp267;
			fRec185[0] = ((iRec188) ? fTemp226 : fRec185[1]);
			fRec189[0] = ((iRec188) ? fTemp232 : fRec189[1]);
			double fTemp269 = std::fmod(fSlow18 + std::fmod(fSlow18 * fRec189[0] + fConst0 * fRec186[0] * fRec185[0], fSlow18), fSlow18);
			int iTemp270 = int(fTemp269);
			double fTemp271 = std::floor(fTemp269);
			double fTemp272 = fTemp269 + (-1.0 - fTemp271);
			double fTemp273 = fTemp269 - fTemp271;
			double fTemp274 = fTemp269 + (-2.0 - fTemp271);
			int iTemp275 = iRec165[0] == 2;
			iVec18[0] = iTemp275;
			int iTemp276 = ((fRec191[1] == 0.0) | (fRec191[1] == 1.0)) & (iTemp275 > iVec18[1]);
			double fTemp277 = ((iTemp276) ? fTemp227 : fRec192[1]);
			fRec191[0] = ((iTemp276) ? fTemp277 : std::min<double>(1.0, fRec191[1] + fTemp277));
			fRec192[0] = fTemp277;
			int iRec193 = iTemp276;
			fRec190[0] = ((iRec193) ? fTemp226 : fRec190[1]);
			fRec194[0] = ((iRec193) ? fTemp232 : fRec194[1]);
			double fTemp278 = std::fmod(fSlow18 + std::fmod(fSlow18 * fRec194[0] + fConst0 * fRec191[0] * fRec190[0], fSlow18), fSlow18);
			int iTemp279 = int(fTemp278);
			double fTemp280 = std::floor(fTemp278);
			double fTemp281 = fTemp278 + (-1.0 - fTemp280);
			double fTemp282 = fTemp278 - fTemp280;
			double fTemp283 = fTemp278 + (-2.0 - fTemp280);
			int iTemp284 = iRec165[0] == 1;
			iVec19[0] = iTemp284;
			int iTemp285 = ((fRec196[1] == 0.0) | (fRec196[1] == 1.0)) & (iTemp284 > iVec19[1]);
			double fTemp286 = ((iTemp285) ? fTemp227 : fRec197[1]);
			fRec196[0] = ((iTemp285) ? fTemp286 : std::min<double>(1.0, fRec196[1] + fTemp286));
			fRec197[0] = fTemp286;
			int iRec198 = iTemp285;
			fRec195[0] = ((iRec198) ? fTemp226 : fRec195[1]);
			fRec199[0] = ((iRec198) ? fTemp232 : fRec199[1]);
			double fTemp287 = std::fmod(fSlow18 + std::fmod(fSlow18 * fRec199[0] + fConst0 * fRec196[0] * fRec195[0], fSlow18), fSlow18);
			int iTemp288 = int(fTemp287);
			double fTemp289 = std::floor(fTemp287);
			double fTemp290 = fTemp287 + (-1.0 - fTemp289);
			double fTemp291 = fTemp287 - fTemp289;
			double fTemp292 = fTemp287 + (-2.0 - fTemp289);
			int iTemp293 = iRec165[0] == 0;
			iVec20[0] = iTemp293;
			int iTemp294 = ((fRec201[1] == 0.0) | (fRec201[1] == 1.0)) & (iTemp293 > iVec20[1]);
			double fTemp295 = ((iTemp294) ? fTemp227 : fRec202[1]);
			fRec201[0] = ((iTemp294) ? fTemp295 : std::min<double>(1.0, fRec201[1] + fTemp295));
			fRec202[0] = fTemp295;
			int iRec203 = iTemp294;
			fRec200[0] = ((iRec203) ? fTemp226 : fRec200[1]);
			fRec204[0] = ((iRec203) ? fTemp232 : fRec204[1]);
			double fTemp296 = std::fmod(fSlow18 + std::fmod(fSlow18 * fRec204[0] + fConst0 * fRec201[0] * fRec200[0], fSlow18), fSlow18);
			int iTemp297 = int(fTemp296);
			double fTemp298 = std::floor(fTemp296);
			double fTemp299 = fTemp296 + (-1.0 - fTemp298);
			double fTemp300 = fTemp296 - fTemp298;
			double fTemp301 = fTemp296 + (-2.0 - fTemp298);
			double fTemp302 = 1e+03 * (mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec201[0])) * ((0.0 - fTemp300) * (0.0 - 0.5 * fTemp299) * (0.0 - 0.3333333333333333 * fTemp301) * ftbl0[((iTemp297 + -1) % 882000 + 882000) % 882000] + (fTemp296 + (1.0 - fTemp298)) * ((0.0 - fTemp299) * (0.0 - 0.5 * fTemp301) * ftbl0[(iTemp297 % 882000 + 882000) % 882000] + 0.5 * fTemp300 * (0.0 - fTemp301) * ftbl0[((iTemp297 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp300 * fTemp299 * ftbl0[((iTemp297 + 2) % 882000 + 882000) % 882000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec196[0])) * ((0.0 - fTemp291) * (0.0 - 0.5 * fTemp290) * (0.0 - 0.3333333333333333 * fTemp292) * ftbl0[((iTemp288 + -1) % 882000 + 882000) % 882000] + (fTemp287 + (1.0 - fTemp289)) * ((0.0 - fTemp290) * (0.0 - 0.5 * fTemp292) * ftbl0[(iTemp288 % 882000 + 882000) % 882000] + 0.5 * fTemp291 * (0.0 - fTemp292) * ftbl0[((iTemp288 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp291 * fTemp290 * ftbl0[((iTemp288 + 2) % 882000 + 882000) % 882000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec191[0])) * ((0.0 - fTemp282) * (0.0 - 0.5 * fTemp281) * (0.0 - 0.3333333333333333 * fTemp283) * ftbl0[((iTemp279 + -1) % 882000 + 882000) % 882000] + (fTemp278 + (1.0 - fTemp280)) * ((0.0 - fTemp281) * (0.0 - 0.5 * fTemp283) * ftbl0[(iTemp279 % 882000 + 882000) % 882000] + 0.5 * fTemp282 * (0.0 - fTemp283) * ftbl0[((iTemp279 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp282 * fTemp281 * ftbl0[((iTemp279 + 2) % 882000 + 882000) % 882000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec186[0])) * ((0.0 - fTemp273) * (0.0 - 0.5 * fTemp272) * (0.0 - 0.3333333333333333 * fTemp274) * ftbl0[((iTemp270 + -1) % 882000 + 882000) % 882000] + (fTemp269 + (1.0 - fTemp271)) * ((0.0 - fTemp272) * (0.0 - 0.5 * fTemp274) * ftbl0[(iTemp270 % 882000 + 882000) % 882000] + 0.5 * fTemp273 * (0.0 - fTemp274) * ftbl0[((iTemp270 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp273 * fTemp272 * ftbl0[((iTemp270 + 2) % 882000 + 882000) % 882000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec181[0])) * ((0.0 - fTemp264) * (0.0 - 0.5 * fTemp263) * (0.0 - 0.3333333333333333 * fTemp265) * ftbl0[((iTemp261 + -1) % 882000 + 882000) % 882000] + (fTemp260 + (1.0 - fTemp262)) * ((0.0 - fTemp263) * (0.0 - 0.5 * fTemp265) * ftbl0[(iTemp261 % 882000 + 882000) % 882000] + 0.5 * fTemp264 * (0.0 - fTemp265) * ftbl0[((iTemp261 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp264 * fTemp263 * ftbl0[((iTemp261 + 2) % 882000 + 882000) % 882000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec176[0])) * ((0.0 - fTemp255) * (0.0 - 0.5 * fTemp254) * (0.0 - 0.3333333333333333 * fTemp256) * ftbl0[((iTemp252 + -1) % 882000 + 882000) % 882000] + (fTemp251 + (1.0 - fTemp253)) * ((0.0 - fTemp254) * (0.0 - 0.5 * fTemp256) * ftbl0[(iTemp252 % 882000 + 882000) % 882000] + 0.5 * fTemp255 * (0.0 - fTemp256) * ftbl0[((iTemp252 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp255 * fTemp254 * ftbl0[((iTemp252 + 2) % 882000 + 882000) % 882000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec171[0])) * ((0.0 - fTemp246) * (0.0 - 0.5 * fTemp245) * (0.0 - 0.3333333333333333 * fTemp247) * ftbl0[((iTemp243 + -1) % 882000 + 882000) % 882000] + (fTemp242 + (1.0 - fTemp244)) * ((0.0 - fTemp245) * (0.0 - 0.5 * fTemp247) * ftbl0[(iTemp243 % 882000 + 882000) % 882000] + 0.5 * fTemp246 * (0.0 - fTemp247) * ftbl0[((iTemp243 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp246 * fTemp245 * ftbl0[((iTemp243 + 2) % 882000 + 882000) % 882000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec160[0])) * ((0.0 - fTemp237) * (0.0 - 0.5 * fTemp236) * (0.0 - 0.3333333333333333 * fTemp238) * ftbl0[((iTemp234 + -1) % 882000 + 882000) % 882000] + (fTemp233 + (1.0 - fTemp235)) * ((0.0 - fTemp236) * (0.0 - 0.5 * fTemp238) * ftbl0[(iTemp234 % 882000 + 882000) % 882000] + 0.5 * fTemp237 * (0.0 - fTemp238) * ftbl0[((iTemp234 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp237 * fTemp236 * ftbl0[((iTemp234 + 2) % 882000 + 882000) % 882000])));
			fVbargraph18 = FAUSTFLOAT(fTemp302);
			double fTemp303 = fTemp302;
			fRec0[0] = 0.001 * fTemp303;
			int iTemp304 = fRec210[1] < fRec210[2];
			fRec212[0] = fVec10[(IOTA0 - iSlow7) & 2097151];
			double fTemp305 = 1e+03 * std::max<double>(0.0, std::min<double>(1.0, fRec212[1]));
			fVbargraph19 = FAUSTFLOAT(fTemp305);
			double fTemp306 = 0.001 * fTemp305;
			double fTemp307 = ((iTemp304 + iTemp45) ? fConst6 * std::pow(5e+01, 2.0 * (1.0 - fTemp306) + -1.0) : fRec209[1]);
			fRec209[0] = fTemp307;
			double fTemp308 = fRec210[1] + fTemp307;
			fRec210[0] = fTemp308 - std::floor(fTemp308);
			iRec211[0] = (iTemp304 + iRec211[1] + iTemp45) % 8;
			int iTemp309 = iRec211[0] == 7;
			iVec21[0] = iTemp309;
			int iTemp310 = ((fRec206[1] == 0.0) | (fRec206[1] == 1.0)) & (iTemp309 > iVec21[1]);
			double fTemp311 = 0.05 * fTemp143;
			double fTemp312 = fTemp311 + 4.656612875245797e-11 * fTemp225 * (fTemp311 + 0.023) + 0.023;
			double fTemp313 = fConst6 / std::max<double>(fConst6, fTemp312);
			double fTemp314 = ((iTemp310) ? fTemp313 : fRec207[1]);
			fRec206[0] = ((iTemp310) ? fTemp314 : std::min<double>(1.0, fRec206[1] + fTemp314));
			fRec207[0] = fTemp314;
			int iRec208 = iTemp310;
			fRec205[0] = ((iRec208) ? fTemp312 : fRec205[1]);
			double fTemp315 = 5e+02 * (fTemp229 + 1.0);
			fVbargraph20 = FAUSTFLOAT(fTemp315);
			double fTemp316 = fTemp315;
			double fTemp317 = 0.001 * fTemp316 * (1.0 - 0.01 * fTemp143) + 4.656612875245797e-12 * fTemp225 * fTemp143;
			fRec213[0] = ((iRec208) ? fTemp317 : fRec213[1]);
			double fTemp318 = std::fmod(fSlow18 + std::fmod(fSlow18 * fRec213[0] + fConst0 * fRec206[0] * fRec205[0], fSlow18), fSlow18);
			int iTemp319 = int(fTemp318);
			double fTemp320 = std::floor(fTemp318);
			double fTemp321 = fTemp318 + (-1.0 - fTemp320);
			double fTemp322 = fTemp318 - fTemp320;
			double fTemp323 = fTemp318 + (-2.0 - fTemp320);
			int iTemp324 = iRec211[0] == 6;
			iVec22[0] = iTemp324;
			int iTemp325 = ((fRec215[1] == 0.0) | (fRec215[1] == 1.0)) & (iTemp324 > iVec22[1]);
			double fTemp326 = ((iTemp325) ? fTemp313 : fRec216[1]);
			fRec215[0] = ((iTemp325) ? fTemp326 : std::min<double>(1.0, fRec215[1] + fTemp326));
			fRec216[0] = fTemp326;
			int iRec217 = iTemp325;
			fRec214[0] = ((iRec217) ? fTemp312 : fRec214[1]);
			fRec218[0] = ((iRec217) ? fTemp317 : fRec218[1]);
			double fTemp327 = std::fmod(fSlow18 + std::fmod(fSlow18 * fRec218[0] + fConst0 * fRec215[0] * fRec214[0], fSlow18), fSlow18);
			int iTemp328 = int(fTemp327);
			double fTemp329 = std::floor(fTemp327);
			double fTemp330 = fTemp327 + (-1.0 - fTemp329);
			double fTemp331 = fTemp327 - fTemp329;
			double fTemp332 = fTemp327 + (-2.0 - fTemp329);
			int iTemp333 = iRec211[0] == 5;
			iVec23[0] = iTemp333;
			int iTemp334 = ((fRec220[1] == 0.0) | (fRec220[1] == 1.0)) & (iTemp333 > iVec23[1]);
			double fTemp335 = ((iTemp334) ? fTemp313 : fRec221[1]);
			fRec220[0] = ((iTemp334) ? fTemp335 : std::min<double>(1.0, fRec220[1] + fTemp335));
			fRec221[0] = fTemp335;
			int iRec222 = iTemp334;
			fRec219[0] = ((iRec222) ? fTemp312 : fRec219[1]);
			fRec223[0] = ((iRec222) ? fTemp317 : fRec223[1]);
			double fTemp336 = std::fmod(fSlow18 + std::fmod(fSlow18 * fRec223[0] + fConst0 * fRec220[0] * fRec219[0], fSlow18), fSlow18);
			int iTemp337 = int(fTemp336);
			double fTemp338 = std::floor(fTemp336);
			double fTemp339 = fTemp336 + (-1.0 - fTemp338);
			double fTemp340 = fTemp336 - fTemp338;
			double fTemp341 = fTemp336 + (-2.0 - fTemp338);
			int iTemp342 = iRec211[0] == 4;
			iVec24[0] = iTemp342;
			int iTemp343 = ((fRec225[1] == 0.0) | (fRec225[1] == 1.0)) & (iTemp342 > iVec24[1]);
			double fTemp344 = ((iTemp343) ? fTemp313 : fRec226[1]);
			fRec225[0] = ((iTemp343) ? fTemp344 : std::min<double>(1.0, fRec225[1] + fTemp344));
			fRec226[0] = fTemp344;
			int iRec227 = iTemp343;
			fRec224[0] = ((iRec227) ? fTemp312 : fRec224[1]);
			fRec228[0] = ((iRec227) ? fTemp317 : fRec228[1]);
			double fTemp345 = std::fmod(fSlow18 + std::fmod(fSlow18 * fRec228[0] + fConst0 * fRec225[0] * fRec224[0], fSlow18), fSlow18);
			int iTemp346 = int(fTemp345);
			double fTemp347 = std::floor(fTemp345);
			double fTemp348 = fTemp345 + (-1.0 - fTemp347);
			double fTemp349 = fTemp345 - fTemp347;
			double fTemp350 = fTemp345 + (-2.0 - fTemp347);
			int iTemp351 = iRec211[0] == 3;
			iVec25[0] = iTemp351;
			int iTemp352 = ((fRec230[1] == 0.0) | (fRec230[1] == 1.0)) & (iTemp351 > iVec25[1]);
			double fTemp353 = ((iTemp352) ? fTemp313 : fRec231[1]);
			fRec230[0] = ((iTemp352) ? fTemp353 : std::min<double>(1.0, fRec230[1] + fTemp353));
			fRec231[0] = fTemp353;
			int iRec232 = iTemp352;
			fRec229[0] = ((iRec232) ? fTemp312 : fRec229[1]);
			fRec233[0] = ((iRec232) ? fTemp317 : fRec233[1]);
			double fTemp354 = std::fmod(fSlow18 + std::fmod(fSlow18 * fRec233[0] + fConst0 * fRec230[0] * fRec229[0], fSlow18), fSlow18);
			int iTemp355 = int(fTemp354);
			double fTemp356 = std::floor(fTemp354);
			double fTemp357 = fTemp354 + (-1.0 - fTemp356);
			double fTemp358 = fTemp354 - fTemp356;
			double fTemp359 = fTemp354 + (-2.0 - fTemp356);
			int iTemp360 = iRec211[0] == 2;
			iVec26[0] = iTemp360;
			int iTemp361 = ((fRec235[1] == 0.0) | (fRec235[1] == 1.0)) & (iTemp360 > iVec26[1]);
			double fTemp362 = ((iTemp361) ? fTemp313 : fRec236[1]);
			fRec235[0] = ((iTemp361) ? fTemp362 : std::min<double>(1.0, fRec235[1] + fTemp362));
			fRec236[0] = fTemp362;
			int iRec237 = iTemp361;
			fRec234[0] = ((iRec237) ? fTemp312 : fRec234[1]);
			fRec238[0] = ((iRec237) ? fTemp317 : fRec238[1]);
			double fTemp363 = std::fmod(fSlow18 + std::fmod(fSlow18 * fRec238[0] + fConst0 * fRec235[0] * fRec234[0], fSlow18), fSlow18);
			int iTemp364 = int(fTemp363);
			double fTemp365 = std::floor(fTemp363);
			double fTemp366 = fTemp363 + (-1.0 - fTemp365);
			double fTemp367 = fTemp363 - fTemp365;
			double fTemp368 = fTemp363 + (-2.0 - fTemp365);
			int iTemp369 = iRec211[0] == 1;
			iVec27[0] = iTemp369;
			int iTemp370 = ((fRec240[1] == 0.0) | (fRec240[1] == 1.0)) & (iTemp369 > iVec27[1]);
			double fTemp371 = ((iTemp370) ? fTemp313 : fRec241[1]);
			fRec240[0] = ((iTemp370) ? fTemp371 : std::min<double>(1.0, fRec240[1] + fTemp371));
			fRec241[0] = fTemp371;
			int iRec242 = iTemp370;
			fRec239[0] = ((iRec242) ? fTemp312 : fRec239[1]);
			fRec243[0] = ((iRec242) ? fTemp317 : fRec243[1]);
			double fTemp372 = std::fmod(fSlow18 + std::fmod(fSlow18 * fRec243[0] + fConst0 * fRec240[0] * fRec239[0], fSlow18), fSlow18);
			int iTemp373 = int(fTemp372);
			double fTemp374 = std::floor(fTemp372);
			double fTemp375 = fTemp372 + (-1.0 - fTemp374);
			double fTemp376 = fTemp372 - fTemp374;
			double fTemp377 = fTemp372 + (-2.0 - fTemp374);
			int iTemp378 = iRec211[0] == 0;
			iVec28[0] = iTemp378;
			int iTemp379 = ((fRec245[1] == 0.0) | (fRec245[1] == 1.0)) & (iTemp378 > iVec28[1]);
			double fTemp380 = ((iTemp379) ? fTemp313 : fRec246[1]);
			fRec245[0] = ((iTemp379) ? fTemp380 : std::min<double>(1.0, fRec245[1] + fTemp380));
			fRec246[0] = fTemp380;
			int iRec247 = iTemp379;
			fRec244[0] = ((iRec247) ? fTemp312 : fRec244[1]);
			fRec248[0] = ((iRec247) ? fTemp317 : fRec248[1]);
			double fTemp381 = std::fmod(fSlow18 + std::fmod(fSlow18 * fRec248[0] + fConst0 * fRec245[0] * fRec244[0], fSlow18), fSlow18);
			int iTemp382 = int(fTemp381);
			double fTemp383 = std::floor(fTemp381);
			double fTemp384 = fTemp381 + (-1.0 - fTemp383);
			double fTemp385 = fTemp381 - fTemp383;
			double fTemp386 = fTemp381 + (-2.0 - fTemp383);
			double fTemp387 = 1e+03 * (mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec245[0])) * ((0.0 - fTemp385) * (0.0 - 0.5 * fTemp384) * (0.0 - 0.3333333333333333 * fTemp386) * ftbl0[((iTemp382 + -1) % 882000 + 882000) % 882000] + (fTemp381 + (1.0 - fTemp383)) * ((0.0 - fTemp384) * (0.0 - 0.5 * fTemp386) * ftbl0[(iTemp382 % 882000 + 882000) % 882000] + 0.5 * fTemp385 * (0.0 - fTemp386) * ftbl0[((iTemp382 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp385 * fTemp384 * ftbl0[((iTemp382 + 2) % 882000 + 882000) % 882000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec240[0])) * ((0.0 - fTemp376) * (0.0 - 0.5 * fTemp375) * (0.0 - 0.3333333333333333 * fTemp377) * ftbl0[((iTemp373 + -1) % 882000 + 882000) % 882000] + (fTemp372 + (1.0 - fTemp374)) * ((0.0 - fTemp375) * (0.0 - 0.5 * fTemp377) * ftbl0[(iTemp373 % 882000 + 882000) % 882000] + 0.5 * fTemp376 * (0.0 - fTemp377) * ftbl0[((iTemp373 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp376 * fTemp375 * ftbl0[((iTemp373 + 2) % 882000 + 882000) % 882000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec235[0])) * ((0.0 - fTemp367) * (0.0 - 0.5 * fTemp366) * (0.0 - 0.3333333333333333 * fTemp368) * ftbl0[((iTemp364 + -1) % 882000 + 882000) % 882000] + (fTemp363 + (1.0 - fTemp365)) * ((0.0 - fTemp366) * (0.0 - 0.5 * fTemp368) * ftbl0[(iTemp364 % 882000 + 882000) % 882000] + 0.5 * fTemp367 * (0.0 - fTemp368) * ftbl0[((iTemp364 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp367 * fTemp366 * ftbl0[((iTemp364 + 2) % 882000 + 882000) % 882000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec230[0])) * ((0.0 - fTemp358) * (0.0 - 0.5 * fTemp357) * (0.0 - 0.3333333333333333 * fTemp359) * ftbl0[((iTemp355 + -1) % 882000 + 882000) % 882000] + (fTemp354 + (1.0 - fTemp356)) * ((0.0 - fTemp357) * (0.0 - 0.5 * fTemp359) * ftbl0[(iTemp355 % 882000 + 882000) % 882000] + 0.5 * fTemp358 * (0.0 - fTemp359) * ftbl0[((iTemp355 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp358 * fTemp357 * ftbl0[((iTemp355 + 2) % 882000 + 882000) % 882000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec225[0])) * ((0.0 - fTemp349) * (0.0 - 0.5 * fTemp348) * (0.0 - 0.3333333333333333 * fTemp350) * ftbl0[((iTemp346 + -1) % 882000 + 882000) % 882000] + (fTemp345 + (1.0 - fTemp347)) * ((0.0 - fTemp348) * (0.0 - 0.5 * fTemp350) * ftbl0[(iTemp346 % 882000 + 882000) % 882000] + 0.5 * fTemp349 * (0.0 - fTemp350) * ftbl0[((iTemp346 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp349 * fTemp348 * ftbl0[((iTemp346 + 2) % 882000 + 882000) % 882000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec220[0])) * ((0.0 - fTemp340) * (0.0 - 0.5 * fTemp339) * (0.0 - 0.3333333333333333 * fTemp341) * ftbl0[((iTemp337 + -1) % 882000 + 882000) % 882000] + (fTemp336 + (1.0 - fTemp338)) * ((0.0 - fTemp339) * (0.0 - 0.5 * fTemp341) * ftbl0[(iTemp337 % 882000 + 882000) % 882000] + 0.5 * fTemp340 * (0.0 - fTemp341) * ftbl0[((iTemp337 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp340 * fTemp339 * ftbl0[((iTemp337 + 2) % 882000 + 882000) % 882000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec215[0])) * ((0.0 - fTemp331) * (0.0 - 0.5 * fTemp330) * (0.0 - 0.3333333333333333 * fTemp332) * ftbl0[((iTemp328 + -1) % 882000 + 882000) % 882000] + (fTemp327 + (1.0 - fTemp329)) * ((0.0 - fTemp330) * (0.0 - 0.5 * fTemp332) * ftbl0[(iTemp328 % 882000 + 882000) % 882000] + 0.5 * fTemp331 * (0.0 - fTemp332) * ftbl0[((iTemp328 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp331 * fTemp330 * ftbl0[((iTemp328 + 2) % 882000 + 882000) % 882000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec206[0])) * ((0.0 - fTemp322) * (0.0 - 0.5 * fTemp321) * (0.0 - 0.3333333333333333 * fTemp323) * ftbl0[((iTemp319 + -1) % 882000 + 882000) % 882000] + (fTemp318 + (1.0 - fTemp320)) * ((0.0 - fTemp321) * (0.0 - 0.5 * fTemp323) * ftbl0[(iTemp319 % 882000 + 882000) % 882000] + 0.5 * fTemp322 * (0.0 - fTemp323) * ftbl0[((iTemp319 + 1) % 882000 + 882000) % 882000] + 0.16666666666666666 * fTemp322 * fTemp321 * ftbl0[((iTemp319 + 2) % 882000 + 882000) % 882000])));
			fVbargraph21 = FAUSTFLOAT(fTemp387);
			double fTemp388 = fTemp387;
			fRec1[0] = 0.001 * fTemp388;
			double fTemp389 = fRec11 - (fConst49 * fRec254[1] + fRec255[1]);
			fRec254[0] = fRec254[1] + fConst52 * fTemp389;
			double fTemp390 = fRec254[1] + fConst51 * fTemp389;
			fRec255[0] = fRec255[1] + fConst53 * fTemp390;
			double fTemp391 = fConst54 * fTemp389;
			double fRec256 = fTemp391;
			double fTemp392 = fRec256 - (fConst48 * fRec251[1] + fRec252[1]);
			fRec251[0] = fRec251[1] + fConst57 * fTemp392;
			double fTemp393 = fRec251[1] + fConst56 * fTemp392;
			fRec252[0] = fRec252[1] + fConst53 * fTemp393;
			double fTemp394 = fConst58 * fTemp392;
			fRec253[IOTA0 & 2097151] = fTemp394;
			fRec250[0] = fRec253[(IOTA0 - iSlow25) & 2097151];
			double fTemp395 = 1e+03 * fRec250[1];
			fVbargraph22 = FAUSTFLOAT(fTemp395);
			double fTemp396 = fTemp395;
			fVec29[IOTA0 & 8191] = fTemp396;
			fRec249[0] = 0.001 * fVec29[(IOTA0 - iConst62) & 8191];
			double fTemp397 = fRec10 - (fConst49 * fRec261[1] + fRec262[1]);
			fRec261[0] = fRec261[1] + fConst52 * fTemp397;
			double fTemp398 = fRec261[1] + fConst51 * fTemp397;
			fRec262[0] = fRec262[1] + fConst53 * fTemp398;
			double fTemp399 = fConst54 * fTemp397;
			double fRec263 = fTemp399;
			double fTemp400 = fRec263 - (fConst48 * fRec258[1] + fRec259[1]);
			fRec258[0] = fRec258[1] + fConst57 * fTemp400;
			double fTemp401 = fRec258[1] + fConst56 * fTemp400;
			fRec259[0] = fRec259[1] + fConst53 * fTemp401;
			double fTemp402 = fConst58 * fTemp400;
			fRec260[IOTA0 & 2097151] = fTemp402;
			fRec257[0] = fRec260[(IOTA0 - iSlow21) & 2097151];
			double fTemp403 = 1e+03 * fRec257[1];
			fVbargraph23 = FAUSTFLOAT(fTemp403);
			double fTemp404 = fTemp403;
			fVec30[IOTA0 & 8191] = fTemp404;
			fRec264[0] = fSlow26 + (fRec264[1] - std::floor(fSlow26 + fRec264[1]));
			double fTemp405 = 1e+03 * std::fabs(2.0 * (fRec264[0] + (-0.5 - std::floor(fRec264[0] + -0.5))) + -1.0);
			fVbargraph24 = FAUSTFLOAT(fTemp405);
			double fTemp406 = fTemp405;
			fRec265[0] = 0.001 * fVec30[(IOTA0 - iConst63) & 8191];
			double fTemp407 = 0.001 * fTemp406;
			double fTemp408 = 1.0 - fTemp407;
			double fTemp409 = 1.0 - fTemp206;
			double fTemp410 = 1e+03 * fTemp64;
			fVbargraph25 = FAUSTFLOAT(fTemp410);
			double fTemp411 = fTemp410;
			double fTemp412 = 0.001 * fTemp411;
			double fTemp413 = fRec266[1] + fSlow27 * (1.0 - fTemp412);
			fRec266[0] = fTemp413 - std::floor(fTemp413);
			double fTemp414 = 1e+03 * std::fabs(2.0 * (fRec266[0] + (-0.5 - std::floor(fRec266[0] + -0.5))) + -1.0);
			fVbargraph26 = FAUSTFLOAT(fTemp414);
			double fTemp415 = fTemp414;
			double fTemp416 = 0.001 * fTemp415;
			fRec277[0] = fConst30 * std::fabs(fRec0[1] + fRec1[1]) + fConst23 * fRec277[1];
			fVec31[IOTA0 & 2047] = fRec277[0] + 0.97 * fRec276[1];
			fRec276[0] = fVec31[(IOTA0 - iConst10) & 2047];
			double fTemp417 = fRec276[1] - fRec274[1];
			fRec274[0] = fRec274[1] + fConst32 * fTemp417;
			double fTemp418 = fRec274[1] + fConst31 * fTemp417;
			double fRec275 = fTemp418;
			double fTemp419 = fRec275 - (fConst22 * fRec271[1] + fRec272[1]);
			fRec271[0] = fRec271[1] + fConst35 * fTemp419;
			double fTemp420 = fRec271[1] + fConst34 * fTemp419;
			fRec272[0] = fRec272[1] + fConst36 * fTemp420;
			double fTemp421 = fRec272[1] + fConst20 * fTemp420;
			double fRec273 = fTemp421;
			double fTemp422 = fRec273 - (fConst21 * fRec268[1] + fRec269[1]);
			fRec268[0] = fRec268[1] + fConst39 * fTemp422;
			double fTemp423 = fRec268[1] + fConst38 * fTemp422;
			fRec269[0] = fRec269[1] + fConst36 * fTemp423;
			double fTemp424 = fRec269[1] + fConst20 * fTemp423;
			double fRec270 = fTemp424;
			fVec32[IOTA0 & 8388607] = fRec270 + fSlow28 * fRec267[1];
			fRec267[0] = fVec32[(IOTA0 - iSlow29) & 8388607];
			double fTemp425 = 1e+03 * std::max<double>(0.0, std::min<double>(1.0, 1.0 - 0.5 * (fRec270 + fRec267[1])));
			fVbargraph27 = FAUSTFLOAT(fTemp425);
			double fTemp426 = fTemp425;
			double fTemp427 = fRec9 * fTemp14;
			fVec33[IOTA0 & 16383] = fTemp427;
			double fTemp428 = 0.001 * fTemp427 * fTemp426 * (1.0 - fTemp416);
			fVbargraph28 = FAUSTFLOAT(fTemp428);
			double fTemp429 = fTemp428;
			double fTemp430 = fTemp40 * fTemp426;
			fVbargraph29 = FAUSTFLOAT(fTemp430);
			double fTemp431 = fTemp430;
			fRec278[0] = fSlow30 + fConst8 * fRec278[1];
			double fTemp432 = fRec278[0] * (0.001 * (fTemp431 + fTemp429 + fTemp303 * fTemp409) + fTemp408 * (fRec265[1] + fRec249[1]) + fTemp406 * (1e-06 * fTemp404 + 0.001 * fRec249[1]) + 1e-06 * fTemp14 * fTemp388);
			fVec34[IOTA0 & 16383] = fTemp432;
			double fTemp433 = 1e+03 * fTemp432;
			fVbargraph30 = FAUSTFLOAT(fTemp433);
			double fRec2 = 0.001 * fTemp433;
			fRec279[0] = fRec12[(IOTA0 - iSlow31) & 4194303];
			double fTemp434 = fTemp426 * fRec279[1];
			fVbargraph31 = FAUSTFLOAT(fTemp434);
			double fTemp435 = fTemp434;
			double fTemp436 = 1.0000000000000002e-06 * fTemp426 * fTemp415 * fVec33[(IOTA0 - int(std::min<double>(fConst66, double(std::max<int>(0, std::max<int>(0, int(fConst67 * fTemp411))))))) & 16383];
			fVbargraph32 = FAUSTFLOAT(fTemp436);
			double fTemp437 = fTemp436;
			double fTemp438 = fTemp198 * fTemp426;
			fVbargraph33 = FAUSTFLOAT(fTemp438);
			double fTemp439 = fTemp438;
			double fTemp440 = fRec278[0] * (1e-06 * (fTemp406 * fTemp396 + fTemp14 * fTemp303) + 0.001 * (fTemp404 * fTemp408 + fRec265[1] * fTemp406 + fTemp408 * fTemp396 + fTemp439 + fTemp437 + fTemp435 + fTemp388 * fTemp409));
			fVec35[IOTA0 & 16383] = fTemp440;
			double fTemp441 = 1e+03 * fTemp440;
			fVbargraph34 = FAUSTFLOAT(fTemp441);
			double fRec3 = 0.001 * fTemp441;
			fRec280[0] = fVec35[(IOTA0 - iSlow33) & 16383];
			double fTemp442 = 1e+03 * fRec280[1];
			fVbargraph35 = FAUSTFLOAT(fTemp442);
			double fRec4 = 0.001 * fTemp442;
			fRec281[0] = fVec34[(IOTA0 - iSlow33) & 16383];
			double fTemp443 = 1e+03 * fRec281[1];
			fVbargraph36 = FAUSTFLOAT(fTemp443);
			double fRec5 = 0.001 * fTemp443;
			fRec282[0] = fVec34[(IOTA0 - iSlow34) & 16383];
			double fTemp444 = 1e+03 * fRec282[1];
			fVbargraph37 = FAUSTFLOAT(fTemp444);
			double fRec6 = 0.001 * fTemp444;
			fRec283[0] = fVec35[(IOTA0 - iSlow34) & 16383];
			double fTemp445 = 1e+03 * fRec283[1];
			fVbargraph38 = FAUSTFLOAT(fTemp445);
			double fRec7 = 0.001 * fTemp445;
	...
	#define FAUST_PASSIVES 39

	FAUST_ADDVERTICALBARGRAPH("Mixer/Signal Flow 1A/Mic SF1A Sum", fVbargraph0, -8e+01, 2e+01);
	FAUST_ADDVERTICALSLIDER("Mixer/Signal Flow 1A/SF_1A", fVslider0, 0.0, -84.0, 24.0, 0.001);
	FAUST_ADDVERTICALBARGRAPH("Mixer/Signal Flow 1B/Mic1 SF1B", fVbargraph3, -8e+01, 2e+01);
	FAUST_ADDVERTICALBARGRAPH("Mixer/Signal Flow 1B/Mic2 SF1B", fVbargraph12, -8e+01, 2e+01);
	FAUST_ADDVERTICALSLIDER("Mixer/Signal Flow 1B/SF_1B", fVslider1, 0.0, -84.0, 24.0, 0.001);
	FAUST_ADDVERTICALBARGRAPH("Mixer/Signal Flow 2A/Mic1 SF2A", fVbargraph5, -8e+01, 2e+01);
	FAUST_ADDVERTICALBARGRAPH("Mixer/Signal Flow 2A/Mic2 SF2A", fVbargraph14, -8e+01, 2e+01);
	FAUST_ADDVERTICALSLIDER("Mixer/Signal Flow 2A/SF_2A", fVslider2, 0.0, -84.0, 24.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Mixer/Signal Flow 3/SF_3", fVslider3, 0.0, -84.0, 24.0, 0.001);
	FAUST_ADDCHECKBOX("Mixer ON/OFF/mute/unmute", fCheckbox0);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1a/Sens. to Ext. Cond./sig_101", fVbargraph6, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1a/diffHL Centroid/sig_100", fVbargraph9, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1a/sig_ 0", fVbargraph10, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1a/sig_ 1", fVbargraph8, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1a/sig_ 2", fVbargraph11, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1a/sig_ 3", fVbargraph1, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1a/sig_ 4", fVbargraph16, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1a/sig_ 5", fVbargraph19, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1a/sig_ 6", fVbargraph7, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1a/sig_ 7", fVbargraph25, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1b/sig_ 0", fVbargraph4, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1b/sig_ 1", fVbargraph13, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1b/sig_ 2", fVbargraph27, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1b/sig_ 3", fVbargraph17, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1b/sig_ 4", fVbargraph20, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1b/sig_ 5", fVbargraph2, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1b/sig_ 6", fVbargraph26, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1b/sig_ 7", fVbargraph24, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 2a/sig_ 0", fVbargraph15, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 2a/sig_ 1", fVbargraph29, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 2a/sig_ 2", fVbargraph33, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 2a/sig_ 3", fVbargraph32, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 2a/sig_ 4", fVbargraph28, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 2a/sig_ 5", fVbargraph23, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 2a/sig_ 6", fVbargraph22, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 2a/sig_ 7", fVbargraph31, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 3/Granular Sampling 1/sig_180", fVbargraph18, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 3/Granular Sampling 2/sig_181", fVbargraph21, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 3/sig_ 0", fVbargraph30, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 3/sig_ 1", fVbargraph34, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 3/sig_ 2", fVbargraph35, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 3/sig_ 3", fVbargraph36, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 3/sig_ 4", fVbargraph37, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 3/sig_ 5", fVbargraph38, -1e+03, 1e+03);
	FAUST_ADDNUMENTRY("System Variables/Var 1", fEntry0, 8.0, 1.0, 2e+01, 1.0);
	FAUST_ADDNUMENTRY("System Variables/Var 2", fEntry1, 5e+01, 1.0, 1e+04, 1.0);
	FAUST_ADDNUMENTRY("System Variables/Var 3", fEntry2, 0.25, 0.0, 1.0, 0.001);
	FAUST_ADDNUMENTRY("System Variables/Var 4", fEntry3, 8.2, 1.0, 2e+01, 1.0);

	#define FAUST_LIST_ACTIVES(p) \
		p(VERTICALSLIDER, SF_1A, "Mixer/Signal Flow 1A/SF_1A", fVslider0, 0.0, -84.0, 24.0, 0.001) \
		p(VERTICALSLIDER, SF_1B, "Mixer/Signal Flow 1B/SF_1B", fVslider1, 0.0, -84.0, 24.0, 0.001) \
		p(VERTICALSLIDER, SF_2A, "Mixer/Signal Flow 2A/SF_2A", fVslider2, 0.0, -84.0, 24.0, 0.001) \
		p(VERTICALSLIDER, SF_3, "Mixer/Signal Flow 3/SF_3", fVslider3, 0.0, -84.0, 24.0, 0.001) \
		p(CHECKBOX, mute/unmute, "Mixer ON/OFF/mute/unmute", fCheckbox0, 0.0, 0.0, 1.0, 1.0) \
		p(NUMENTRY, Var_1, "System Variables/Var 1", fEntry0, 8.0, 1.0, 2e+01, 1.0) \
		p(NUMENTRY, Var_2, "System Variables/Var 2", fEntry1, 5e+01, 1.0, 1e+04, 1.0) \
		p(NUMENTRY, Var_3, "System Variables/Var 3", fEntry2, 0.25, 0.0, 1.0, 0.001) \
		p(NUMENTRY, Var_4, "System Variables/Var 4", fEntry3, 8.2, 1.0, 2e+01, 1.0) \

	#define FAUST_LIST_PASSIVES(p) \
		p(VERTICALBARGRAPH, Mic_SF1A_Sum, "Mixer/Signal Flow 1A/Mic SF1A Sum", fVbargraph0, 0.0, -8e+01, 2e+01, 0.0) \
		p(VERTICALBARGRAPH, Mic1_SF1B, "Mixer/Signal Flow 1B/Mic1 SF1B", fVbargraph3, 0.0, -8e+01, 2e+01, 0.0) \
		p(VERTICALBARGRAPH, Mic2_SF1B, "Mixer/Signal Flow 1B/Mic2 SF1B", fVbargraph12, 0.0, -8e+01, 2e+01, 0.0) \
		p(VERTICALBARGRAPH, Mic1_SF2A, "Mixer/Signal Flow 2A/Mic1 SF2A", fVbargraph5, 0.0, -8e+01, 2e+01, 0.0) \
		p(VERTICALBARGRAPH, Mic2_SF2A, "Mixer/Signal Flow 2A/Mic2 SF2A", fVbargraph14, 0.0, -8e+01, 2e+01, 0.0) \
		p(VERTICALBARGRAPH, sig_101, "System Inspectors/Signal Flow 1a/Sens. to Ext. Cond./sig_101", fVbargraph6, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig_100, "System Inspectors/Signal Flow 1a/diffHL Centroid/sig_100", fVbargraph9, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__0, "System Inspectors/Signal Flow 1a/sig_ 0", fVbargraph10, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__1, "System Inspectors/Signal Flow 1a/sig_ 1", fVbargraph8, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__2, "System Inspectors/Signal Flow 1a/sig_ 2", fVbargraph11, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__3, "System Inspectors/Signal Flow 1a/sig_ 3", fVbargraph1, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__4, "System Inspectors/Signal Flow 1a/sig_ 4", fVbargraph16, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__5, "System Inspectors/Signal Flow 1a/sig_ 5", fVbargraph19, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__6, "System Inspectors/Signal Flow 1a/sig_ 6", fVbargraph7, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__7, "System Inspectors/Signal Flow 1a/sig_ 7", fVbargraph25, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__0, "System Inspectors/Signal Flow 1b/sig_ 0", fVbargraph4, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__1, "System Inspectors/Signal Flow 1b/sig_ 1", fVbargraph13, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__2, "System Inspectors/Signal Flow 1b/sig_ 2", fVbargraph27, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__3, "System Inspectors/Signal Flow 1b/sig_ 3", fVbargraph17, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__4, "System Inspectors/Signal Flow 1b/sig_ 4", fVbargraph20, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__5, "System Inspectors/Signal Flow 1b/sig_ 5", fVbargraph2, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__6, "System Inspectors/Signal Flow 1b/sig_ 6", fVbargraph26, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__7, "System Inspectors/Signal Flow 1b/sig_ 7", fVbargraph24, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__0, "System Inspectors/Signal Flow 2a/sig_ 0", fVbargraph15, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__1, "System Inspectors/Signal Flow 2a/sig_ 1", fVbargraph29, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__2, "System Inspectors/Signal Flow 2a/sig_ 2", fVbargraph33, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__3, "System Inspectors/Signal Flow 2a/sig_ 3", fVbargraph32, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__4, "System Inspectors/Signal Flow 2a/sig_ 4", fVbargraph28, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__5, "System Inspectors/Signal Flow 2a/sig_ 5", fVbargraph23, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__6, "System Inspectors/Signal Flow 2a/sig_ 6", fVbargraph22, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__7, "System Inspectors/Signal Flow 2a/sig_ 7", fVbargraph31, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig_180, "System Inspectors/Signal Flow 3/Granular Sampling 1/sig_180", fVbargraph18, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig_181, "System Inspectors/Signal Flow 3/Granular Sampling 2/sig_181", fVbargraph21, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__0, "System Inspectors/Signal Flow 3/sig_ 0", fVbargraph30, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__1, "System Inspectors/Signal Flow 3/sig_ 1", fVbargraph34, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__2, "System Inspectors/Signal Flow 3/sig_ 2", fVbargraph35, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__3, "System Inspectors/Signal Flow 3/sig_ 3", fVbargraph36, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__4, "System Inspectors/Signal Flow 3/sig_ 4", fVbargraph37, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__5, "System Inspectors/Signal Flow 3/sig_ 5", fVbargraph38, 0.0, -1e+03, 1e+03, 0.0) \
