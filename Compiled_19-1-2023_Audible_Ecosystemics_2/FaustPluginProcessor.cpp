...
class mydsp : public base_dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("interpolators.lib/lagrangeN:author", "Dario Sanfilippo");
		m->declare("interpolators.lib/lagrangeN:copyright", "Copyright (C) 2021 Dario Sanfilippo     <sanfilippo.dario@gmail.com>");
		m->declare("interpolators.lib/lagrangeN:license", "LGPL v3.0 license");
		m->declare("interpolators.lib/lagrange_h:author", "Dario Sanfilippo");
		m->declare("interpolators.lib/lagrange_h:copyright", "Copyright (C) 2021 Dario Sanfilippo     <sanfilippo.dario@gmail.com>");
		m->declare("interpolators.lib/lagrange_h:license", "LGPL v3.0 license");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst1 = 0.020833333333333332 / fConst0;
		fConst2 = 1.0 / fConst0;
		fConst3 = 44.1 / fConst0;
		fConst4 = 1.0 - fConst3;
		fConst5 = std::exp(0.0 - 10.000000000040254 / fConst0);
		fConst6 = 1.0 - fConst5;
		iConst7 = int(std::max<double>(0.0, 0.01 * fConst0 + -1.0));
		double fConst8 = std::tan(78.53981633974483 / fConst0);
		fConst9 = fConst8 / (fConst8 + 1.0);
		fConst10 = 2.0 * fConst9;
		double fConst11 = std::tan(157.07963267948966 / fConst0);
		fConst12 = fConst11 / (fConst11 + 1.0);
		fConst13 = 2.0 * fConst12;
		double fConst14 = std::tan(18849.55592153876 / fConst0);
		fConst15 = fConst14 / (fConst14 + 1.0);
		fConst16 = 2.0 * fConst15;
		fConst17 = std::exp(0.0 - 100.00000000040254 / fConst0);
		fConst18 = 1.0 - fConst17;
		double fConst19 = std::tan(1.5707963267948966 / fConst0);
		fConst20 = fConst19 / (fConst19 + 1.0);
		fConst21 = 2.0 * fConst20;
		iConst22 = int(std::max<double>(0.0, 12.0 * fConst0 + -1.0));
		iConst23 = int(std::max<double>(0.0, 4.0 * fConst0 + -1.0));
		fConst24 = 3.141592653589793 / fConst0;
		double fConst25 = std::tan(fConst24);
		fConst26 = fConst25 / (fConst25 + 1.0);
		fConst27 = 2.0 * fConst26;
		double fConst28 = std::tan(314.1592653589793 / fConst0);
		fConst29 = fConst28 / (fConst28 + 1.0);
		fConst30 = 2.0 * fConst29;
		fConst31 = std::exp(0.0 - 20.000000000080508 / fConst0);
		fConst32 = 1.0 - fConst31;
		sig0->instanceInitmydspSIG0(sample_rate);
		sig0->fillmydspSIG0(352800, ftbl1);
		iConst33 = int(std::max<double>(0.0, 2.6666666666666665 * fConst0 + -1.0));
		fConst34 = 8.0 * fConst0;
		iConst35 = int(std::max<double>(0.0, fConst34 + -1.0));
		iConst36 = int(fConst34);
		fConst37 = 0.0625 / fConst0;
		fConst38 = 8.0 / fConst0;
		iConst39 = int(std::max<double>(0.0, 16.0 * fConst0 + -1.0));
		iConst40 = int(std::max<double>(0.0, 3.2 * fConst0 + -1.0));
		iConst41 = int(std::max<double>(0.0, 0.036 * fConst0 + -1.0));
		fConst42 = 0.125 / fConst0;
		iConst43 = int(std::max<double>(0.0, 0.04 * fConst0 + -1.0));
		iConst44 = int(std::max<double>(0.0, 5.333333333333333 * fConst0 + -1.0));
		fConst45 = std::max<double>(0.0, 0.05 * fConst0);
		fConst46 = 5e-05 * fConst0;
		iConst47 = int(std::max<double>(0.0, 0.011627906976744186 * fConst0 + -1.0));
		iConst48 = int(std::max<double>(0.0, 0.023255813953488372 * fConst0 + -1.0));
	...
	virtual void instanceClear() {
		...
		for (int l60 = 0; l60 < 1048576; l60 = l60 + 1) {
			fVec10[l60] = 0.0;
		}
		...
		for (int l96 = 0; l96 < 1048576; l96 = l96 + 1) {
			fRec135[l96] = 0.0;
		}
		...
		for (int l103 = 0; l103 < 2097152; l103 = l103 + 1) {
			fRec145[l103] = 0.0;
		}
		...
		for (int l230 = 0; l230 < 1048576; l230 = l230 + 1) {
			fRec283[l230] = 0.0;
		}
		...
		for (int l238 = 0; l238 < 524288; l238 = l238 + 1) {
			fRec292[l238] = 0.0;
		}
		...
		for (int l247 = 0; l247 < 8192; l247 = l247 + 1) {
			fVec35[l247] = 0.0;
		}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalBargraph("1A", &fVbargraph4, FAUSTFLOAT(-8e+01), FAUSTFLOAT(2e+01));
		ui_interface->declare(&fVslider0, "unit", "db");
		ui_interface->addVerticalSlider("SF_1A", &fVslider0, FAUSTFLOAT(0.0), FAUSTFLOAT(-8e+01), FAUSTFLOAT(8e+01), FAUSTFLOAT(0.001));
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("Signal Flow 1B");
		ui_interface->declare(&fVbargraph9, "unit", "dB");
		ui_interface->addVerticalBargraph("1B", &fVbargraph9, FAUSTFLOAT(-8e+01), FAUSTFLOAT(2e+01));
		ui_interface->declare(&fVslider1, "unit", "db");
		ui_interface->addVerticalSlider("SF_1B", &fVslider1, FAUSTFLOAT(0.0), FAUSTFLOAT(-8e+01), FAUSTFLOAT(8e+01), FAUSTFLOAT(0.001));
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("Signal Flow 2A");
		ui_interface->declare(&fVbargraph11, "unit", "dB");
		ui_interface->addVerticalBargraph("2A", &fVbargraph11, FAUSTFLOAT(-8e+01), FAUSTFLOAT(2e+01));
		ui_interface->declare(&fVslider2, "unit", "db");
		ui_interface->addVerticalSlider("SF_2A", &fVslider2, FAUSTFLOAT(0.0), FAUSTFLOAT(-8e+01), FAUSTFLOAT(8e+01), FAUSTFLOAT(0.001));
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("Signal Flow 3");
		ui_interface->declare(&fVbargraph32, "unit", "dB");
		ui_interface->addVerticalBargraph("3", &fVbargraph32, FAUSTFLOAT(-8e+01), FAUSTFLOAT(2e+01));
		ui_interface->declare(&fVslider3, "unit", "db");
		ui_interface->addVerticalSlider("SF_3", &fVslider3, FAUSTFLOAT(0.0), FAUSTFLOAT(-8e+01), FAUSTFLOAT(8e+01), FAUSTFLOAT(0.001));
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->openVerticalBox("System Inspectors");
		ui_interface->openHorizontalBox("Mics");
		ui_interface->declare(&fVbargraph8, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 0", &fVbargraph8, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph17, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 1", &fVbargraph17, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph3, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 2", &fVbargraph3, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		...
		ui_interface->addVerticalBargraph("sig_ 4", &fVbargraph7, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph16, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 5", &fVbargraph16, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph2, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 6", &fVbargraph2, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph0, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 7", &fVbargraph0, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("Signal Flow 1a");
		ui_interface->declare(&fVbargraph14, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 0", &fVbargraph14, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		...
		ui_interface->addVerticalBargraph("sig_ 2", &fVbargraph15, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph5, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 3", &fVbargraph5, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		...
		ui_interface->addVerticalBargraph("sig_ 6", &fVbargraph12, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		...
		ui_interface->addVerticalBargraph("sig_ 1", &fVbargraph18, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph26, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 2", &fVbargraph26, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph21, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 3", &fVbargraph21, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		...
		ui_interface->addVerticalBargraph("sig_ 5", &fVbargraph6, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		...
		ui_interface->addVerticalBargraph("sig_ 0", &fVbargraph19, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph28, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 1", &fVbargraph28, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph36, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 2", &fVbargraph36, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph35, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 3", &fVbargraph35, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph27, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 4", &fVbargraph27, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph30, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 5", &fVbargraph30, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		...
		ui_interface->addVerticalBargraph("sig_ 7", &fVbargraph34, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("Signal Flow 3");
		ui_interface->declare(&fVbargraph33, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 0", &fVbargraph33, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		...
		ui_interface->addVerticalBargraph("sig_ 2", &fVbargraph38, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph39, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 3", &fVbargraph39, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph40, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 4", &fVbargraph40, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->declare(&fVbargraph41, "style", "numerical");
		ui_interface->addVerticalBargraph("sig_ 5", &fVbargraph41, FAUSTFLOAT(-1e+03), FAUSTFLOAT(1e+03));
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		double fSlow0 = fConst3 * std::pow(1e+01, 0.05 * double(fVslider0));
		double fSlow1 = fConst3 * std::pow(1e+01, 0.05 * double(fVslider1));
		double fSlow2 = fConst3 * std::pow(1e+01, 0.05 * double(fVslider2));
		double fSlow3 = fConst3 * std::pow(1e+01, 0.05 * double(fVslider3));
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			iVec0[0] = 1;
			fRec13[0] = fConst1 + (fRec13[1] - std::floor(fConst1 + fRec13[1]));
			double fTemp0 = 1e+03 * double(input7[i0]);
			fVbargraph0 = FAUSTFLOAT(fTemp0);
			double fTemp1 = 1e+03 * double(input3[i0]);
			fVbargraph1 = FAUSTFLOAT(fTemp1);
			double fTemp2 = fTemp1 + fTemp0;
			double fTemp3 = 1e+03 * double(input6[i0]);
			fVbargraph2 = FAUSTFLOAT(fTemp3);
			double fTemp4 = 1e+03 * double(input2[i0]);
			fVbargraph3 = FAUSTFLOAT(fTemp4);
			double fTemp5 = fTemp4 + fTemp3;
			double fTemp6 = fTemp5 + fTemp2;
			fRec27[0] = fSlow0 + fConst4 * fRec27[1];
			fRec26[0] = std::max<double>(fRec26[1] - fConst2, std::fabs(fRec27[0]));
			fVbargraph4 = FAUSTFLOAT(2e+01 * std::log10(std::max<double>(2.2250738585072014e-308, std::max<double>(0.0001, fRec26[0]))));
			double fTemp7 = fRec27[0];
			double fTemp8 = 0.001 * fTemp7 * fTemp6;
			fRec25[0] = fConst5 * fRec25[1] + fConst6 * std::fabs(fTemp8);
			fVec1[IOTA0 & 2047] = fRec25[0] + 0.9 * fRec24[1];
			fRec24[0] = fVec1[(IOTA0 - iConst7) & 2047];
			double fTemp9 = fRec24[1] - fRec22[1];
			fRec22[0] = fRec22[1] + fConst10 * fTemp9;
			double fTemp10 = fRec22[1] + fConst9 * fTemp9;
			double fRec23 = fTemp10;
			double fTemp11 = fRec23 - fRec20[1];
			fRec20[0] = fRec20[1] + fConst10 * fTemp11;
			double fTemp12 = fRec20[1] + fConst9 * fTemp11;
			double fRec21 = fTemp12;
			double fTemp13 = fRec21 - fRec18[1];
			fRec18[0] = fRec18[1] + fConst10 * fTemp13;
			double fTemp14 = fRec18[1] + fConst9 * fTemp13;
			double fRec19 = fTemp14;
			double fTemp15 = fRec19 - fRec16[1];
			fRec16[0] = fRec16[1] + fConst10 * fTemp15;
			double fTemp16 = fRec16[1] + fConst9 * fTemp15;
			double fRec17 = fTemp16;
			double fTemp17 = fRec17 - fRec14[1];
			fRec14[0] = fRec14[1] + fConst10 * fTemp17;
			double fTemp18 = fRec14[1] + fConst9 * fTemp17;
			double fRec15 = fTemp18;
			double fTemp19 = std::max<double>(0.0, std::min<double>(1.0, 1.0 - mydsp_faustpower2_f(fRec15)));
			fVec2[IOTA0 & 1048575] = fTemp19;
			double fTemp20 = 1e+03 * fTemp19;
			fVbargraph5 = FAUSTFLOAT(fTemp20);
			double fTemp21 = fTemp20;
			double fTemp22 = fTemp21 * std::fabs(2.0 * (fRec13[0] + (-0.5 - std::floor(fRec13[0] + -0.5))) + -1.0);
			fVbargraph6 = FAUSTFLOAT(fTemp22);
			double fTemp23 = fTemp22;
			double fTemp24 = 1e+03 * double(input4[i0]);
			fVbargraph7 = FAUSTFLOAT(fTemp24);
			double fTemp25 = 1e+03 * double(input0[i0]);
			fVbargraph8 = FAUSTFLOAT(fTemp25);
			double fTemp26 = fTemp25 + fTemp24;
			fRec45[0] = fSlow1 + fConst4 * fRec45[1];
			fRec44[0] = std::max<double>(fRec44[1] - fConst2, std::fabs(fRec45[0]));
			fVbargraph9 = FAUSTFLOAT(2e+01 * std::log10(std::max<double>(2.2250738585072014e-308, std::max<double>(0.0001, fRec44[0]))));
			double fTemp27 = fRec45[0];
			double fTemp28 = 0.001 * fTemp27 * fTemp26;
			double fTemp29 = fTemp28 - fRec42[1];
			fRec42[0] = fRec42[1] + fConst13 * fTemp29;
			double fTemp30 = fRec42[1] + fConst12 * fTemp29;
			double fRec43 = fTemp28 - fTemp30;
			double fTemp31 = fRec43 - fRec40[1];
			fRec40[0] = fRec40[1] + fConst16 * fTemp31;
			double fTemp32 = fRec40[1] + fConst15 * fTemp31;
			double fRec41 = fTemp32;
			fRec39[0] = fConst17 * fRec39[1] + fConst18 * std::fabs(fRec41);
			fVec3[IOTA0 & 2047] = fRec39[0] + 0.995 * fRec38[1];
			fRec38[0] = fVec3[(IOTA0 - iConst7) & 2047];
			double fTemp33 = fRec38[1] - fRec36[1];
			fRec36[0] = fRec36[1] + fConst21 * fTemp33;
			double fTemp34 = fRec36[1] + fConst20 * fTemp33;
			double fRec37 = fTemp34;
			double fTemp35 = fRec37 - fRec34[1];
			fRec34[0] = fRec34[1] + fConst21 * fTemp35;
			double fTemp36 = fRec34[1] + fConst20 * fTemp35;
			double fRec35 = fTemp36;
			double fTemp37 = fRec35 - fRec32[1];
			fRec32[0] = fRec32[1] + fConst21 * fTemp37;
			double fTemp38 = fRec32[1] + fConst20 * fTemp37;
			double fRec33 = fTemp38;
			double fTemp39 = fRec33 - fRec30[1];
			fRec30[0] = fRec30[1] + fConst21 * fTemp39;
			double fTemp40 = fRec30[1] + fConst20 * fTemp39;
			double fRec31 = fTemp40;
			double fTemp41 = fRec31 - fRec28[1];
			fRec28[0] = fRec28[1] + fConst21 * fTemp41;
			double fTemp42 = fRec28[1] + fConst20 * fTemp41;
			double fRec29 = fTemp42;
			double fTemp43 = 1e+03 * std::max<double>(0.0, std::min<double>(1.0, fRec29));
			fVbargraph10 = FAUSTFLOAT(fTemp43);
			double fTemp44 = 0.001 * fTemp43;
			fRec51[0] = fSlow2 + fConst4 * fRec51[1];
			fRec50[0] = std::max<double>(fRec50[1] - fConst2, std::fabs(fRec51[0]));
			fVbargraph11 = FAUSTFLOAT(2e+01 * std::log10(std::max<double>(2.2250738585072014e-308, std::max<double>(0.0001, fRec50[0]))));
			double fTemp45 = fRec51[0];
			double fTemp46 = 0.001 * fTemp45 * fTemp26;
			double fTemp47 = fTemp46 - fRec48[1];
			fRec48[0] = fRec48[1] + fConst13 * fTemp47;
			double fTemp48 = fRec48[1] + fConst12 * fTemp47;
			double fRec49 = fTemp46 - fTemp48;
			double fTemp49 = fRec49 - fRec46[1];
			fRec46[0] = fRec46[1] + fConst16 * fTemp49;
			double fTemp50 = fRec46[1] + fConst15 * fTemp49;
			double fRec47 = fTemp50;
			double fTemp51 = fRec47 * (1.0 - fTemp44);
			int iTemp52 = double(iRec68[1]) >= (fRec70[1] + -1.0);
			int iTemp53 = double(iRec72[1]) >= (fRec74[1] + -1.0);
			double fTemp54 = std::fabs(0.001 * fTemp7 * fTemp2);
			double fTemp55 = std::max<double>(fTemp54, fRec73[1] * (1.0 - double(iTemp53)));
			fVec4[0] = fTemp55;
			fRec71[0] = ((iTemp53) ? fVec4[1] : fRec71[1]);
			iRec72[0] = ((iTemp53) ? 1 : iRec72[1] + 1);
			fRec73[0] = fTemp55;
			int iTemp56 = 1 - iVec0[1];
			fRec76[0] = fConst17 * fRec76[1] + fConst18 * fTemp54;
			fVec5[IOTA0 & 2047] = fRec76[0] + 0.95 * fRec75[1];
			fRec75[0] = fVec5[(IOTA0 - iConst7) & 2047];
			double fTemp57 = std::fabs(0.001 * fTemp7 * fTemp5);
			fRec78[0] = fConst17 * fRec78[1] + fConst18 * fTemp57;
			fVec6[IOTA0 & 2047] = fRec78[0] + 0.95 * fRec77[1];
			fRec77[0] = fVec6[(IOTA0 - iConst7) & 2047];
			double fTemp58 = fConst0 * std::max<double>(0.0, std::min<double>(1e+03, 6.0 * (fRec77[1] + fRec75[1] + 1.0)));
			fRec74[0] = ((iTemp53 + iTemp56) ? fTemp58 : fRec74[1]);
			int iTemp59 = double(iRec80[1]) >= (fRec82[1] + -1.0);
			double fTemp60 = std::max<double>(fTemp57, fRec81[1] * (1.0 - double(iTemp59)));
			fVec7[0] = fTemp60;
			fRec79[0] = ((iTemp59) ? fVec7[1] : fRec79[1]);
			iRec80[0] = ((iTemp59) ? 1 : iRec80[1] + 1);
			fRec81[0] = fTemp60;
			fRec82[0] = ((iTemp59 + iTemp56) ? fTemp58 : fRec82[1]);
			double fTemp61 = std::max<double>(std::fabs(fRec79[0] - fRec71[0]), fRec69[1] * (1.0 - double(iTemp52)));
			fVec8[0] = fTemp61;
			fRec67[IOTA0 & 4194303] = ((iTemp52) ? fVec8[1] : fRec67[(IOTA0 - 1) & 4194303]);
			iRec68[0] = ((iTemp52) ? 1 : iRec68[1] + 1);
			fRec69[0] = fTemp61;
			fRec70[0] = ((iTemp52 + iTemp56) ? fTemp58 : fRec70[1]);
			fRec66[0] = fRec67[(IOTA0 - iConst22) & 4194303];
			double fTemp62 = 0.5 * (fRec67[IOTA0 & 4194303] + fRec66[1]);
			double fTemp63 = fTemp62 - fRec64[1];
			fRec64[0] = fRec64[1] + fConst21 * fTemp63;
			double fTemp64 = fRec64[1] + fConst20 * fTemp63;
			double fRec65 = fTemp64;
			fRec63[0] = fConst17 * fRec63[1] + fConst18 * std::fabs(0.001 * fTemp7 * fRec65 * fTemp6);
			fVec9[IOTA0 & 2047] = fRec63[0] + 0.995 * fRec62[1];
			fRec62[0] = fVec9[(IOTA0 - iConst7) & 2047];
			double fTemp65 = fRec62[1] - fRec60[1];
			fRec60[0] = fRec60[1] + fConst10 * fTemp65;
			double fTemp66 = fRec60[1] + fConst9 * fTemp65;
			double fRec61 = fTemp66;
			double fTemp67 = fRec61 - fRec58[1];
			fRec58[0] = fRec58[1] + fConst10 * fTemp67;
			double fTemp68 = fRec58[1] + fConst9 * fTemp67;
			double fRec59 = fTemp68;
			double fTemp69 = fRec59 - fRec56[1];
			fRec56[0] = fRec56[1] + fConst10 * fTemp69;
			double fTemp70 = fRec56[1] + fConst9 * fTemp69;
			double fRec57 = fTemp70;
			double fTemp71 = fRec57 - fRec54[1];
			fRec54[0] = fRec54[1] + fConst10 * fTemp71;
			double fTemp72 = fRec54[1] + fConst9 * fTemp71;
			double fRec55 = fTemp72;
			double fTemp73 = fRec55 - fRec52[1];
			fRec52[0] = fRec52[1] + fConst10 * fTemp73;
			double fTemp74 = fRec52[1] + fConst9 * fTemp73;
			double fRec53 = fTemp74;
			double fTemp75 = std::max<double>(0.0, std::min<double>(1.0, fRec53));
			fVec10[IOTA0 & 1048575] = fTemp75;
			double fTemp76 = 1e+03 * std::max<double>(0.0, std::min<double>(1.0, ((fTemp75 <= 0.5) ? 1.0 : 2.0 * (1.0 - fTemp75))));
			fVbargraph12 = FAUSTFLOAT(fTemp76);
			double fTemp77 = fTemp76;
			fRec88[0] = fVec2[(IOTA0 - iConst23) & 1048575];
			double fTemp78 = 1e+03 * std::max<double>(0.0, std::min<double>(1.0, fRec88[1]));
			fVbargraph13 = FAUSTFLOAT(fTemp78);
			double fTemp79 = fTemp78;
			double fTemp80 = 0.001 * fTemp79;
			double fTemp81 = 1.0 - fTemp80;
			double fTemp82 = 1e+02 * fTemp81;
			double fTemp83 = fTemp82 - fRec86[1];
			fRec86[0] = fRec86[1] + fConst27 * fTemp83;
			double fTemp84 = fRec86[1] + fConst26 * fTemp83;
			double fRec87 = fTemp84;
			double fTemp85 = std::max<double>(2e+01, std::min<double>(2.048e+04, fRec87));
			double fTemp86 = std::tan(fConst24 * fTemp85);
			double fTemp87 = fTemp8 - fRec107[1];
			fRec107[0] = fRec107[1] + fConst30 * fTemp87;
			double fTemp88 = fRec107[1] + fConst29 * fTemp87;
			double fRec108 = fTemp88;
			double fRec109 = fTemp8 - fTemp88;
			double fTemp89 = fRec108 - fRec105[1];
			fRec105[0] = fRec105[1] + fConst30 * fTemp89;
			double fTemp90 = fRec105[1] + fConst29 * fTemp89;
			double fRec106 = fTemp90;
			double fTemp91 = fRec106 - fRec103[1];
			fRec103[0] = fRec103[1] + fConst30 * fTemp91;
			double fTemp92 = fRec103[1] + fConst29 * fTemp91;
			double fRec104 = fTemp92;
			fRec102[0] = fConst5 * fRec102[1] + fConst6 * std::fabs(fRec104);
			double fTemp93 = fRec109 - fRec113[1];
			fRec113[0] = fRec113[1] + fConst30 * fTemp93;
			double fTemp94 = fRec113[1] + fConst29 * fTemp93;
			double fRec114 = fRec109 - fTemp94;
			double fTemp95 = fRec114 - fRec111[1];
			fRec111[0] = fRec111[1] + fConst30 * fTemp95;
			double fTemp96 = fRec111[1] + fConst29 * fTemp95;
			double fRec112 = fRec114 - fTemp96;
			fRec110[0] = fConst31 * fRec110[1] + fConst32 * std::fabs(fRec112);
			fVec11[IOTA0 & 2047] = (fRec110[0] - fRec102[0]) * (1.0 - fRec65) + 0.995 * fRec101[1];
			fRec101[0] = fVec11[(IOTA0 - iConst7) & 2047];
			double fTemp97 = fRec101[1] - fRec99[1];
			fRec99[0] = fRec99[1] + fConst10 * fTemp97;
			double fTemp98 = fRec99[1] + fConst9 * fTemp97;
			double fRec100 = fTemp98;
			double fTemp99 = fRec100 - fRec97[1];
			fRec97[0] = fRec97[1] + fConst10 * fTemp99;
			double fTemp100 = fRec97[1] + fConst9 * fTemp99;
			double fRec98 = fTemp100;
			double fTemp101 = fRec98 - fRec95[1];
			fRec95[0] = fRec95[1] + fConst10 * fTemp101;
			double fTemp102 = fRec95[1] + fConst9 * fTemp101;
			double fRec96 = fTemp102;
			double fTemp103 = fRec96 - fRec93[1];
			fRec93[0] = fRec93[1] + fConst10 * fTemp103;
			double fTemp104 = fRec93[1] + fConst9 * fTemp103;
			double fRec94 = fTemp104;
			double fTemp105 = fRec94 - fRec91[1];
			fRec91[0] = fRec91[1] + fConst10 * fTemp105;
			double fTemp106 = fRec91[1] + fConst9 * fTemp105;
			double fRec92 = fTemp106;
			double fTemp107 = 1e+03 * std::max<double>(0.0, std::min<double>(1.0, 0.5 * (fRec92 + 1.0)));
			fVbargraph14 = FAUSTFLOAT(fTemp107);
			double fTemp108 = fTemp107;
			double fTemp109 = 0.001 * fTemp108;
			double fTemp110 = 8e+02 * (1.0 - fTemp109);
			double fTemp111 = fTemp110 - fRec89[1];
			fRec89[0] = fRec89[1] + fConst27 * fTemp111;
			double fTemp112 = fRec89[1] + fConst26 * fTemp111;
			double fRec90 = fTemp112;
			double fTemp113 = std::max<double>(0.01, std::min<double>(1e+02, std::max<double>(1.0, std::min<double>(2.048e+04, fRec90)) / fTemp85));
			double fTemp114 = 1.0 / fTemp113 + fTemp86;
			double fTemp115 = fTemp86 * fTemp114 + 1.0;
			double fTemp116 = 3.528e+05 * std::max<double>(0.01, std::min<double>(1.0, fTemp81));
			iRec123[0] = (iVec0[1] + iRec123[1]) % 352800;
			double fTemp117 = double(iRec123[0]);
			double fTemp118 = std::max<double>(1.0, ((fTemp117 > fTemp116) ? fTemp116 : 1.0));
			double fTemp119 = 0.5 * fTemp118;
			fRec124[0] = std::fmod(0.0038314176245210726 * (2e+02 - fTemp108) + fRec124[1], fTemp118);
			ftbl1[std::max<int>(0, std::min<int>(iRec123[0], 352799))] = fRec8[1];
			int iTemp120 = int(fRec124[0]);
			double fTemp121 = std::floor(fRec124[0]);
			double fTemp122 = fRec124[0] + (-1.0 - fTemp121);
			double fTemp123 = fRec124[0] - fTemp121;
			double fTemp124 = fRec124[0] + (-2.0 - fTemp121);
			double fTemp125 = ((0.0 - fTemp123) * (0.0 - 0.5 * fTemp122) * (0.0 - 0.3333333333333333 * fTemp124) * ftbl1[((iTemp120 + -1) % 352800 + 352800) % 352800] + (fRec124[0] + (1.0 - fTemp121)) * ((0.0 - fTemp122) * (0.0 - 0.5 * fTemp124) * ftbl1[(iTemp120 % 352800 + 352800) % 352800] + 0.5 * fTemp123 * (0.0 - fTemp124) * ftbl1[((iTemp120 + 1) % 352800 + 352800) % 352800] + 0.16666666666666666 * fTemp123 * fTemp122 * ftbl1[((iTemp120 + 2) % 352800 + 352800) % 352800])) * std::min<double>(1.0, 0.005 * std::fabs(std::fmod(fRec124[0] + fTemp119, fTemp118) - fTemp119));
			double fTemp126 = fTemp125 - fRec121[1];
			fRec121[0] = fRec121[1] + fConst13 * fTemp126;
			double fTemp127 = fRec121[1] + fConst12 * fTemp126;
			double fRec122 = fTemp125 - fTemp127;
			double fTemp128 = fRec122 - fRec119[1];
			fRec119[0] = fRec119[1] + fConst13 * fTemp128;
			double fTemp129 = fRec119[1] + fConst12 * fTemp128;
			double fRec120 = fRec122 - fTemp129;
			double fTemp130 = fRec120 - fRec117[1];
			fRec117[0] = fRec117[1] + fConst13 * fTemp130;
			double fTemp131 = fRec117[1] + fConst12 * fTemp130;
			double fRec118 = fRec120 - fTemp131;
			double fTemp132 = fRec118 - fRec115[1];
			fRec115[0] = fRec115[1] + fConst13 * fTemp132;
			double fTemp133 = fRec115[1] + fConst12 * fTemp132;
			double fRec116 = fRec118 - fTemp133;
			double fTemp134 = fRec116 - (fRec83[1] * fTemp114 + fRec84[1]);
			double fTemp135 = fTemp86 * fTemp134 / fTemp115;
			fRec83[0] = fRec83[1] + 2.0 * fTemp135;
			double fTemp136 = fRec83[1] + fTemp135;
			double fTemp137 = fTemp86 * fTemp136;
			fRec84[0] = fRec84[1] + 2.0 * fTemp137;
			double fTemp138 = fTemp136 / fTemp113;
			double fRec85 = fTemp138;
			fRec130[0] = fVec2[(IOTA0 - iConst33) & 1048575];
			double fTemp139 = 1e+03 * std::max<double>(0.0, std::min<double>(1.0, fRec130[1]));
			fVbargraph15 = FAUSTFLOAT(fTemp139);
			double fTemp140 = fTemp139;
			double fTemp141 = 0.05 * fTemp140;
			double fTemp142 = fTemp141 - fRec128[1];
			fRec128[0] = fRec128[1] + fConst27 * fTemp142;
			double fTemp143 = fRec128[1] + fConst26 * fTemp142;
			double fRec129 = fTemp143;
			double fTemp144 = std::max<double>(2e+01, std::min<double>(2.048e+04, fRec129));
			double fTemp145 = std::tan(fConst24 * fTemp144);
			double fTemp146 = 0.4 * fTemp108;
			double fTemp147 = fTemp146 - fRec131[1];
			fRec131[0] = fRec131[1] + fConst27 * fTemp147;
			double fTemp148 = fRec131[1] + fConst26 * fTemp147;
			double fRec132 = fTemp148;
			double fTemp149 = std::max<double>(0.01, std::min<double>(1e+02, std::max<double>(1.0, std::min<double>(2.048e+04, fRec132)) / fTemp144));
			double fTemp150 = 1.0 / fTemp149 + fTemp145;
			double fTemp151 = fTemp145 * fTemp150 + 1.0;
			double fTemp152 = fRec116 - (fRec125[1] * fTemp150 + fRec126[1]);
			double fTemp153 = fTemp145 * fTemp152 / fTemp151;
			fRec125[0] = fRec125[1] + 2.0 * fTemp153;
			double fTemp154 = fRec125[1] + fTemp153;
			double fTemp155 = fTemp145 * fTemp154;
			fRec126[0] = fRec126[1] + 2.0 * fTemp155;
			double fTemp156 = fTemp154 / fTemp149;
			double fRec127 = fTemp156;
			double fTemp157 = 0.001 * fTemp140;
			double fTemp158 = 1.0 - fTemp157;
			double fTemp159 = 3.528e+05 * std::max<double>(0.01, std::min<double>(1.0, fTemp158));
			double fTemp160 = std::max<double>(1.0, ((fTemp117 > fTemp159) ? fTemp159 : 1.0));
			double fTemp161 = 0.5 * fTemp160;
			fRec142[0] = std::fmod(0.0038314176245210726 * (fTemp108 + 1e+02) + fRec142[1], fTemp160);
			int iTemp162 = int(fRec142[0]);
			double fTemp163 = std::floor(fRec142[0]);
			double fTemp164 = fRec142[0] + (-1.0 - fTemp163);
			double fTemp165 = fRec142[0] - fTemp163;
			double fTemp166 = fRec142[0] + (-2.0 - fTemp163);
			double fTemp167 = ((0.0 - fTemp165) * (0.0 - 0.5 * fTemp164) * (0.0 - 0.3333333333333333 * fTemp166) * ftbl1[((iTemp162 + -1) % 352800 + 352800) % 352800] + (fRec142[0] + (1.0 - fTemp163)) * ((0.0 - fTemp164) * (0.0 - 0.5 * fTemp166) * ftbl1[(iTemp162 % 352800 + 352800) % 352800] + 0.5 * fTemp165 * (0.0 - fTemp166) * ftbl1[((iTemp162 + 1) % 352800 + 352800) % 352800] + 0.16666666666666666 * fTemp165 * fTemp164 * ftbl1[((iTemp162 + 2) % 352800 + 352800) % 352800])) * std::min<double>(1.0, 0.005 * std::fabs(std::fmod(fRec142[0] + fTemp161, fTemp160) - fTemp161));
			double fTemp168 = fTemp167 - fRec140[1];
			fRec140[0] = fRec140[1] + fConst13 * fTemp168;
			double fTemp169 = fRec140[1] + fConst12 * fTemp168;
			double fRec141 = fTemp167 - fTemp169;
			double fTemp170 = fRec141 - fRec138[1];
			fRec138[0] = fRec138[1] + fConst13 * fTemp170;
			double fTemp171 = fRec138[1] + fConst12 * fTemp170;
			double fRec139 = fRec141 - fTemp171;
			double fTemp172 = fRec139 - fRec136[1];
			fRec136[0] = fRec136[1] + fConst13 * fTemp172;
			double fTemp173 = fRec136[1] + fConst12 * fTemp172;
			double fRec137 = fRec139 - fTemp173;
			double fTemp174 = fRec137 - fRec134[1];
			fRec134[0] = fRec134[1] + fConst13 * fTemp174;
			double fTemp175 = fRec134[1] + fConst12 * fTemp174;
			fRec135[IOTA0 & 1048575] = fRec137 - fTemp175;
			fRec133[0] = fRec135[(IOTA0 - iConst23) & 1048575];
			double fTemp176 = 3.528e+05 * std::max<double>(0.01, std::min<double>(1.0, 0.0005 * (fTemp79 + fTemp21)));
			double fTemp177 = std::max<double>(1.0, ((fTemp117 > fTemp176) ? fTemp176 : 1.0));
			double fTemp178 = 0.5 * fTemp177;
			fRec152[0] = std::fmod(0.0038314176245210726 * (2.9e+02 - 0.09 * fTemp108) + fRec152[1], fTemp177);
			int iTemp179 = int(fRec152[0]);
			double fTemp180 = std::floor(fRec152[0]);
			double fTemp181 = fRec152[0] + (-1.0 - fTemp180);
			double fTemp182 = fRec152[0] - fTemp180;
			double fTemp183 = fRec152[0] + (-2.0 - fTemp180);
			double fTemp184 = ((0.0 - fTemp182) * (0.0 - 0.5 * fTemp181) * (0.0 - 0.3333333333333333 * fTemp183) * ftbl1[((iTemp179 + -1) % 352800 + 352800) % 352800] + (fRec152[0] + (1.0 - fTemp180)) * ((0.0 - fTemp181) * (0.0 - 0.5 * fTemp183) * ftbl1[(iTemp179 % 352800 + 352800) % 352800] + 0.5 * fTemp182 * (0.0 - fTemp183) * ftbl1[((iTemp179 + 1) % 352800 + 352800) % 352800] + 0.16666666666666666 * fTemp182 * fTemp181 * ftbl1[((iTemp179 + 2) % 352800 + 352800) % 352800])) * std::min<double>(1.0, 0.005 * std::fabs(std::fmod(fRec152[0] + fTemp178, fTemp177) - fTemp178));
			double fTemp185 = fTemp184 - fRec150[1];
			fRec150[0] = fRec150[1] + fConst13 * fTemp185;
			double fTemp186 = fRec150[1] + fConst12 * fTemp185;
			double fRec151 = fTemp184 - fTemp186;
			double fTemp187 = fRec151 - fRec148[1];
			fRec148[0] = fRec148[1] + fConst13 * fTemp187;
			double fTemp188 = fRec148[1] + fConst12 * fTemp187;
			double fRec149 = fRec151 - fTemp188;
			double fTemp189 = fRec149 - fRec146[1];
			fRec146[0] = fRec146[1] + fConst13 * fTemp189;
			double fTemp190 = fRec146[1] + fConst12 * fTemp189;
			double fRec147 = fRec149 - fTemp190;
			double fTemp191 = fRec147 - fRec144[1];
			fRec144[0] = fRec144[1] + fConst13 * fTemp191;
			double fTemp192 = fRec144[1] + fConst12 * fTemp191;
			fRec145[IOTA0 & 2097151] = fRec147 - fTemp192;
			fRec143[0] = fRec145[(IOTA0 - iConst35) & 2097151];
			double fTemp193 = 1e-06 * fTemp21 * (fRec143[1] + fRec133[1] + fRec127 + fRec85) * fTemp77;
			double fTemp194 = 1e+03 * double(input5[i0]);
			fVbargraph16 = FAUSTFLOAT(fTemp194);
			double fTemp195 = 1e+03 * double(input1[i0]);
			fVbargraph17 = FAUSTFLOAT(fTemp195);
			double fTemp196 = fTemp195 + fTemp194;
			double fTemp197 = 0.001 * fTemp27 * fTemp196;
			double fTemp198 = fTemp197 - fRec167[1];
			fRec167[0] = fRec167[1] + fConst13 * fTemp198;
			double fTemp199 = fRec167[1] + fConst12 * fTemp198;
			double fRec168 = fTemp197 - fTemp199;
			double fTemp200 = fRec168 - fRec165[1];
			fRec165[0] = fRec165[1] + fConst16 * fTemp200;
			double fTemp201 = fRec165[1] + fConst15 * fTemp200;
			double fRec166 = fTemp201;
			fRec164[0] = fConst17 * fRec164[1] + fConst18 * std::fabs(fRec166);
			fVec12[IOTA0 & 2047] = fRec164[0] + 0.995 * fRec163[1];
			fRec163[0] = fVec12[(IOTA0 - iConst7) & 2047];
			double fTemp202 = fRec163[1] - fRec161[1];
			fRec161[0] = fRec161[1] + fConst21 * fTemp202;
			double fTemp203 = fRec161[1] + fConst20 * fTemp202;
			double fRec162 = fTemp203;
			double fTemp204 = fRec162 - fRec159[1];
			fRec159[0] = fRec159[1] + fConst21 * fTemp204;
			double fTemp205 = fRec159[1] + fConst20 * fTemp204;
			double fRec160 = fTemp205;
			double fTemp206 = fRec160 - fRec157[1];
			fRec157[0] = fRec157[1] + fConst21 * fTemp206;
			double fTemp207 = fRec157[1] + fConst20 * fTemp206;
			double fRec158 = fTemp207;
			double fTemp208 = fRec158 - fRec155[1];
			fRec155[0] = fRec155[1] + fConst21 * fTemp208;
			double fTemp209 = fRec155[1] + fConst20 * fTemp208;
			double fRec156 = fTemp209;
			double fTemp210 = fRec156 - fRec153[1];
			fRec153[0] = fRec153[1] + fConst21 * fTemp210;
			double fTemp211 = fRec153[1] + fConst20 * fTemp210;
			double fRec154 = fTemp211;
			double fTemp212 = 1e+03 * std::max<double>(0.0, std::min<double>(1.0, fRec154));
			fVbargraph18 = FAUSTFLOAT(fTemp212);
			double fTemp213 = 0.001 * fTemp212;
			double fTemp214 = 0.001 * fTemp45 * fTemp196;
			double fTemp215 = fTemp214 - fRec171[1];
			fRec171[0] = fRec171[1] + fConst13 * fTemp215;
			double fTemp216 = fRec171[1] + fConst12 * fTemp215;
			double fRec172 = fTemp214 - fTemp216;
			double fTemp217 = fRec172 - fRec169[1];
			fRec169[0] = fRec169[1] + fConst16 * fTemp217;
			double fTemp218 = fRec169[1] + fConst15 * fTemp217;
			double fRec170 = fTemp218;
			double fTemp219 = fRec170 * (1.0 - fTemp213);
			fRec8[0] = 0.001 * (fTemp219 + fTemp193 + fTemp51) * fTemp23;
			double fRec9 = fTemp193;
			double fTemp220 = std::max<double>(1.0, ((fTemp117 > 3.528e+05) ? 3.528e+05 : 1.0));
			double fTemp221 = 0.5 * fTemp220;
			fRec173[0] = std::fmod(0.0038314176245210726 * (0.02 * fTemp108 + 2.5e+02) + fRec173[1], fTemp220);
			int iTemp222 = int(fRec173[0]);
			double fTemp223 = std::floor(fRec173[0]);
			double fTemp224 = fRec173[0] + (-1.0 - fTemp223);
			double fTemp225 = fRec173[0] - fTemp223;
			double fTemp226 = fRec173[0] + (-2.0 - fTemp223);
			double fRec10 = ((0.0 - fTemp225) * (0.0 - 0.5 * fTemp224) * (0.0 - 0.3333333333333333 * fTemp226) * ftbl1[((iTemp222 + -1) % 352800 + 352800) % 352800] + (fRec173[0] + (1.0 - fTemp223)) * ((0.0 - fTemp224) * (0.0 - 0.5 * fTemp226) * ftbl1[(iTemp222 % 352800 + 352800) % 352800] + 0.5 * fTemp225 * (0.0 - fTemp226) * ftbl1[((iTemp222 + 1) % 352800 + 352800) % 352800] + 0.16666666666666666 * fTemp225 * fTemp224 * ftbl1[((iTemp222 + 2) % 352800 + 352800) % 352800])) * std::min<double>(1.0, 0.005 * std::fabs(std::fmod(fRec173[0] + fTemp221, fTemp220) - fTemp221));
			double fTemp227 = 0.001 * fTemp21;
			double fTemp228 = 3.528e+05 * std::max<double>(0.01, std::min<double>(1.0, fTemp227));
			double fTemp229 = std::max<double>(1.0, ((fTemp117 > fTemp228) ? fTemp228 : 1.0));
			double fTemp230 = 0.5 * fTemp229;
			fRec174[0] = std::fmod(fRec174[1] + 0.766283, fTemp229);
			int iTemp231 = int(fRec174[0]);
			double fTemp232 = std::floor(fRec174[0]);
			double fTemp233 = fRec174[0] + (-1.0 - fTemp232);
			double fTemp234 = fRec174[0] - fTemp232;
			double fTemp235 = fRec174[0] + (-2.0 - fTemp232);
			double fRec11 = ((0.0 - fTemp234) * (0.0 - 0.5 * fTemp233) * (0.0 - 0.3333333333333333 * fTemp235) * ftbl1[((iTemp231 + -1) % 352800 + 352800) % 352800] + (fRec174[0] + (1.0 - fTemp232)) * ((0.0 - fTemp233) * (0.0 - 0.5 * fTemp235) * ftbl1[(iTemp231 % 352800 + 352800) % 352800] + 0.5 * fTemp234 * (0.0 - fTemp235) * ftbl1[((iTemp231 + 1) % 352800 + 352800) % 352800] + 0.16666666666666666 * fTemp234 * fTemp233 * ftbl1[((iTemp231 + 2) % 352800 + 352800) % 352800])) * std::min<double>(1.0, 0.005 * std::fabs(std::fmod(fRec174[0] + fTemp230, fTemp229) - fTemp230));
			fRec12[IOTA0 & 1048575] = fRec116;
			double fTemp236 = 1e+03 * fRec8[0];
			fVbargraph19 = FAUSTFLOAT(fTemp236);
			double fTemp237 = 0.001 * fTemp236;
			iRec175[0] = (iVec0[1] + iRec175[1]) % iConst36;
			ftbl0[std::max<int>(0, std::min<int>(iRec175[0], 1919999))] = fTemp237;
			int iTemp238 = fRec181[1] < fRec181[2];
			fRec183[0] = fVec10[(IOTA0 - iConst33) & 1048575];
			double fTemp239 = 1e+03 * std::max<double>(0.0, std::min<double>(1.0, fRec183[1]));
			fVbargraph20 = FAUSTFLOAT(fTemp239);
			double fTemp240 = 0.001 * fTemp239;
			double fTemp241 = ((iTemp238 + iTemp56) ? fConst2 * std::pow(5e+01, 2.0 * (1.0 - fTemp240) + -1.0) : fRec180[1]);
			fRec180[0] = fTemp241;
			double fTemp242 = fRec181[1] + fTemp241;
			fRec181[0] = fTemp242 - std::floor(fTemp242);
			iRec182[0] = (iTemp238 + iRec182[1] + iTemp56) % 8;
			int iTemp243 = iRec182[0] == 7;
			iVec13[0] = iTemp243;
			int iTemp244 = ((fRec177[1] == 0.0) | (fRec177[1] == 1.0)) & (iTemp243 > iVec13[1]);
			double fTemp245 = 0.047619047619047616 * fTemp81;
			iRec184[0] = 1103515245 * iRec184[1] + 12345;
			double fTemp246 = double(iRec184[0]);
			double fTemp247 = fTemp245 + 4.656612875245797e-11 * fTemp246 * (fTemp245 + 0.023) + 0.023;
			double fTemp248 = fConst2 / std::max<double>(fConst2, fTemp247);
			double fTemp249 = ((iTemp244) ? fTemp248 : fRec178[1]);
			fRec177[0] = ((iTemp244) ? fTemp249 : std::min<double>(1.0, fRec177[1] + fTemp249));
			fRec178[0] = fTemp249;
			int iRec179 = iTemp244;
			fRec185[0] = fConst37 + (fRec185[1] - std::floor(fConst37 + fRec185[1]));
			double fTemp250 = std::fabs(2.0 * (fRec185[0] + (-0.5 - std::floor(fRec185[0] + -0.5))) + -1.0);
			double fTemp251 = 5e+02 * (fTemp250 + -2.0);
			fVbargraph21 = FAUSTFLOAT(fTemp251);
			double fTemp252 = fTemp251;
			double fTemp253 = 0.001 * fTemp252 * (1.0 - 0.01 * fTemp81) + 4.656612875245797e-12 * fTemp246 * fTemp81;
			fRec176[0] = ((iRec179) ? fTemp253 : fRec176[1]);
			fRec186[0] = ((iRec179) ? fTemp247 : fRec186[1]);
			double fTemp254 = std::fmod(fConst34 + std::fmod(fConst0 * (fRec177[0] * fRec186[0] + 8.0 * fRec176[0]), fConst34), fConst34);
			int iTemp255 = int(fTemp254);
			double fTemp256 = std::floor(fTemp254);
			double fTemp257 = fTemp254 + (-1.0 - fTemp256);
			double fTemp258 = fTemp254 - fTemp256;
			double fTemp259 = fTemp254 + (-2.0 - fTemp256);
			int iTemp260 = iRec182[0] == 6;
			iVec14[0] = iTemp260;
			int iTemp261 = ((fRec188[1] == 0.0) | (fRec188[1] == 1.0)) & (iTemp260 > iVec14[1]);
			double fTemp262 = ((iTemp261) ? fTemp248 : fRec189[1]);
			fRec188[0] = ((iTemp261) ? fTemp262 : std::min<double>(1.0, fRec188[1] + fTemp262));
			fRec189[0] = fTemp262;
			int iRec190 = iTemp261;
			fRec187[0] = ((iRec190) ? fTemp253 : fRec187[1]);
			fRec191[0] = ((iRec190) ? fTemp247 : fRec191[1]);
			double fTemp263 = std::fmod(fConst34 + std::fmod(fConst0 * (fRec188[0] * fRec191[0] + 8.0 * fRec187[0]), fConst34), fConst34);
			int iTemp264 = int(fTemp263);
			double fTemp265 = std::floor(fTemp263);
			double fTemp266 = fTemp263 + (-1.0 - fTemp265);
			double fTemp267 = fTemp263 - fTemp265;
			double fTemp268 = fTemp263 + (-2.0 - fTemp265);
			int iTemp269 = iRec182[0] == 5;
			iVec15[0] = iTemp269;
			int iTemp270 = ((fRec193[1] == 0.0) | (fRec193[1] == 1.0)) & (iTemp269 > iVec15[1]);
			double fTemp271 = ((iTemp270) ? fTemp248 : fRec194[1]);
			fRec193[0] = ((iTemp270) ? fTemp271 : std::min<double>(1.0, fRec193[1] + fTemp271));
			fRec194[0] = fTemp271;
			int iRec195 = iTemp270;
			fRec192[0] = ((iRec195) ? fTemp253 : fRec192[1]);
			fRec196[0] = ((iRec195) ? fTemp247 : fRec196[1]);
			double fTemp272 = std::fmod(fConst34 + std::fmod(fConst0 * (fRec193[0] * fRec196[0] + 8.0 * fRec192[0]), fConst34), fConst34);
			int iTemp273 = int(fTemp272);
			double fTemp274 = std::floor(fTemp272);
			double fTemp275 = fTemp272 + (-1.0 - fTemp274);
			double fTemp276 = fTemp272 - fTemp274;
			double fTemp277 = fTemp272 + (-2.0 - fTemp274);
			int iTemp278 = iRec182[0] == 4;
			iVec16[0] = iTemp278;
			int iTemp279 = ((fRec198[1] == 0.0) | (fRec198[1] == 1.0)) & (iTemp278 > iVec16[1]);
			double fTemp280 = ((iTemp279) ? fTemp248 : fRec199[1]);
			fRec198[0] = ((iTemp279) ? fTemp280 : std::min<double>(1.0, fRec198[1] + fTemp280));
			fRec199[0] = fTemp280;
			int iRec200 = iTemp279;
			fRec197[0] = ((iRec200) ? fTemp253 : fRec197[1]);
			fRec201[0] = ((iRec200) ? fTemp247 : fRec201[1]);
			double fTemp281 = std::fmod(fConst34 + std::fmod(fConst0 * (fRec198[0] * fRec201[0] + 8.0 * fRec197[0]), fConst34), fConst34);
			int iTemp282 = int(fTemp281);
			double fTemp283 = std::floor(fTemp281);
			double fTemp284 = fTemp281 + (-1.0 - fTemp283);
			double fTemp285 = fTemp281 - fTemp283;
			double fTemp286 = fTemp281 + (-2.0 - fTemp283);
			int iTemp287 = iRec182[0] == 3;
			iVec17[0] = iTemp287;
			int iTemp288 = ((fRec203[1] == 0.0) | (fRec203[1] == 1.0)) & (iTemp287 > iVec17[1]);
			double fTemp289 = ((iTemp288) ? fTemp248 : fRec204[1]);
			fRec203[0] = ((iTemp288) ? fTemp289 : std::min<double>(1.0, fRec203[1] + fTemp289));
			fRec204[0] = fTemp289;
			int iRec205 = iTemp288;
			fRec202[0] = ((iRec205) ? fTemp253 : fRec202[1]);
			fRec206[0] = ((iRec205) ? fTemp247 : fRec206[1]);
			double fTemp290 = std::fmod(fConst34 + std::fmod(fConst0 * (fRec203[0] * fRec206[0] + 8.0 * fRec202[0]), fConst34), fConst34);
			int iTemp291 = int(fTemp290);
			double fTemp292 = std::floor(fTemp290);
			double fTemp293 = fTemp290 + (-1.0 - fTemp292);
			double fTemp294 = fTemp290 - fTemp292;
			double fTemp295 = fTemp290 + (-2.0 - fTemp292);
			int iTemp296 = iRec182[0] == 2;
			iVec18[0] = iTemp296;
			int iTemp297 = ((fRec208[1] == 0.0) | (fRec208[1] == 1.0)) & (iTemp296 > iVec18[1]);
			double fTemp298 = ((iTemp297) ? fTemp248 : fRec209[1]);
			fRec208[0] = ((iTemp297) ? fTemp298 : std::min<double>(1.0, fRec208[1] + fTemp298));
			fRec209[0] = fTemp298;
			int iRec210 = iTemp297;
			fRec207[0] = ((iRec210) ? fTemp253 : fRec207[1]);
			fRec211[0] = ((iRec210) ? fTemp247 : fRec211[1]);
			double fTemp299 = std::fmod(fConst34 + std::fmod(fConst0 * (fRec208[0] * fRec211[0] + 8.0 * fRec207[0]), fConst34), fConst34);
			int iTemp300 = int(fTemp299);
			double fTemp301 = std::floor(fTemp299);
			double fTemp302 = fTemp299 + (-1.0 - fTemp301);
			double fTemp303 = fTemp299 - fTemp301;
			double fTemp304 = fTemp299 + (-2.0 - fTemp301);
			int iTemp305 = iRec182[0] == 1;
			iVec19[0] = iTemp305;
			int iTemp306 = ((fRec213[1] == 0.0) | (fRec213[1] == 1.0)) & (iTemp305 > iVec19[1]);
			double fTemp307 = ((iTemp306) ? fTemp248 : fRec214[1]);
			fRec213[0] = ((iTemp306) ? fTemp307 : std::min<double>(1.0, fRec213[1] + fTemp307));
			fRec214[0] = fTemp307;
			int iRec215 = iTemp306;
			fRec212[0] = ((iRec215) ? fTemp253 : fRec212[1]);
			fRec216[0] = ((iRec215) ? fTemp247 : fRec216[1]);
			double fTemp308 = std::fmod(fConst34 + std::fmod(fConst0 * (fRec213[0] * fRec216[0] + 8.0 * fRec212[0]), fConst34), fConst34);
			int iTemp309 = int(fTemp308);
			double fTemp310 = std::floor(fTemp308);
			double fTemp311 = fTemp308 + (-1.0 - fTemp310);
			double fTemp312 = fTemp308 - fTemp310;
			double fTemp313 = fTemp308 + (-2.0 - fTemp310);
			int iTemp314 = iRec182[0] == 0;
			iVec20[0] = iTemp314;
			int iTemp315 = ((fRec218[1] == 0.0) | (fRec218[1] == 1.0)) & (iTemp314 > iVec20[1]);
			double fTemp316 = ((iTemp315) ? fTemp248 : fRec219[1]);
			fRec218[0] = ((iTemp315) ? fTemp316 : std::min<double>(1.0, fRec218[1] + fTemp316));
			fRec219[0] = fTemp316;
			int iRec220 = iTemp315;
			fRec217[0] = ((iRec220) ? fTemp253 : fRec217[1]);
			fRec221[0] = ((iRec220) ? fTemp247 : fRec221[1]);
			double fTemp317 = std::fmod(fConst34 + std::fmod(fConst0 * (fRec218[0] * fRec221[0] + 8.0 * fRec217[0]), fConst34), fConst34);
			int iTemp318 = int(fTemp317);
			double fTemp319 = std::floor(fTemp317);
			double fTemp320 = fTemp317 + (-1.0 - fTemp319);
			double fTemp321 = fTemp317 - fTemp319;
			double fTemp322 = fTemp317 + (-2.0 - fTemp319);
			double fTemp323 = mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec218[0])) * ((0.0 - fTemp321) * (0.0 - 0.5 * fTemp320) * (0.0 - 0.3333333333333333 * fTemp322) * ftbl0[((iTemp318 + -1) % 1920000 + 1920000) % 1920000] + (fTemp317 + (1.0 - fTemp319)) * ((0.0 - fTemp320) * (0.0 - 0.5 * fTemp322) * ftbl0[(iTemp318 % 1920000 + 1920000) % 1920000] + 0.5 * fTemp321 * (0.0 - fTemp322) * ftbl0[((iTemp318 + 1) % 1920000 + 1920000) % 1920000] + 0.16666666666666666 * fTemp321 * fTemp320 * ftbl0[((iTemp318 + 2) % 1920000 + 1920000) % 1920000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec213[0])) * ((0.0 - fTemp312) * (0.0 - 0.5 * fTemp311) * (0.0 - 0.3333333333333333 * fTemp313) * ftbl0[((iTemp309 + -1) % 1920000 + 1920000) % 1920000] + (fTemp308 + (1.0 - fTemp310)) * ((0.0 - fTemp311) * (0.0 - 0.5 * fTemp313) * ftbl0[(iTemp309 % 1920000 + 1920000) % 1920000] + 0.5 * fTemp312 * (0.0 - fTemp313) * ftbl0[((iTemp309 + 1) % 1920000 + 1920000) % 1920000] + 0.16666666666666666 * fTemp312 * fTemp311 * ftbl0[((iTemp309 + 2) % 1920000 + 1920000) % 1920000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec208[0])) * ((0.0 - fTemp303) * (0.0 - 0.5 * fTemp302) * (0.0 - 0.3333333333333333 * fTemp304) * ftbl0[((iTemp300 + -1) % 1920000 + 1920000) % 1920000] + (fTemp299 + (1.0 - fTemp301)) * ((0.0 - fTemp302) * (0.0 - 0.5 * fTemp304) * ftbl0[(iTemp300 % 1920000 + 1920000) % 1920000] + 0.5 * fTemp303 * (0.0 - fTemp304) * ftbl0[((iTemp300 + 1) % 1920000 + 1920000) % 1920000] + 0.16666666666666666 * fTemp303 * fTemp302 * ftbl0[((iTemp300 + 2) % 1920000 + 1920000) % 1920000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec203[0])) * ((0.0 - fTemp294) * (0.0 - 0.5 * fTemp293) * (0.0 - 0.3333333333333333 * fTemp295) * ftbl0[((iTemp291 + -1) % 1920000 + 1920000) % 1920000] + (fTemp290 + (1.0 - fTemp292)) * ((0.0 - fTemp293) * (0.0 - 0.5 * fTemp295) * ftbl0[(iTemp291 % 1920000 + 1920000) % 1920000] + 0.5 * fTemp294 * (0.0 - fTemp295) * ftbl0[((iTemp291 + 1) % 1920000 + 1920000) % 1920000] + 0.16666666666666666 * fTemp294 * fTemp293 * ftbl0[((iTemp291 + 2) % 1920000 + 1920000) % 1920000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec198[0])) * ((0.0 - fTemp285) * (0.0 - 0.5 * fTemp284) * (0.0 - 0.3333333333333333 * fTemp286) * ftbl0[((iTemp282 + -1) % 1920000 + 1920000) % 1920000] + (fTemp281 + (1.0 - fTemp283)) * ((0.0 - fTemp284) * (0.0 - 0.5 * fTemp286) * ftbl0[(iTemp282 % 1920000 + 1920000) % 1920000] + 0.5 * fTemp285 * (0.0 - fTemp286) * ftbl0[((iTemp282 + 1) % 1920000 + 1920000) % 1920000] + 0.16666666666666666 * fTemp285 * fTemp284 * ftbl0[((iTemp282 + 2) % 1920000 + 1920000) % 1920000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec193[0])) * ((0.0 - fTemp276) * (0.0 - 0.5 * fTemp275) * (0.0 - 0.3333333333333333 * fTemp277) * ftbl0[((iTemp273 + -1) % 1920000 + 1920000) % 1920000] + (fTemp272 + (1.0 - fTemp274)) * ((0.0 - fTemp275) * (0.0 - 0.5 * fTemp277) * ftbl0[(iTemp273 % 1920000 + 1920000) % 1920000] + 0.5 * fTemp276 * (0.0 - fTemp277) * ftbl0[((iTemp273 + 1) % 1920000 + 1920000) % 1920000] + 0.16666666666666666 * fTemp276 * fTemp275 * ftbl0[((iTemp273 + 2) % 1920000 + 1920000) % 1920000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec188[0])) * ((0.0 - fTemp267) * (0.0 - 0.5 * fTemp266) * (0.0 - 0.3333333333333333 * fTemp268) * ftbl0[((iTemp264 + -1) % 1920000 + 1920000) % 1920000] + (fTemp263 + (1.0 - fTemp265)) * ((0.0 - fTemp266) * (0.0 - 0.5 * fTemp268) * ftbl0[(iTemp264 % 1920000 + 1920000) % 1920000] + 0.5 * fTemp267 * (0.0 - fTemp268) * ftbl0[((iTemp264 + 1) % 1920000 + 1920000) % 1920000] + 0.16666666666666666 * fTemp267 * fTemp266 * ftbl0[((iTemp264 + 2) % 1920000 + 1920000) % 1920000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec177[0])) * ((0.0 - fTemp258) * (0.0 - 0.5 * fTemp257) * (0.0 - 0.3333333333333333 * fTemp259) * ftbl0[((iTemp255 + -1) % 1920000 + 1920000) % 1920000] + (fTemp254 + (1.0 - fTemp256)) * ((0.0 - fTemp257) * (0.0 - 0.5 * fTemp259) * ftbl0[(iTemp255 % 1920000 + 1920000) % 1920000] + 0.5 * fTemp258 * (0.0 - fTemp259) * ftbl0[((iTemp255 + 1) % 1920000 + 1920000) % 1920000] + 0.16666666666666666 * fTemp258 * fTemp257 * ftbl0[((iTemp255 + 2) % 1920000 + 1920000) % 1920000]));
			fRec0[0] = 0.125 * fTemp323;
			int iTemp324 = fRec227[1] < fRec227[2];
			fRec229[0] = fVec10[(IOTA0 - iConst23) & 1048575];
			double fTemp325 = 1e+03 * std::max<double>(0.0, std::min<double>(1.0, fRec229[1]));
			fVbargraph22 = FAUSTFLOAT(fTemp325);
			double fTemp326 = 0.001 * fTemp325;
			double fTemp327 = ((iTemp324 + iTemp56) ? fConst2 * std::pow(5e+01, 2.0 * (1.0 - fTemp326) + -1.0) : fRec226[1]);
			fRec226[0] = fTemp327;
			double fTemp328 = fRec227[1] + fTemp327;
			fRec227[0] = fTemp328 - std::floor(fTemp328);
			iRec228[0] = (iTemp324 + iRec228[1] + iTemp56) % 8;
			int iTemp329 = iRec228[0] == 7;
			iVec21[0] = iTemp329;
			int iTemp330 = ((fRec223[1] == 0.0) | (fRec223[1] == 1.0)) & (iTemp329 > iVec21[1]);
			double fTemp331 = 0.05 * fTemp158;
			double fTemp332 = fTemp331 + 4.656612875245797e-11 * fTemp246 * (fTemp331 + 0.023) + 0.023;
			double fTemp333 = fConst2 / std::max<double>(fConst2, fTemp332);
			double fTemp334 = ((iTemp330) ? fTemp333 : fRec224[1]);
			fRec223[0] = ((iTemp330) ? fTemp334 : std::min<double>(1.0, fRec223[1] + fTemp334));
			fRec224[0] = fTemp334;
			int iRec225 = iTemp330;
			double fTemp335 = 5e+02 * (fTemp250 + 1.0);
			fVbargraph23 = FAUSTFLOAT(fTemp335);
			double fTemp336 = fTemp335;
			double fTemp337 = 0.001 * fTemp336 * (1.0 - 0.01 * fTemp158) + 4.656612875245797e-12 * fTemp246 * fTemp158;
			fRec222[0] = ((iRec225) ? fTemp337 : fRec222[1]);
			fRec230[0] = ((iRec225) ? fTemp332 : fRec230[1]);
			double fTemp338 = std::fmod(fConst34 + std::fmod(fConst0 * (fRec223[0] * fRec230[0] + 8.0 * fRec222[0]), fConst34), fConst34);
			int iTemp339 = int(fTemp338);
			double fTemp340 = std::floor(fTemp338);
			double fTemp341 = fTemp338 + (-1.0 - fTemp340);
			double fTemp342 = fTemp338 - fTemp340;
			double fTemp343 = fTemp338 + (-2.0 - fTemp340);
			int iTemp344 = iRec228[0] == 6;
			iVec22[0] = iTemp344;
			int iTemp345 = ((fRec232[1] == 0.0) | (fRec232[1] == 1.0)) & (iTemp344 > iVec22[1]);
			double fTemp346 = ((iTemp345) ? fTemp333 : fRec233[1]);
			fRec232[0] = ((iTemp345) ? fTemp346 : std::min<double>(1.0, fRec232[1] + fTemp346));
			fRec233[0] = fTemp346;
			int iRec234 = iTemp345;
			fRec231[0] = ((iRec234) ? fTemp337 : fRec231[1]);
			fRec235[0] = ((iRec234) ? fTemp332 : fRec235[1]);
			double fTemp347 = std::fmod(fConst34 + std::fmod(fConst0 * (fRec232[0] * fRec235[0] + 8.0 * fRec231[0]), fConst34), fConst34);
			int iTemp348 = int(fTemp347);
			double fTemp349 = std::floor(fTemp347);
			double fTemp350 = fTemp347 + (-1.0 - fTemp349);
			double fTemp351 = fTemp347 - fTemp349;
			double fTemp352 = fTemp347 + (-2.0 - fTemp349);
			int iTemp353 = iRec228[0] == 5;
			iVec23[0] = iTemp353;
			int iTemp354 = ((fRec237[1] == 0.0) | (fRec237[1] == 1.0)) & (iTemp353 > iVec23[1]);
			double fTemp355 = ((iTemp354) ? fTemp333 : fRec238[1]);
			fRec237[0] = ((iTemp354) ? fTemp355 : std::min<double>(1.0, fRec237[1] + fTemp355));
			fRec238[0] = fTemp355;
			int iRec239 = iTemp354;
			fRec236[0] = ((iRec239) ? fTemp337 : fRec236[1]);
			fRec240[0] = ((iRec239) ? fTemp332 : fRec240[1]);
			double fTemp356 = std::fmod(fConst34 + std::fmod(fConst0 * (fRec237[0] * fRec240[0] + 8.0 * fRec236[0]), fConst34), fConst34);
			int iTemp357 = int(fTemp356);
			double fTemp358 = std::floor(fTemp356);
			double fTemp359 = fTemp356 + (-1.0 - fTemp358);
			double fTemp360 = fTemp356 - fTemp358;
			double fTemp361 = fTemp356 + (-2.0 - fTemp358);
			int iTemp362 = iRec228[0] == 4;
			iVec24[0] = iTemp362;
			int iTemp363 = ((fRec242[1] == 0.0) | (fRec242[1] == 1.0)) & (iTemp362 > iVec24[1]);
			double fTemp364 = ((iTemp363) ? fTemp333 : fRec243[1]);
			fRec242[0] = ((iTemp363) ? fTemp364 : std::min<double>(1.0, fRec242[1] + fTemp364));
			fRec243[0] = fTemp364;
			int iRec244 = iTemp363;
			fRec241[0] = ((iRec244) ? fTemp337 : fRec241[1]);
			fRec245[0] = ((iRec244) ? fTemp332 : fRec245[1]);
			double fTemp365 = std::fmod(fConst34 + std::fmod(fConst0 * (fRec242[0] * fRec245[0] + 8.0 * fRec241[0]), fConst34), fConst34);
			int iTemp366 = int(fTemp365);
			double fTemp367 = std::floor(fTemp365);
			double fTemp368 = fTemp365 + (-1.0 - fTemp367);
			double fTemp369 = fTemp365 - fTemp367;
			double fTemp370 = fTemp365 + (-2.0 - fTemp367);
			int iTemp371 = iRec228[0] == 3;
			iVec25[0] = iTemp371;
			int iTemp372 = ((fRec247[1] == 0.0) | (fRec247[1] == 1.0)) & (iTemp371 > iVec25[1]);
			double fTemp373 = ((iTemp372) ? fTemp333 : fRec248[1]);
			fRec247[0] = ((iTemp372) ? fTemp373 : std::min<double>(1.0, fRec247[1] + fTemp373));
			fRec248[0] = fTemp373;
			int iRec249 = iTemp372;
			fRec246[0] = ((iRec249) ? fTemp337 : fRec246[1]);
			fRec250[0] = ((iRec249) ? fTemp332 : fRec250[1]);
			double fTemp374 = std::fmod(fConst34 + std::fmod(fConst0 * (fRec247[0] * fRec250[0] + 8.0 * fRec246[0]), fConst34), fConst34);
			int iTemp375 = int(fTemp374);
			double fTemp376 = std::floor(fTemp374);
			double fTemp377 = fTemp374 + (-1.0 - fTemp376);
			double fTemp378 = fTemp374 - fTemp376;
			double fTemp379 = fTemp374 + (-2.0 - fTemp376);
			int iTemp380 = iRec228[0] == 2;
			iVec26[0] = iTemp380;
			int iTemp381 = ((fRec252[1] == 0.0) | (fRec252[1] == 1.0)) & (iTemp380 > iVec26[1]);
			double fTemp382 = ((iTemp381) ? fTemp333 : fRec253[1]);
			fRec252[0] = ((iTemp381) ? fTemp382 : std::min<double>(1.0, fRec252[1] + fTemp382));
			fRec253[0] = fTemp382;
			int iRec254 = iTemp381;
			fRec251[0] = ((iRec254) ? fTemp337 : fRec251[1]);
			fRec255[0] = ((iRec254) ? fTemp332 : fRec255[1]);
			double fTemp383 = std::fmod(fConst34 + std::fmod(fConst0 * (fRec252[0] * fRec255[0] + 8.0 * fRec251[0]), fConst34), fConst34);
			int iTemp384 = int(fTemp383);
			double fTemp385 = std::floor(fTemp383);
			double fTemp386 = fTemp383 + (-1.0 - fTemp385);
			double fTemp387 = fTemp383 - fTemp385;
			double fTemp388 = fTemp383 + (-2.0 - fTemp385);
			int iTemp389 = iRec228[0] == 1;
			iVec27[0] = iTemp389;
			int iTemp390 = ((fRec257[1] == 0.0) | (fRec257[1] == 1.0)) & (iTemp389 > iVec27[1]);
			double fTemp391 = ((iTemp390) ? fTemp333 : fRec258[1]);
			fRec257[0] = ((iTemp390) ? fTemp391 : std::min<double>(1.0, fRec257[1] + fTemp391));
			fRec258[0] = fTemp391;
			int iRec259 = iTemp390;
			fRec256[0] = ((iRec259) ? fTemp337 : fRec256[1]);
			fRec260[0] = ((iRec259) ? fTemp332 : fRec260[1]);
			double fTemp392 = std::fmod(fConst34 + std::fmod(fConst0 * (fRec257[0] * fRec260[0] + 8.0 * fRec256[0]), fConst34), fConst34);
			int iTemp393 = int(fTemp392);
			double fTemp394 = std::floor(fTemp392);
			double fTemp395 = fTemp392 + (-1.0 - fTemp394);
			double fTemp396 = fTemp392 - fTemp394;
			double fTemp397 = fTemp392 + (-2.0 - fTemp394);
			int iTemp398 = iRec228[0] == 0;
			iVec28[0] = iTemp398;
			int iTemp399 = ((fRec262[1] == 0.0) | (fRec262[1] == 1.0)) & (iTemp398 > iVec28[1]);
			double fTemp400 = ((iTemp399) ? fTemp333 : fRec263[1]);
			fRec262[0] = ((iTemp399) ? fTemp400 : std::min<double>(1.0, fRec262[1] + fTemp400));
			fRec263[0] = fTemp400;
			int iRec264 = iTemp399;
			fRec261[0] = ((iRec264) ? fTemp337 : fRec261[1]);
			fRec265[0] = ((iRec264) ? fTemp332 : fRec265[1]);
			double fTemp401 = std::fmod(fConst34 + std::fmod(fConst0 * (fRec262[0] * fRec265[0] + 8.0 * fRec261[0]), fConst34), fConst34);
			int iTemp402 = int(fTemp401);
			double fTemp403 = std::floor(fTemp401);
			double fTemp404 = fTemp401 + (-1.0 - fTemp403);
			double fTemp405 = fTemp401 - fTemp403;
			double fTemp406 = fTemp401 + (-2.0 - fTemp403);
			double fTemp407 = mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec262[0])) * ((0.0 - fTemp405) * (0.0 - 0.5 * fTemp404) * (0.0 - 0.3333333333333333 * fTemp406) * ftbl0[((iTemp402 + -1) % 1920000 + 1920000) % 1920000] + (fTemp401 + (1.0 - fTemp403)) * ((0.0 - fTemp404) * (0.0 - 0.5 * fTemp406) * ftbl0[(iTemp402 % 1920000 + 1920000) % 1920000] + 0.5 * fTemp405 * (0.0 - fTemp406) * ftbl0[((iTemp402 + 1) % 1920000 + 1920000) % 1920000] + 0.16666666666666666 * fTemp405 * fTemp404 * ftbl0[((iTemp402 + 2) % 1920000 + 1920000) % 1920000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec257[0])) * ((0.0 - fTemp396) * (0.0 - 0.5 * fTemp395) * (0.0 - 0.3333333333333333 * fTemp397) * ftbl0[((iTemp393 + -1) % 1920000 + 1920000) % 1920000] + (fTemp392 + (1.0 - fTemp394)) * ((0.0 - fTemp395) * (0.0 - 0.5 * fTemp397) * ftbl0[(iTemp393 % 1920000 + 1920000) % 1920000] + 0.5 * fTemp396 * (0.0 - fTemp397) * ftbl0[((iTemp393 + 1) % 1920000 + 1920000) % 1920000] + 0.16666666666666666 * fTemp396 * fTemp395 * ftbl0[((iTemp393 + 2) % 1920000 + 1920000) % 1920000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec252[0])) * ((0.0 - fTemp387) * (0.0 - 0.5 * fTemp386) * (0.0 - 0.3333333333333333 * fTemp388) * ftbl0[((iTemp384 + -1) % 1920000 + 1920000) % 1920000] + (fTemp383 + (1.0 - fTemp385)) * ((0.0 - fTemp386) * (0.0 - 0.5 * fTemp388) * ftbl0[(iTemp384 % 1920000 + 1920000) % 1920000] + 0.5 * fTemp387 * (0.0 - fTemp388) * ftbl0[((iTemp384 + 1) % 1920000 + 1920000) % 1920000] + 0.16666666666666666 * fTemp387 * fTemp386 * ftbl0[((iTemp384 + 2) % 1920000 + 1920000) % 1920000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec247[0])) * ((0.0 - fTemp378) * (0.0 - 0.5 * fTemp377) * (0.0 - 0.3333333333333333 * fTemp379) * ftbl0[((iTemp375 + -1) % 1920000 + 1920000) % 1920000] + (fTemp374 + (1.0 - fTemp376)) * ((0.0 - fTemp377) * (0.0 - 0.5 * fTemp379) * ftbl0[(iTemp375 % 1920000 + 1920000) % 1920000] + 0.5 * fTemp378 * (0.0 - fTemp379) * ftbl0[((iTemp375 + 1) % 1920000 + 1920000) % 1920000] + 0.16666666666666666 * fTemp378 * fTemp377 * ftbl0[((iTemp375 + 2) % 1920000 + 1920000) % 1920000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec242[0])) * ((0.0 - fTemp369) * (0.0 - 0.5 * fTemp368) * (0.0 - 0.3333333333333333 * fTemp370) * ftbl0[((iTemp366 + -1) % 1920000 + 1920000) % 1920000] + (fTemp365 + (1.0 - fTemp367)) * ((0.0 - fTemp368) * (0.0 - 0.5 * fTemp370) * ftbl0[(iTemp366 % 1920000 + 1920000) % 1920000] + 0.5 * fTemp369 * (0.0 - fTemp370) * ftbl0[((iTemp366 + 1) % 1920000 + 1920000) % 1920000] + 0.16666666666666666 * fTemp369 * fTemp368 * ftbl0[((iTemp366 + 2) % 1920000 + 1920000) % 1920000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec237[0])) * ((0.0 - fTemp360) * (0.0 - 0.5 * fTemp359) * (0.0 - 0.3333333333333333 * fTemp361) * ftbl0[((iTemp357 + -1) % 1920000 + 1920000) % 1920000] + (fTemp356 + (1.0 - fTemp358)) * ((0.0 - fTemp359) * (0.0 - 0.5 * fTemp361) * ftbl0[(iTemp357 % 1920000 + 1920000) % 1920000] + 0.5 * fTemp360 * (0.0 - fTemp361) * ftbl0[((iTemp357 + 1) % 1920000 + 1920000) % 1920000] + 0.16666666666666666 * fTemp360 * fTemp359 * ftbl0[((iTemp357 + 2) % 1920000 + 1920000) % 1920000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec232[0])) * ((0.0 - fTemp351) * (0.0 - 0.5 * fTemp350) * (0.0 - 0.3333333333333333 * fTemp352) * ftbl0[((iTemp348 + -1) % 1920000 + 1920000) % 1920000] + (fTemp347 + (1.0 - fTemp349)) * ((0.0 - fTemp350) * (0.0 - 0.5 * fTemp352) * ftbl0[(iTemp348 % 1920000 + 1920000) % 1920000] + 0.5 * fTemp351 * (0.0 - fTemp352) * ftbl0[((iTemp348 + 1) % 1920000 + 1920000) % 1920000] + 0.16666666666666666 * fTemp351 * fTemp350 * ftbl0[((iTemp348 + 2) % 1920000 + 1920000) % 1920000])) + mydsp_faustpower2_f(std::sin(3.141592653589793 * fRec223[0])) * ((0.0 - fTemp342) * (0.0 - 0.5 * fTemp341) * (0.0 - 0.3333333333333333 * fTemp343) * ftbl0[((iTemp339 + -1) % 1920000 + 1920000) % 1920000] + (fTemp338 + (1.0 - fTemp340)) * ((0.0 - fTemp341) * (0.0 - 0.5 * fTemp343) * ftbl0[(iTemp339 % 1920000 + 1920000) % 1920000] + 0.5 * fTemp342 * (0.0 - fTemp343) * ftbl0[((iTemp339 + 1) % 1920000 + 1920000) % 1920000] + 0.16666666666666666 * fTemp342 * fTemp341 * ftbl0[((iTemp339 + 2) % 1920000 + 1920000) % 1920000]));
			fRec1[0] = 0.125 * fTemp407;
			double fTemp408 = 1.0 - fTemp227;
			double fTemp409 = 1e+03 * fTemp75;
			fVbargraph24 = FAUSTFLOAT(fTemp409);
			double fTemp410 = fTemp409;
			double fTemp411 = 0.001 * fTemp410;
			double fTemp412 = fRec266[1] + fConst38 * (1.0 - fTemp411);
			fRec266[0] = fTemp412 - std::floor(fTemp412);
			double fTemp413 = 1e+03 * std::fabs(2.0 * (fRec266[0] + (-0.5 - std::floor(fRec266[0] + -0.5))) + -1.0);
			fVbargraph25 = FAUSTFLOAT(fTemp413);
			double fTemp414 = fTemp413;
			double fTemp415 = 0.001 * fTemp414;
			fRec279[0] = fConst17 * fRec279[1] + fConst18 * std::fabs(fRec0[1] + fRec1[1]);
			fVec29[IOTA0 & 2047] = fRec279[0] + 0.97 * fRec278[1];
			fRec278[0] = fVec29[(IOTA0 - iConst7) & 2047];
			double fTemp416 = fRec278[1] - fRec276[1];
			fRec276[0] = fRec276[1] + fConst21 * fTemp416;
			double fTemp417 = fRec276[1] + fConst20 * fTemp416;
			double fRec277 = fTemp417;
			double fTemp418 = fRec277 - fRec274[1];
			fRec274[0] = fRec274[1] + fConst21 * fTemp418;
			double fTemp419 = fRec274[1] + fConst20 * fTemp418;
			double fRec275 = fTemp419;
			double fTemp420 = fRec275 - fRec272[1];
			fRec272[0] = fRec272[1] + fConst21 * fTemp420;
			double fTemp421 = fRec272[1] + fConst20 * fTemp420;
			double fRec273 = fTemp421;
			double fTemp422 = fRec273 - fRec270[1];
			fRec270[0] = fRec270[1] + fConst21 * fTemp422;
			double fTemp423 = fRec270[1] + fConst20 * fTemp422;
			double fRec271 = fTemp423;
			double fTemp424 = fRec271 - fRec268[1];
			fRec268[0] = fRec268[1] + fConst21 * fTemp424;
			double fTemp425 = fRec268[1] + fConst20 * fTemp424;
			double fRec269 = fTemp425;
			fVec30[IOTA0 & 4194303] = fRec269 + 0.4 * fRec267[1];
			fRec267[0] = fVec30[(IOTA0 - iConst39) & 4194303];
			double fTemp426 = 1e+03 * std::max<double>(0.0, std::min<double>(1.0, 1.0 - 0.5 * (fRec269 + fRec267[1])));
			fVbargraph26 = FAUSTFLOAT(fTemp426);
			double fTemp427 = fTemp426;
			double fTemp428 = fRec9 * fTemp21;
			fVec31[IOTA0 & 16383] = fTemp428;
			double fTemp429 = 0.001 * fTemp428 * fTemp427 * (1.0 - fTemp415);
			fVbargraph27 = FAUSTFLOAT(fTemp429);
			double fTemp430 = fTemp429;
			double fTemp431 = fTemp51 * fTemp427;
			fVbargraph28 = FAUSTFLOAT(fTemp431);
			double fTemp432 = fTemp431;
			double fTemp433 = fRec11 - fRec288[1];
			fRec288[0] = fRec288[1] + fConst13 * fTemp433;
			double fTemp434 = fRec288[1] + fConst12 * fTemp433;
			double fRec289 = fRec11 - fTemp434;
			double fTemp435 = fRec289 - fRec286[1];
			fRec286[0] = fRec286[1] + fConst13 * fTemp435;
			double fTemp436 = fRec286[1] + fConst12 * fTemp435;
			double fRec287 = fRec289 - fTemp436;
			double fTemp437 = fRec287 - fRec284[1];
			fRec284[0] = fRec284[1] + fConst13 * fTemp437;
			double fTemp438 = fRec284[1] + fConst12 * fTemp437;
			double fRec285 = fRec287 - fTemp438;
			double fTemp439 = fRec285 - fRec282[1];
			fRec282[0] = fRec282[1] + fConst13 * fTemp439;
			double fTemp440 = fRec282[1] + fConst12 * fTemp439;
			fRec283[IOTA0 & 1048575] = fRec285 - fTemp440;
			fRec281[0] = fRec283[(IOTA0 - iConst40) & 1048575];
			double fTemp441 = 1e+03 * fRec281[1];
			fVbargraph29 = FAUSTFLOAT(fTemp441);
			double fTemp442 = fTemp441;
			fVec32[IOTA0 & 8191] = fTemp442;
			fRec280[0] = 0.001 * fVec32[(IOTA0 - iConst41) & 8191];
			double fTemp443 = fRec10 - fRec297[1];
			fRec297[0] = fRec297[1] + fConst13 * fTemp443;
			double fTemp444 = fRec297[1] + fConst12 * fTemp443;
			double fRec298 = fRec10 - fTemp444;
			double fTemp445 = fRec298 - fRec295[1];
			fRec295[0] = fRec295[1] + fConst13 * fTemp445;
			double fTemp446 = fRec295[1] + fConst12 * fTemp445;
			double fRec296 = fRec298 - fTemp446;
			double fTemp447 = fRec296 - fRec293[1];
			fRec293[0] = fRec293[1] + fConst13 * fTemp447;
			double fTemp448 = fRec293[1] + fConst12 * fTemp447;
			double fRec294 = fRec296 - fTemp448;
			double fTemp449 = fRec294 - fRec291[1];
			fRec291[0] = fRec291[1] + fConst13 * fTemp449;
			double fTemp450 = fRec291[1] + fConst12 * fTemp449;
			fRec292[IOTA0 & 524287] = fRec294 - fTemp450;
			fRec290[0] = fRec292[(IOTA0 - iConst33) & 524287];
			double fTemp451 = 1e+03 * fRec290[1];
			fVbargraph30 = FAUSTFLOAT(fTemp451);
			double fTemp452 = fTemp451;
			fVec33[IOTA0 & 8191] = fTemp452;
			fRec299[0] = fConst42 + (fRec299[1] - std::floor(fConst42 + fRec299[1]));
			double fTemp453 = 1e+03 * std::fabs(2.0 * (fRec299[0] + (-0.5 - std::floor(fRec299[0] + -0.5))) + -1.0);
			fVbargraph31 = FAUSTFLOAT(fTemp453);
			double fTemp454 = fTemp453;
			fRec300[0] = 0.001 * fVec33[(IOTA0 - iConst43) & 8191];
			double fTemp455 = 0.001 * fTemp454;
			double fTemp456 = 1.0 - fTemp455;
			fRec302[0] = fSlow3 + fConst4 * fRec302[1];
			fRec301[0] = std::max<double>(fRec301[1] - fConst2, std::fabs(fRec302[0]));
			fVbargraph32 = FAUSTFLOAT(2e+01 * std::log10(std::max<double>(2.2250738585072014e-308, std::max<double>(0.0001, fRec301[0]))));
			double fTemp457 = fRec302[0];
			double fTemp458 = fTemp457 * (0.000125 * fTemp21 * fTemp407 + fTemp456 * (fRec300[1] + fRec280[1]) + fTemp454 * (1e-06 * fTemp452 + 0.001 * fRec280[1]) + 0.001 * (fTemp432 + fTemp430) + 0.125 * fTemp323 * fTemp408);
			fVec34[IOTA0 & 8191] = fTemp458;
			double fTemp459 = 1e+03 * fTemp458;
			fVbargraph33 = FAUSTFLOAT(fTemp459);
			double fRec2 = 0.001 * fTemp459;
			fRec303[0] = fRec12[(IOTA0 - iConst44) & 1048575];
			double fTemp460 = fTemp427 * fRec303[1];
			fVbargraph34 = FAUSTFLOAT(fTemp460);
			double fTemp461 = fTemp460;
			double fTemp462 = 1.0000000000000002e-06 * fTemp427 * fTemp414 * fVec31[(IOTA0 - int(std::min<double>(fConst45, double(std::max<int>(0, std::max<int>(0, int(fConst46 * fTemp410))))))) & 16383];
			fVbargraph35 = FAUSTFLOAT(fTemp462);
			double fTemp463 = fTemp462;
			double fTemp464 = fTemp219 * fTemp427;
			fVbargraph36 = FAUSTFLOAT(fTemp464);
			double fTemp465 = fTemp464;
			double fTemp466 = fTemp457 * (0.125 * fTemp407 * fTemp408 + 1e-06 * fTemp454 * fTemp442 + 0.001 * (fTemp452 * fTemp456 + fRec300[1] * fTemp454 + fTemp456 * fTemp442 + fTemp465 + fTemp463 + fTemp461) + 0.000125 * fTemp21 * fTemp323);
			fVec35[IOTA0 & 8191] = fTemp466;
			double fTemp467 = 1e+03 * fTemp466;
			fVbargraph37 = FAUSTFLOAT(fTemp467);
			double fRec3 = 0.001 * fTemp467;
			fRec304[0] = fVec35[(IOTA0 - iConst47) & 8191];
			double fTemp468 = 1e+03 * fRec304[1];
			fVbargraph38 = FAUSTFLOAT(fTemp468);
			double fRec4 = 0.001 * fTemp468;
			fRec305[0] = fVec34[(IOTA0 - iConst47) & 8191];
			double fTemp469 = 1e+03 * fRec305[1];
			fVbargraph39 = FAUSTFLOAT(fTemp469);
			double fRec5 = 0.001 * fTemp469;
			fRec306[0] = fVec34[(IOTA0 - iConst48) & 8191];
			double fTemp470 = 1e+03 * fRec306[1];
			fVbargraph40 = FAUSTFLOAT(fTemp470);
			double fRec6 = 0.001 * fTemp470;
			fRec307[0] = fVec35[(IOTA0 - iConst48) & 8191];
			double fTemp471 = 1e+03 * fRec307[1];
			fVbargraph41 = FAUSTFLOAT(fTemp471);
			double fRec7 = 0.001 * fTemp471;
	...
	#define FAUST_PASSIVES 42

	FAUST_ADDVERTICALBARGRAPH("Mixer/Signal Flow 1A/1A", fVbargraph4, -8e+01, 2e+01);
	FAUST_ADDVERTICALSLIDER("Mixer/Signal Flow 1A/SF_1A", fVslider0, 0.0, -8e+01, 8e+01, 0.001);
	FAUST_ADDVERTICALBARGRAPH("Mixer/Signal Flow 1B/1B", fVbargraph9, -8e+01, 2e+01);
	FAUST_ADDVERTICALSLIDER("Mixer/Signal Flow 1B/SF_1B", fVslider1, 0.0, -8e+01, 8e+01, 0.001);
	FAUST_ADDVERTICALBARGRAPH("Mixer/Signal Flow 2A/2A", fVbargraph11, -8e+01, 2e+01);
	FAUST_ADDVERTICALSLIDER("Mixer/Signal Flow 2A/SF_2A", fVslider2, 0.0, -8e+01, 8e+01, 0.001);
	FAUST_ADDVERTICALBARGRAPH("Mixer/Signal Flow 3/3", fVbargraph32, -8e+01, 2e+01);
	FAUST_ADDVERTICALSLIDER("Mixer/Signal Flow 3/SF_3", fVslider3, 0.0, -8e+01, 8e+01, 0.001);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Mics/sig_ 0", fVbargraph8, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Mics/sig_ 1", fVbargraph17, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Mics/sig_ 2", fVbargraph3, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Mics/sig_ 3", fVbargraph1, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Mics/sig_ 4", fVbargraph7, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Mics/sig_ 5", fVbargraph16, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Mics/sig_ 6", fVbargraph2, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Mics/sig_ 7", fVbargraph0, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1a/sig_ 0", fVbargraph14, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1a/sig_ 1", fVbargraph13, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1a/sig_ 2", fVbargraph15, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1a/sig_ 3", fVbargraph5, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1a/sig_ 4", fVbargraph20, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1a/sig_ 5", fVbargraph22, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1a/sig_ 6", fVbargraph12, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1a/sig_ 7", fVbargraph24, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1b/sig_ 0", fVbargraph10, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1b/sig_ 1", fVbargraph18, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1b/sig_ 2", fVbargraph26, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1b/sig_ 3", fVbargraph21, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1b/sig_ 4", fVbargraph23, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1b/sig_ 5", fVbargraph6, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1b/sig_ 6", fVbargraph25, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 1b/sig_ 7", fVbargraph31, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 2a/sig_ 0", fVbargraph19, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 2a/sig_ 1", fVbargraph28, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 2a/sig_ 2", fVbargraph36, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 2a/sig_ 3", fVbargraph35, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 2a/sig_ 4", fVbargraph27, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 2a/sig_ 5", fVbargraph30, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 2a/sig_ 6", fVbargraph29, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 2a/sig_ 7", fVbargraph34, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 3/sig_ 0", fVbargraph33, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 3/sig_ 1", fVbargraph37, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 3/sig_ 2", fVbargraph38, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 3/sig_ 3", fVbargraph39, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 3/sig_ 4", fVbargraph40, -1e+03, 1e+03);
	FAUST_ADDVERTICALBARGRAPH("System Inspectors/Signal Flow 3/sig_ 5", fVbargraph41, -1e+03, 1e+03);

	#define FAUST_LIST_ACTIVES(p) \
		p(VERTICALSLIDER, SF_1A, "Mixer/Signal Flow 1A/SF_1A", fVslider0, 0.0, -8e+01, 8e+01, 0.001) \
		p(VERTICALSLIDER, SF_1B, "Mixer/Signal Flow 1B/SF_1B", fVslider1, 0.0, -8e+01, 8e+01, 0.001) \
		p(VERTICALSLIDER, SF_2A, "Mixer/Signal Flow 2A/SF_2A", fVslider2, 0.0, -8e+01, 8e+01, 0.001) \
		p(VERTICALSLIDER, SF_3, "Mixer/Signal Flow 3/SF_3", fVslider3, 0.0, -8e+01, 8e+01, 0.001) \

	#define FAUST_LIST_PASSIVES(p) \
		p(VERTICALBARGRAPH, 1A, "Mixer/Signal Flow 1A/1A", fVbargraph4, 0.0, -8e+01, 2e+01, 0.0) \
		p(VERTICALBARGRAPH, 1B, "Mixer/Signal Flow 1B/1B", fVbargraph9, 0.0, -8e+01, 2e+01, 0.0) \
		p(VERTICALBARGRAPH, 2A, "Mixer/Signal Flow 2A/2A", fVbargraph11, 0.0, -8e+01, 2e+01, 0.0) \
		p(VERTICALBARGRAPH, 3, "Mixer/Signal Flow 3/3", fVbargraph32, 0.0, -8e+01, 2e+01, 0.0) \
		p(VERTICALBARGRAPH, sig__0, "System Inspectors/Mics/sig_ 0", fVbargraph8, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__1, "System Inspectors/Mics/sig_ 1", fVbargraph17, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__2, "System Inspectors/Mics/sig_ 2", fVbargraph3, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__3, "System Inspectors/Mics/sig_ 3", fVbargraph1, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__4, "System Inspectors/Mics/sig_ 4", fVbargraph7, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__5, "System Inspectors/Mics/sig_ 5", fVbargraph16, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__6, "System Inspectors/Mics/sig_ 6", fVbargraph2, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__7, "System Inspectors/Mics/sig_ 7", fVbargraph0, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__0, "System Inspectors/Signal Flow 1a/sig_ 0", fVbargraph14, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__1, "System Inspectors/Signal Flow 1a/sig_ 1", fVbargraph13, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__2, "System Inspectors/Signal Flow 1a/sig_ 2", fVbargraph15, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__3, "System Inspectors/Signal Flow 1a/sig_ 3", fVbargraph5, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__4, "System Inspectors/Signal Flow 1a/sig_ 4", fVbargraph20, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__5, "System Inspectors/Signal Flow 1a/sig_ 5", fVbargraph22, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__6, "System Inspectors/Signal Flow 1a/sig_ 6", fVbargraph12, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__7, "System Inspectors/Signal Flow 1a/sig_ 7", fVbargraph24, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__0, "System Inspectors/Signal Flow 1b/sig_ 0", fVbargraph10, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__1, "System Inspectors/Signal Flow 1b/sig_ 1", fVbargraph18, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__2, "System Inspectors/Signal Flow 1b/sig_ 2", fVbargraph26, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__3, "System Inspectors/Signal Flow 1b/sig_ 3", fVbargraph21, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__4, "System Inspectors/Signal Flow 1b/sig_ 4", fVbargraph23, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__5, "System Inspectors/Signal Flow 1b/sig_ 5", fVbargraph6, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__6, "System Inspectors/Signal Flow 1b/sig_ 6", fVbargraph25, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__7, "System Inspectors/Signal Flow 1b/sig_ 7", fVbargraph31, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__0, "System Inspectors/Signal Flow 2a/sig_ 0", fVbargraph19, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__1, "System Inspectors/Signal Flow 2a/sig_ 1", fVbargraph28, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__2, "System Inspectors/Signal Flow 2a/sig_ 2", fVbargraph36, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__3, "System Inspectors/Signal Flow 2a/sig_ 3", fVbargraph35, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__4, "System Inspectors/Signal Flow 2a/sig_ 4", fVbargraph27, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__5, "System Inspectors/Signal Flow 2a/sig_ 5", fVbargraph30, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__6, "System Inspectors/Signal Flow 2a/sig_ 6", fVbargraph29, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__7, "System Inspectors/Signal Flow 2a/sig_ 7", fVbargraph34, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__0, "System Inspectors/Signal Flow 3/sig_ 0", fVbargraph33, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__1, "System Inspectors/Signal Flow 3/sig_ 1", fVbargraph37, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__2, "System Inspectors/Signal Flow 3/sig_ 2", fVbargraph38, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__3, "System Inspectors/Signal Flow 3/sig_ 3", fVbargraph39, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__4, "System Inspectors/Signal Flow 3/sig_ 4", fVbargraph40, 0.0, -1e+03, 1e+03, 0.0) \
		p(VERTICALBARGRAPH, sig__5, "System Inspectors/Signal Flow 3/sig_ 5", fVbargraph41, 0.0, -1e+03, 1e+03, 0.0) \
